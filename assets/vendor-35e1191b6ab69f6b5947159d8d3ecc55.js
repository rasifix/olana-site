...
var u="suspendedStart",l="suspendedYield",c="executing",p="completed",f={},h=v.prototype=b.prototype
...
return!!t&&(t===g||"GeneratorFunction"===(t.displayName||t.name))},a.mark=function(e){return Object.setPrototypeOf?Object.setPrototypeOf(e,v):(e.__proto__=v,o in e||(e[o]="GeneratorFunction")),e.prototype=Object.create(h),e},a.awrap=function(e){return new _(e)},y(E.prototype),a.async=function(e,t,n,r){var i=new E(d(e,t,n,r))
...
if(r in e)return n.value=r,n.done=!1,n}return n.done=!0,n}},a.values=k,C.prototype={constructor:C,reset:function(e){if(this.prev=0,this.next=0,this.sent=this._sent=t,this.done=!1,this.delegate=null,this.tryEntries.forEach(w),!e)for(var r in this)"t"===r.charAt(0)&&n.call(this,r)&&!isNaN(+r.slice(1))&&(this[r]=t)},stop:function(){this.done=!0
...
w(n)}return i}}throw new Error("illegal catch attempt")},delegateYield:function(e,t,n){return this.delegate={iterator:k(e),resultName:t,nextLoc:n},f}}}function d(e,n,r,i){var o=n&&n.prototype instanceof b?n:b,s=Object.create(o.prototype),a=new C(i||[])
...
var n=[],r=e.document,i=Object.getPrototypeOf,o=n.slice,s=n.concat,a=n.push,u=n.indexOf,l={},c=l.toString,p=l.hasOwnProperty,f=p.toString,h=f.call(Object),d={},m=function(e){return"function"==typeof e&&"number"!=typeof e.nodeType},b=function(e){return null!=e&&e===e.window},g={type:!0,src:!0,noModule:!0}
...
try{A.apply(R=N.call(E.childNodes),E.childNodes),R[E.childNodes.length].nodeType}catch(we){A={apply:R.length?function(e,t){M.apply(e,N.call(t))}:function(e,t){for(var n=e.length,r=0;e[n++]=t[r++];);e.length=n-1}}}function oe(e,t,r,i){var o,a,l,c,p,d,g,v=t&&t.ownerDocument,x=t?t.nodeType:9
if(r=r||[],"string"!=typeof e||!e||1!==x&&9!==x&&11!==x)return r
if(!i&&((t?t.ownerDocument||t:E)!==h&&f(t),t=t||h,m)){if(11!==x&&(p=X.exec(e)))if(o=p[1]){if(9===x){if(!(l=t.getElementById(o)))return r
if(l.id===o)return r.push(l),r}else if(v&&(l=v.getElementById(o))&&y(t,l)&&l.id===o)return r.push(l),r}else{if(p[2])return A.apply(r,t.getElementsByTagName(e)),r
if((o=p[3])&&n.getElementsByClassName&&t.getElementsByClassName)return A.apply(r,t.getElementsByClassName(o)),r}if(n.qsa&&!T[e+" "]&&(!b||!b.test(e))){if(1!==x)v=t,g=e
...
g=d.join(","),v=J.test(e)&&me(t.parentNode)||t}if(g)try{return A.apply(r,v.querySelectorAll(g)),r}catch(w){}finally{c===_&&t.removeAttribute("id")}}}return u(e.replace(H,"$1"),t,r,i)}function se(){var e=[]
...
t.setAttribute("type","hidden"),e.appendChild(t).setAttribute("name","D"),e.querySelectorAll("[name=d]").length&&b.push("name"+I+"*[*^$|!~]?="),2!==e.querySelectorAll(":enabled").length&&b.push(":enabled",":disabled"),d.appendChild(e).disabled=!0,2!==e.querySelectorAll(":disabled").length&&b.push(":enabled",":disabled"),e.querySelectorAll("*,:x"),b.push(",.*:")})),(n.matchesSelector=$.test(v=d.matches||d.webkitMatchesSelector||d.mozMatchesSelector||d.oMatchesSelector||d.msMatchesSelector))&&ue(function(e){n.disconnectedMatch=v.call(e,"*"),v.call(e,"[s!='']:x"),g.push("!=",F)}),b=b.length&&new RegExp(b.join("|")),g=g.length&&new RegExp(g.join("|")),t=$.test(d.compareDocumentPosition),y=t||$.test(d.contains)?function(e,t){var n=9===e.nodeType?e.documentElement:e,r=t&&t.parentNode
return e===r||!(!r||1!==r.nodeType||!(n.contains?n.contains(r):e.compareDocumentPosition&&16&e.compareDocumentPosition(r)))}:function(e,t){if(t)for(;t=t.parentNode;)if(t===e)return!0
return!1},O=t?function(e,t){if(e===t)return p=!0,0
var r=!e.compareDocumentPosition-!t.compareDocumentPosition
return r||(1&(r=(e.ownerDocument||e)===(t.ownerDocument||t)?e.compareDocumentPosition(t):1)||!n.sortDetached&&t.compareDocumentPosition(e)===r?e===h||e.ownerDocument===E&&y(E,e)?-1:t===h||t.ownerDocument===E&&y(E,t)?1:c?j(c,e)-j(c,t):0:4&r?-1:1)}:function(e,t){if(e===t)return p=!0,0
...
for(;s[r]===a[r];)r++
return r?ce(s[r],a[r]):s[r]===E?-1:a[r]===E?1:0},h):h},oe.matches=function(e,t){return oe(e,null,null,t)},oe.matchesSelector=function(e,t){if((e.ownerDocument||e)!==h&&f(e),t=t.replace(V,"='$1']"),n.matchesSelector&&m&&!T[t+" "]&&(!g||!g.test(t))&&(!b||!b.test(t)))try{var r=v.call(e,t)
if(r||n.disconnectedMatch||e.document&&11!==e.document.nodeType)return r}catch(we){}return oe(t,h,null,[e]).length>0},oe.contains=function(e,t){return(e.ownerDocument||e)!==h&&f(e),y(e,t)},oe.attr=function(e,t){(e.ownerDocument||e)!==h&&f(e)
...
return 1===r&&0===i?function(e){return!!e.parentNode}:function(t,n,u){var l,c,p,f,h,d,m=o!==s?"nextSibling":"previousSibling",b=t.parentNode,g=a&&t.nodeName.toLowerCase(),v=!u&&!a,y=!1
if(b){if(o){for(;m;){for(f=t;f=f[m];)if(a?f.nodeName.toLowerCase()===g:1===f.nodeType)return!1
d=m="only"===e&&!d&&"nextSibling"}return!0}if(d=[s?b.firstChild:b.lastChild],s&&v){for(y=(h=(l=(c=(p=(f=b)[_]||(f[_]={}))[f.uniqueID]||(p[f.uniqueID]={}))[e]||[])[0]===x&&l[1])&&l[2],f=h&&b.childNodes[h];f=++h&&f&&f[m]||(y=h=0)||d.pop();)if(1===f.nodeType&&++y&&f===t){c[e]=[x,h,y]
break}}else if(v&&(y=h=(l=(c=(p=(f=t)[_]||(f[_]={}))[f.uniqueID]||(p[f.uniqueID]={}))[e]||[])[0]===x&&l[1]),!1===y)for(;(f=++h&&f&&f[m]||(y=h=0)||d.pop())&&((a?f.nodeName.toLowerCase()!==g:1!==f.nodeType)||!++y||(v&&((c=(p=f[_]||(f[_]={}))[f.uniqueID]||(p[f.uniqueID]={}))[e]=[x,y]),f!==t)););return(y-=i)===r||y%r==0&&y/r>=0}}},PSEUDO:function(e,t){var n,i=r.pseudos[e]||r.setFilters[e.toLowerCase()]||oe.error("unsupported pseudo: "+e)
...
return s}function Ee(e,t,n,r,i,o){return r&&!r[_]&&(r=Ee(r)),i&&!i[_]&&(i=Ee(i,o)),ae(function(o,s,a,u){var l,c,p,f=[],h=[],d=s.length,m=o||function(e,t,n){for(var r=0,i=t.length;r<i;r++)oe(e,t[r],n)
return n}(t||"*",a.nodeType?[a]:a,[]),b=!e||!o&&t?m:_e(m,f,e,a,u),g=n?i||(o?e:d||r)?[]:s:b
if(n&&n(b,g,a,u),r)for(l=_e(g,h),r(l,[],a,u),c=l.length;c--;)(p=l[c])&&(g[h[c]]=!(b[h[c]]=p))
if(o){if(i||e){if(i){for(l=[],c=g.length;c--;)(p=g[c])&&l.push(b[c]=p)
i(null,g=[],l,u)}for(c=g.length;c--;)(p=g[c])&&(l=i?j(o,p):f[c])>-1&&(o[l]=!(s[l]=p))}}else g=_e(g===s?g.splice(d,g.length):g),i?i(null,s,g,u):A.apply(s,g)})}function xe(e){for(var t,n,i,o=e.length,s=r.relative[e[0].type],a=s||r.relative[" "],u=s?1:0,c=ve(function(e){return e===t},a,!0),p=ve(function(e){return j(t,e)>-1},a,!0),f=[function(e,n,r){var i=!s&&(r||n!==l)||((t=n).nodeType?c(e,n,r):p(e,n,r))
return t=null,i}];u<o;u++)if(n=r.relative[e[u].type])f=[ve(ye(f),n)]
else{if((n=r.filter[e[u].type].apply(null,e[u].matches))[_]){for(i=++u;i<o&&!r.relative[e[i].type];i++);return Ee(u>1&&ye(f),u>1&&ge(e.slice(0,u-1).concat({value:" "===e[u-2].type?"*":""})).replace(H,"$1"),n,u<i&&xe(e.slice(u,i)),i<o&&xe(e=e.slice(i)),i<o&&ge(e))}f.push(n)}return ye(f)}return be.prototype=r.filters=r.pseudos,r.setFilters=new be,s=oe.tokenize=function(e,t){var n,i,o,s,a,u,l,c=k[e+" "]
...
if(!a){for(t||(t=s(e)),n=t.length;n--;)(a=xe(t[n]))[_]?i.push(a):o.push(a);(a=T(e,function(e,t){var n=t.length>0,i=e.length>0,o=function(o,s,a,u,c){var p,d,b,g=0,v="0",y=o&&[],_=[],E=l,w=o||i&&r.find.TAG("*",c),C=x+=null==E?1:Math.random()||.1,k=w.length
for(c&&(l=s===h||s||c);v!==k&&null!=(p=w[v]);v++){if(i&&p){for(d=0,s||p.ownerDocument===h||(f(p),a=!m);b=e[d++];)if(b(p,s||h,a)){u.push(p)
break}c&&(x=C)}n&&((p=!b&&p)&&g--,o&&y.push(p))}if(g+=v,n&&v!==g){for(d=0;b=t[d++];)b(y,_,s,a)
if(o){if(g>0)for(;v--;)y[v]||_[v]||(_[v]=P.call(u))
_=_e(_)}A.apply(u,_),c&&!o&&_.length>0&&g+t.length>1&&oe.uniqueSort(u)}return c&&(x=C,l=E),y}
...
f&&(t=t.parentNode),e=e.slice(u.shift().value.length)}for(o=G.needsContext.test(e)?0:u.length;o--&&(l=u[o],!r.relative[c=l.type]);)if((p=r.find[c])&&(i=p(l.matches[0].replace(Z,ee),J.test(u[0].type)&&me(t.parentNode)||t))){if(u.splice(o,1),!(e=i.length&&ge(u)))return A.apply(n,i),n
break}}return(f||a(e,h))(i,t,!m,n,!t||J.test(e)&&me(t.parentNode)||t),n},n.sortStable=_.split("").sort(O).join("")===_,n.detectDuplicates=!!p,f(),n.sortDetached=ue(function(e){return 1&e.compareDocumentPosition(h.createElement("fieldset"))}),ue(function(e){return e.innerHTML="<a href='#'></a>","#"===e.firstChild.getAttribute("href")})||le("type|href|height|width",function(e,t,n){if(!n)return e.getAttribute(t,"type"===t.toLowerCase()?1:2)}),n.attributes&&ue(function(e){return e.innerHTML="<input/>",e.firstChild.setAttribute("value",""),""===e.firstChild.getAttribute("value")})||le("value",function(e,t,n){if(!n&&"input"===e.nodeName.toLowerCase())return e.defaultValue}),ue(function(e){return null==e.getAttribute("disabled")})||le(L,function(e,t,n){var r
...
return r>1?_.uniqueSort(n):n},filter:function(e){return this.pushStack(R(this,e||[],!1))},not:function(e){return this.pushStack(R(this,e||[],!0))},is:function(e){return!!R(this,"string"==typeof e&&T.test(e)?_(e):e||[],!1).length}})
var P,M=/^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;(_.fn.init=function(e,t,n){var i,o
if(!e)return this
...
var me,be,ge=/<|&#?\w+;/
function ve(e,t,n,r,i){for(var o,s,a,u,l,c,p=t.createDocumentFragment(),f=[],h=0,d=e.length;h<d;h++)if((o=e[h])||0===o)if("object"===y(o))_.merge(f,o.nodeType?[o]:o)
...
return p}me=r.createDocumentFragment().appendChild(r.createElement("div")),(be=r.createElement("input")).setAttribute("type","radio"),be.setAttribute("checked","checked"),be.setAttribute("name","t"),me.appendChild(be),d.checkClone=me.cloneNode(!0).cloneNode(!0).lastChild.checked,me.innerHTML="<textarea>x</textarea>",d.noCloneChecked=!!me.cloneNode(!0).lastChild.defaultValue
var ye=r.documentElement,_e=/^key/,Ee=/^(?:mouse|pointer|contextmenu|drag|drop)|click/,xe=/^([^.]*)(?:\.(.+)|)/
function we(){return!0}function Ce(){return!1}function ke(){try{return r.activeElement}catch(e){}}function Te(e,t,n,r,i,o){var s,a
...
return 1===o&&(s=i,(i=function(e){return _().off(e),s.apply(this,arguments)}).guid=s.guid||(s.guid=_.guid++)),e.each(function(){_.event.add(this,t,i,r,n)})}_.event={global:{},add:function(e,t,n,r,i){var o,s,a,u,l,c,p,f,h,d,m,b=K.get(e)
if(b)for(n.handler&&(n=(o=n).handler,i=o.selector),i&&_.find.matchesSelector(ye,i),n.guid||(n.guid=_.guid++),(u=b.events)||(u=b.events={}),(s=b.handle)||(s=b.handle=function(t){return void 0!==_&&_.event.triggered!==t.type?_.event.dispatch.apply(e,arguments):void 0}),l=(t=(t||"").match(L)||[""]).length;l--;)h=m=(a=xe.exec(t[l])||[])[1],d=(a[2]||"").split(".").sort(),h&&(p=_.event.special[h]||{},h=(i?p.delegateType:p.bindType)||h,p=_.event.special[h]||{},c=_.extend({type:h,origType:m,data:r,handler:n,guid:n.guid,selector:i,needsContext:i&&_.expr.match.needsContext.test(i),namespace:d.join(".")},o),(f=u[h])||((f=u[h]=[]).delegateCount=0,p.setup&&!1!==p.setup.call(e,r,d,s)||e.addEventListener&&e.addEventListener(h,s)),p.add&&(p.add.call(e,c),c.handler.guid||(c.handler.guid=n.guid)),i?f.splice(f.delegateCount++,0,c):f.push(c),_.event.global[h]=!0)},remove:function(e,t,n,r,i){var o,s,a,u,l,c,p,f,h,d,m,b=K.hasData(e)&&K.get(e)
if(b&&(u=b.events)){for(l=(t=(t||"").match(L)||[""]).length;l--;)if(h=m=(a=xe.exec(t[l])||[])[1],d=(a[2]||"").split(".").sort(),h){for(p=_.event.special[h]||{},f=u[h=(r?p.delegateType:p.bindType)||h]||[],a=a[2]&&new RegExp("(^|\\.)"+d.join("\\.(?:.*\\.|)")+"(\\.|$)"),s=o=f.length;o--;)c=f[o],!i&&m!==c.origType||n&&n.guid!==c.guid||a&&!a.test(c.namespace)||r&&r!==c.selector&&("**"!==r||!c.selector)||(f.splice(o,1),c.selector&&f.delegateCount--,p.remove&&p.remove.call(e,c))
s&&!f.length&&(p.teardown&&!1!==p.teardown.call(e,d,b.handle)||_.removeEvent(e,h,b.handle),delete u[h])}else for(h in u)_.event.remove(e,h+t[l],n,r,!0)
...
var Oe=/<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,Se=/<script|<style|<link/i,Re=/checked\s*(?:[^=]|=\s*.checked.)/i,Pe=/^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g
function Me(e,t){return O(e,"table")&&O(11!==t.nodeType?t:t.firstChild,"tr")&&_(e).children("tbody")[0]||e}function Ae(e){return e.type=(null!==e.getAttribute("type"))+"/"+e.type,e}function Ne(e){return"true/"===(e.type||"").slice(0,5)?e.type=e.type.slice(5):e.removeAttribute("type"),e}function je(e,t){var n,r,i,o,s,a,u,l
...
var i,o,a,u,l,c,p=0,f=e.length,h=f-1,b=t[0],g=m(b)
if(g||f>1&&"string"==typeof b&&!d.checkClone&&Re.test(b))return e.each(function(i){var o=e.eq(i)
g&&(t[0]=b.call(this,i,o.html())),Le(o,t,n,r)})
if(f&&(o=(i=ve(t,e[0].ownerDocument,!1,e,r)).firstChild,1===i.childNodes.length&&(i=o),o||r)){for(u=(a=_.map(he(i,"script"),Ae)).length;p<f;p++)l=i,p!==h&&(l=_.clone(l,!0,!0),u&&_.merge(a,he(l,"script"))),n.call(e[p],l,p)
if(u)for(c=a[a.length-1].ownerDocument,_.map(a,Ne),p=0;p<u;p++)l=a[p],pe.test(l.type||"")&&!K.access(l,"globalEval")&&_.contains(c,l)&&(l.src&&"module"!==(l.type||"").toLowerCase()?_._evalUrl&&_._evalUrl(l.src):v(l.textContent.replace(Pe,""),c,l))}return e}function Ie(e,t,n){for(var r,i=t?_.filter(t,e):e,o=0;null!=(r=i[o]);o++)n||1!==r.nodeType||_.cleanData(he(r)),r.parentNode&&(n&&_.contains(r.ownerDocument,r)&&de(he(r,"script")),r.parentNode.removeChild(r))
...
return(s=he(c,"script")).length>0&&de(s,!p&&he(e,"script")),c},cleanData:function(e){for(var t,n,r,i=_.event.special,o=0;void 0!==(n=e[o]);o++)if(G(n)){if(t=n[K.expando]){if(t.events)for(r in t.events)i[r]?_.event.remove(n,r):_.removeEvent(n,r,t.handle)
n[K.expando]=void 0}n[$.expando]&&(n[$.expando]=void 0)}}}),_.fn.extend({detach:function(e){return Ie(this,e,!0)},remove:function(e){return Ie(this,e)},text:function(e){return q(this,function(e){return void 0===e?_.text(this):this.empty().each(function(){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||(this.textContent=e)})},null,e,arguments.length)},append:function(){return Le(this,arguments,function(e){1!==this.nodeType&&11!==this.nodeType&&9!==this.nodeType||Me(this,e).appendChild(e)})},prepend:function(){return Le(this,arguments,function(e){if(1===this.nodeType||11===this.nodeType||9===this.nodeType){var t=Me(this,e)
...
return(n=n||Be(e))&&(""!==(s=n.getPropertyValue(t)||n[t])||_.contains(e.ownerDocument,e)||(s=_.style(e,t)),!d.pixelBoxStyles()&&De.test(s)&&Fe.test(t)&&(r=a.width,i=a.minWidth,o=a.maxWidth,a.minWidth=a.maxWidth=a.width=s,s=n.width,a.width=r,a.minWidth=i,a.maxWidth=o)),void 0!==s?s+"":s}function He(e,t){return{get:function(){if(!e())return(this.get=t).apply(this,arguments)
...
for(var n,r=0,i=e.length;r<i;r++)n=e[r],at.tweeners[n]=at.tweeners[n]||[],at.tweeners[n].unshift(t)},prefilters:[function(e,t,n){var r,i,o,s,a,u,l,c,p="width"in t||"height"in t,f=this,h={},d=e.style,m=e.nodeType&&re(e),b=K.get(e,"fxshow")
for(r in n.queue||(null==(s=_._queueHooks(e,"fx")).unqueued&&(s.unqueued=0,a=s.empty.fire,s.empty.fire=function(){s.unqueued||a()}),s.unqueued++,f.always(function(){f.always(function(){s.unqueued--,_.queue(e,"fx").length||s.empty.fire()})})),t)if(i=t[r],tt.test(i)){if(delete t[r],o=o||"toggle"===i,i===(m?"hide":"show")){if("show"!==i||!b||void 0===b[r])continue
m=!0}h[r]=b&&b[r]||_.style(e,r)}if((u=!_.isEmptyObject(t))||!_.isEmptyObject(h))for(r in p&&1===e.nodeType&&(n.overflow=[d.overflow,d.overflowX,d.overflowY],null==(l=b&&b.display)&&(l=K.get(e,"display")),"none"===(c=_.css(e,"display"))&&(l?c=l:(ue([e],!0),l=e.style.display||l,c=_.css(e,"display"),ue([e]))),("inline"===c||"inline-block"===c&&null!=l)&&"none"===_.css(e,"float")&&(u||(f.done(function(){d.display=l}),null==l&&(c=d.display,l="none"===c?"":c)),d.display="inline-block")),n.overflow&&(d.overflow="hidden",f.always(function(){d.overflow=n.overflow[0],d.overflowX=n.overflow[1],d.overflowY=n.overflow[2]})),u=!1,h)u||(b?"hidden"in b&&(m=b.hidden):b=K.access(e,"fxshow",{display:l}),o&&(b.hidden=!m),m&&ue([e],!0),f.done(function(){for(r in m||ue([e]),K.remove(e,"fxshow"),h)_.style(e,r,h[r])})),u=st(m?b[r]:0,r,f),r in b||(b[r]=u.start,m&&(u.end=u.start,u.start=0))}],prefilter:function(e,t){t?at.prefilters.unshift(e):at.prefilters.push(e)}}),_.speed=function(e,t,n){var r=e&&"object"==typeof e?_.extend({},e):{complete:n||!n&&t||m(e)&&e,duration:e,easing:n&&t||t&&!m(t)&&t}
...
function ft(e){return(e.match(L)||[]).join(" ")}function ht(e){return e.getAttribute&&e.getAttribute("class")||""}function dt(e){return Array.isArray(e)?e:"string"==typeof e&&e.match(L)||[]}_.fn.extend({prop:function(e,t){return q(this,_.prop,e,t,arguments.length>1)},removeProp:function(e){return this.each(function(){delete this[_.propFix[e]||e]})}}),_.extend({prop:function(e,t,n){var r,i,o=e.nodeType
...
_.extend(_.event,{trigger:function(t,n,i,o){var s,a,u,l,c,f,h,d,g=[i||r],v=p.call(t,"type")?t.type:t,y=p.call(t,"namespace")?t.namespace.split("."):[]
if(a=d=u=i=i||r,3!==i.nodeType&&8!==i.nodeType&&!bt.test(v+_.event.triggered)&&(v.indexOf(".")>-1&&(y=v.split("."),v=y.shift(),y.sort()),c=v.indexOf(":")<0&&"on"+v,(t=t[_.expando]?t:new _.Event(v,"object"==typeof t&&t)).isTrigger=o?2:3,t.namespace=y.join("."),t.rnamespace=t.namespace?new RegExp("(^|\\.)"+y.join("\\.(?:.*\\.|)")+"(\\.|$)"):null,t.result=void 0,t.target||(t.target=i),n=null==n?[t]:_.makeArray(n,[t]),h=_.event.special[v]||{},o||!h.trigger||!1!==h.trigger.apply(i,n))){if(!o&&!h.noBubble&&!b(i)){for(l=h.delegateType||v,bt.test(l+v)||(a=a.parentNode);a;a=a.parentNode)g.push(a),u=a
u===(i.ownerDocument||r)&&g.push(u.defaultView||u.parentWindow||e)}for(s=0;(a=g[s++])&&!t.isPropagationStopped();)d=a,t.type=s>1?l:h.bindType||v,(f=(K.get(a,"events")||{})[t.type]&&K.get(a,"handle"))&&f.apply(a,n),(f=c&&a[c])&&f.apply&&G(a)&&(t.result=f.apply(a,n),!1===t.result&&t.preventDefault())
return t.type=v,o||t.isDefaultPrevented()||h._default&&!1!==h._default.apply(g.pop(),n)||!G(i)||c&&m(i[v])&&!b(i)&&((u=i[c])&&(i[c]=null),_.event.triggered=v,t.isPropagationStopped()&&d.addEventListener(v,gt),i[v](),t.isPropagationStopped()&&d.removeEventListener(v,gt),_.event.triggered=void 0,u&&(i[c]=u)),t.result}},simulate:function(e,t,n){var r=_.extend(new _.Event,n,{type:e,isSimulated:!0})
...
return this.name&&!_(this).is(":disabled")&&Ct.test(this.nodeName)&&!wt.test(e)&&(this.checked||!le.test(e))}).map(function(e,t){var n=_(this).val()
return null==n?null:Array.isArray(n)?_.map(n,function(e){return{name:t.name,value:e.replace(xt,"\r\n")}}):{name:t.name,value:n.replace(xt,"\r\n")}}).get()}})
var Tt=/%20/g,Ot=/#.*$/,St=/([?&])_=[^&]*/,Rt=/^(.*?):[ \t]*([^\r\n]*)$/gm,Pt=/^(?:GET|HEAD)$/,Mt=/^\/\//,At={},Nt={},jt="*/".concat("*"),Lt=r.createElement("a")
...
return r&&_.extend(!0,e,r),e}Lt.href=vt.href,_.extend({active:0,lastModified:{},etag:{},ajaxSettings:{url:vt.href,type:"GET",isLocal:/^(?:about|app|app-storage|.+-extension|file|res|widget):$/.test(vt.protocol),global:!0,processData:!0,async:!0,contentType:"application/x-www-form-urlencoded; charset=UTF-8",accepts:{"*":jt,text:"text/plain",html:"text/html",xml:"application/xml, text/xml",json:"application/json, text/javascript"},contents:{xml:/\bxml\b/,html:/\bhtml/,json:/\bjson\b/},responseFields:{xml:"responseXML",text:"responseText",json:"responseJSON"},converters:{"* text":String,"text html":!0,"text json":JSON.parse,"text xml":_.parseXML},flatOptions:{url:!0,context:!0}},ajaxSetup:function(e,t){return t?Bt(Bt(e,_.ajaxSettings),t):Bt(_.ajaxSettings,e)},ajaxPrefilter:It(At),ajaxTransport:It(Nt),ajax:function(t,n){"object"==typeof t&&(n=t,t=void 0),n=n||{}
var i,o,s,a,u,l,c,p,f,h,d=_.ajaxSetup({},n),m=d.context||d,b=d.context&&(m.nodeType||m.jquery)?_(m):_.event,g=_.Deferred(),v=_.Callbacks("once memory"),y=d.statusCode||{},E={},x={},w="canceled",C={readyState:0,getResponseHeader:function(e){var t
if(c){if(!a)for(a={};t=Rt.exec(s);)a[t[1].toLowerCase()]=t[2]
t=a[e.toLowerCase()]}return null==t?null:t},getAllResponseHeaders:function(){return c?s:null},setRequestHeader:function(e,t){return null==c&&(e=x[e.toLowerCase()]=x[e.toLowerCase()]||e,E[e]=t),this},overrideMimeType:function(e){return null==c&&(d.mimeType=e),this},statusCode:function(e){var t
if(e)if(c)C.always(e[C.status])
else for(t in e)y[t]=[y[t],e[t]]
return this},abort:function(e){var t=e||w
return i&&i.abort(t),k(0,t),this}}
if(g.promise(C),d.url=((t||d.url||vt.href)+"").replace(Mt,vt.protocol+"//"),d.type=n.method||n.type||d.method||d.type,d.dataTypes=(d.dataType||"*").toLowerCase().match(L)||[""],null==d.crossDomain){l=r.createElement("a")
try{l.href=d.url,l.href=l.href,d.crossDomain=Lt.protocol+"//"+Lt.host!=l.protocol+"//"+l.host}catch(T){d.crossDomain=!0}}if(d.data&&d.processData&&"string"!=typeof d.data&&(d.data=_.param(d.data,d.traditional)),Dt(At,d,n,C),c)return C
for(f in(p=_.event&&d.global)&&0==_.active++&&_.event.trigger("ajaxStart"),d.type=d.type.toUpperCase(),d.hasContent=!Pt.test(d.type),o=d.url.replace(Ot,""),d.hasContent?d.data&&d.processData&&0===(d.contentType||"").indexOf("application/x-www-form-urlencoded")&&(d.data=d.data.replace(Tt,"+")):(h=d.url.slice(o.length),d.data&&(d.processData||"string"==typeof d.data)&&(o+=(_t.test(o)?"&":"?")+d.data,delete d.data),!1===d.cache&&(o=o.replace(St,"$1"),h=(_t.test(o)?"&":"?")+"_="+yt+++h),d.url=o+h),d.ifModified&&(_.lastModified[o]&&C.setRequestHeader("If-Modified-Since",_.lastModified[o]),_.etag[o]&&C.setRequestHeader("If-None-Match",_.etag[o])),(d.data&&d.hasContent&&!1!==d.contentType||n.contentType)&&C.setRequestHeader("Content-Type",d.contentType),C.setRequestHeader("Accept",d.dataTypes[0]&&d.accepts[d.dataTypes[0]]?d.accepts[d.dataTypes[0]]+("*"!==d.dataTypes[0]?", "+jt+"; q=0.01":""):d.accepts["*"]),d.headers)C.setRequestHeader(f,d.headers[f])
if(d.beforeSend&&(!1===d.beforeSend.call(m,C,d)||c))return C.abort()
if(w="abort",v.add(d.complete),C.done(d.success),C.fail(d.error),i=Dt(Nt,d,n,C)){if(C.readyState=1,p&&b.trigger("ajaxSend",[C,d]),c)return C
...
function k(t,n,r,a){var l,f,h,E,x,w=n
...
else try{t=s(t)}catch(T){return{state:"parsererror",error:s?T:"No conversion from "+u+" to "+o}}}return{state:"success",data:t}}(d,E,C,l),l?(d.ifModified&&((x=C.getResponseHeader("Last-Modified"))&&(_.lastModified[o]=x),(x=C.getResponseHeader("etag"))&&(_.etag[o]=x)),204===t||"HEAD"===d.type?w="nocontent":304===t?w="notmodified":(w=E.state,f=E.data,l=!(h=E.error))):(h=w,!t&&w||(w="error",t<0&&(t=0))),C.status=t,C.statusText=(n||w)+"",l?g.resolveWith(m,[f,w,C]):g.rejectWith(m,[C,w,h]),C.statusCode(y),y=void 0,p&&b.trigger(l?"ajaxSuccess":"ajaxError",[C,d,l?f:h]),v.fireWith(m,[C,w]),p&&(b.trigger("ajaxComplete",[C,d]),--_.active||_.event.trigger("ajaxStop")))}return C},getJSON:function(e,t,n){return _.get(e,t,n,"json")},getScript:function(e,t){return _.get(e,void 0,t,"script")}}),_.each(["get","post"],function(e,t){_[t]=function(e,n,r,i){return m(n)&&(i=i||r,r=n,n=void 0),_.ajax(_.extend({url:e,type:t,dataType:i,data:n,success:r},_.isPlainObject(e)&&e))}}),_._evalUrl=function(e){return _.ajax({url:e,type:"GET",dataType:"script",cache:!0,async:!1,global:!1,throws:!0})},_.fn.extend({wrapAll:function(e){var t
...
return{fullName:e,type:s,fullNameWithoutType:a,dirname:p,name:u,root:l,resolveMethodName:"resolve"+f}},i.prototype.lookupDescription=function(e){var t=this.parseName(e),n=void 0
...
for(h=0;h<s.length;h++)d=s[h],f[h]=d.before(e,m,l)
return function(){var t=void 0,n=void 0,r=a()
for(t=0;t<s.length;t++)"function"==typeof(n=s[t]).after&&n.after(e,r,l,f[t])
...
return[n,r=r||"asc"]})}(u)
0===h.length?(s=f?"[]":e+".[]",(0,n.addObserver)(this,s,p),c=[[this,s,p]]):c=h.map(function(t){var r=t[0],i=f?"@each."+r:e+".@each."+r
return(0,n.addObserver)(a,i,p),[a,i,p]}),l.set(this,c)
var d=f?this:(0,n.get)(this,e)
return(0,r.isArray)(d)?0===h.length?(0,r.A)(d.slice()):function(e,t){return(0,r.A)(e.slice().sort(function(e,i){var o,s,a,u,l
...
function p(){return c.run.apply(c,arguments)}function f(){return c.join.apply(c,arguments)}e._globalsRun=p.bind(null),e.bind=function(){var e,t,n
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
...
e._setStrings=e._getStrings=void 0,Object.defineProperty(e,"_getStrings",{enumerable:!0,get:function(){return t.getStrings}}),Object.defineProperty(e,"_setStrings",{enumerable:!0,get:function(){return t.setStrings}}),e.loc=_,e.w=E,e.decamelize=x,e.dasherize=w,e.camelize=C,e.classify=k,e.underscore=T,e.capitalize=O
var i=/[ _]/g,o=new r.Cache(1e3,function(e){return x(e).replace(i,"-")}),s=/(\-|\_|\.|\s)+(.)?/g,a=/(^|\/)([A-Z])/g,u=new r.Cache(1e3,function(e){return e.replace(s,function(e,t,n){return n?n.toUpperCase():""}).replace(a,function(e){return e.toLowerCase()})}),l=/^(\-|_)+(.)?/,c=/(.)(\-|\_|\.|\s)+(.)?/g,p=/(^|\/|\.)([a-z])/g,f=new r.Cache(1e3,function(e){var t,n=function(e,t,n){return n?"_"+n.toUpperCase():""},r=function(e,t,n,r){return t+(r?r.toUpperCase():"")},i=e.split("/")
for(t=0;t<i.length;t++)i[t]=i[t].replace(l,n).replace(c,r)
return i.join("/").replace(p,function(e){return e.toUpperCase()})}),h=/([a-z\d])([A-Z]+)/g,d=/\-|\s+/g,m=new r.Cache(1e3,function(e){return e.replace(h,"$1_$2").replace(d,"_").toLowerCase()}),b=/(^|\/)([a-z\u00C0-\u024F])/g,g=new r.Cache(1e3,function(e){return e.replace(b,function(e){return e.toUpperCase()})}),v=/([a-z\d])([A-Z])/g,y=new r.Cache(1e3,function(e){return e.replace(v,"$1_$2").toLowerCase()})
function _(e,n){return(!Array.isArray(n)||arguments.length>2)&&(n=Array.prototype.slice.call(arguments,1)),function(e,t){var n=0
return e.replace(/%@([0-9]+)?/g,function(e,r){var i=r?parseInt(r,10)-1:n++,o=i<t.length?t[i]:void 0
return"string"==typeof o?o:null===o?"(null)":void 0===o?"":""+o})}(e=(0,t.getString)(e)||e,n)}function E(e){return e.split(/\s+/)}function x(e){return y.get(e)}function w(e){return o.get(e)}function C(e){return u.get(e)}function k(e){return f.get(e)}function T(e){return m.get(e)}function O(e){return g.get(e)}n.ENV.EXTEND_PROTOTYPES.String&&Object.defineProperties(String.prototype,{w:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return E(this)}},loc:{configurable:!0,enumerable:!1,writeable:!0,value:function(){var e,t,n
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
return _(this,t)}},camelize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return C(this)}},decamelize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return x(this)}},dasherize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return w(this)}},underscore:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return T(this)}},classify:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return k(this)}},capitalize:{configurable:!0,enumerable:!1,writeable:!0,value:function(){return O(this)}}})}),e("@ember/string/lib/string_registry",["exports"],function(e){"use strict"
...
o.length>0&&(n=[[c.ClientSideStatement,u.SetComponentAttrs,!0]].concat(o,[[c.ClientSideStatement,u.SetComponentAttrs,!1]]),p=t.inlineBlock({statements:n,parameters:r.EMPTY_ARRAY})),t.dynamicComponent(i,p,null,s,!1,l,null)}),e.add(c.Component,function(e,t){var n,i,o,s=e[1],a=e[2],l=e[3],p=e[4],f=t.referrer,h=t.compiler.resolveLayoutForTag(s,f),d=h.handle,m=h.capabilities,b=h.compilable
if(null===d||null===m)throw new Error("Compile Error: Cannot find component "+s)
n=[[c.ClientSideStatement,u.SetComponentAttrs,!0]].concat(a,[[c.ClientSideStatement,u.SetComponentAttrs,!1]]),i=t.inlineBlock({statements:n,parameters:r.EMPTY_ARRAY}),o=t.template(p),b?(t.pushComponentDefinition(d),t.invokeStaticComponent(m,b,i,null,l,!1,o&&o)):(t.pushComponentDefinition(d),t.invokeComponent(m,i,null,l,!1,o&&o))}),e.add(c.Partial,function(e,t){var n=e[1],r=e[2],i=t.referrer
...
var w=[]
for(this.getComponentSelf(i.Register.s0),w.push({symbol:0,isBlock:!1}),l=0;l<x.length;l++)switch((c=x[l]).charAt(0)){case"&":if(f=null,"&default"===c)f=u
else if("&inverse"===c)f=_
else{if(c!==p)throw(0,r.unreachable)()
f=n}f?(this.pushYieldableBlock(f),w.push({symbol:l+1,isBlock:!0})):(this.pushYieldableBlock(null),w.push({symbol:l+1,isBlock:!0}))
break
case"@":if(!s)break
h=s[0],d=s[1],m=c,a&&(m=c.slice(1)),-1!==(b=h.indexOf(m))&&(this.expr(d[b]),w.push({symbol:l+1,isBlock:!1}))}for(this.pushRootScope(x.length+1,!!(u||_||n)),g=w.length-1;g>=0;g--)y=(v=w[g]).symbol,v.isBlock?this.setBlock(y):this.setVariable(y)
...
this.pushArgs(u,a)},t.prototype.template=function(e){return e?this.inlineBlock(e):null},(0,n.createClass)(t,[{key:"referrer",get:function(){return this.containingLayout&&this.containingLayout.referrer}}]),t}(T),S=function(e){function t(){return(0,n.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,n.inherits)(t,e),t.prototype.pushBlock=function(e){e?this.pushOther(e):this.primitive(null)},t.prototype.resolveBlock=function(){this.push(46)},t.prototype.pushLayout=function(e){e?this.pushOther(e):this.primitive(null)},t.prototype.resolveLayout=function(){this.push(46)},t.prototype.invokeStatic=function(e){this.pushOther(e),this.push(46),this.pushMachine(49)},t.prototype.pushOther=function(e){this.push(12,this.other(e))},t.prototype.other=function(e){return this.constants.other(e)},t}(O),R=function(e){function t(){return(0,n.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,n.inherits)(t,e),t.prototype.pushBlock=function(e){var t=e?e.compile():null
this.primitive(t)},t.prototype.resolveBlock=function(){},t.prototype.pushLayout=function(e){e?this.primitive(e.compile()):this.primitive(null)},t.prototype.resolveLayout=function(){},t.prototype.invokeStatic=function(e){var t=e.compile();-1===t?this.pushMachine(50,function(){return e.compile()}):this.pushMachine(50,t)},t}(O),P=function(e){function t(t,r,i){var o=new a.LazyConstants(r),s=new a.Program(o)
return(0,n.possibleConstructorReturn)(this,e.call(this,i,s,t))}return(0,n.inherits)(t,e),t.prototype.builderFor=function(e){return new S(this,e)},t}(x),M=function(){function e(e,t){this.name=e,this.template=t}return e.prototype.getPartial=function(){var e=this.template.asPartial(),t=e.compile()
...
var n=t.block
this.symbols=n.symbols,this.hasEval=n.hasEval,this.referrer=t.referrer,this.id=t.id||"client-"+A++}return e.prototype.asLayout=function(){return this.layout?this.layout:this.layout=new v(this.compiler,(0,t.assign)({},this.parsedLayout,{asPartial:!1}))},e.prototype.asPartial=function(){return this.partial?this.partial:this.layout=new v(this.compiler,(0,t.assign)({},this.parsedLayout,{asPartial:!0}))},e.prototype.asWrappedLayout=function(){return this.wrappedLayout?this.wrappedLayout:this.wrappedLayout=new w(this.compiler,(0,t.assign)({},this.parsedLayout,{asPartial:!1}))},e}()
...
this.blocks=t,this.inlines=n},e.LazyCompiler=P,e.compile=_,e.AbstractCompiler=x,e.debugCompiler=void 0,e.CompilableBlock=y,e.CompilableProgram=v,e.LazyOpcodeBuilder=S,e.EagerOpcodeBuilder=R,e.OpcodeBuilder=O,e.StdOpcodeBuilder=T,e.PartialDefinition=M,e.templateFactory=function(e){var t=e.id,n=e.meta,i=e.block,o=void 0,s=t||"client-"+A++
...
function l(e,t,n){return e|t<<16|n<<30}function c(e,t){return e|t<<30}var p=1048576,f=function(){function e(e){var t,n,r
...
this.lastValue
return e!==f&&(this.lastChecked=f,this.lastValue=this.compute()),this.lastValue},n.prototype.invalidate=function(){this.lastChecked=null},n}(i),b=function(e){function n(n,r){var i=(0,t.possibleConstructorReturn)(this,e.call(this))
...
return this.lastRevision=e.tag.value(),this.initialized=!0,t},e}(),w="adb3b78e-3d22-4e4b-877a-6317c2c5c145",C=function(){function e(e){this.inner=e,this.tag=l}return e.prototype.value=function(){return this.inner},e}(),k=function(e){function n(n,r){var i=(0,t.possibleConstructorReturn)(this,e.call(this,n.valueReferenceFor(r)))
...
r!==l&&i.push(r)}return d(i)},e.CachedTag=m,e.UpdatableTag=v,e.CachedReference=_,e.map=function(e,t){return new E(e,t)},e.ReferenceCache=x,e.isModified=function(e){return e!==w}}),e("@glimmer/runtime",["exports","ember-babel","@glimmer/util","@glimmer/reference","@glimmer/vm","@glimmer/low-level"],function(e,t,n,r,i,o){"use strict"
...
if(e!==t){var n=void 0;(n=x(e)?"":k(e)?e:String(e))!==t&&(this.node.nodeValue=this.lastValue=n)}},n}(a),O=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.create=function(e){return new n(e)},n.prototype.toBool=function(e){return y(e)},n}(m),S=function(){function e(e){this.inner=e,this.tag=e.tag}return e.prototype.value=function(){var e,t=this.inner.value()
return function(e){return k(e)||x(e)||"boolean"==typeof e||"number"==typeof e}(t)?1:(e=t)&&e[v]?0:w(t)?3:function(e){return C(e)&&11===e.nodeType}(t)?4:C(t)?5:1},e}()
...
e.pushFrame(),e.pushScope(l),e.call(o)}),s.add(53,function(e,t){var n,i=t.op1,o=e.stack.pop();(0,r.isConst)(o)?o.value()&&e.goto(i):((n=new r.ReferenceCache(o)).peek()&&e.goto(i),e.updateWith(new R(n)))}),s.add(54,function(e,t){var n,i=t.op1,o=e.stack.pop();(0,r.isConst)(o)?o.value()||e.goto(i):((n=new r.ReferenceCache(o)).peek()||e.goto(i),e.updateWith(new R(n)))}),s.add(55,function(e,t){var n=t.op1,r=t.op2
...
!e.alwaysRevalidate&&t.validate(r)&&e.goto(n)},n.prototype.didModify=function(){this.lastRevision=this.tag.value()},n}(a),M=function(e){function n(n){var i=(0,t.possibleConstructorReturn)(this,e.call(this))
...
e.elements().openElement(t)}),s.add(41,function(e){var t,n,i=e.stack.pop(),o=e.stack.pop(),s=void 0,a=void 0,u=e.stack.pop().value();(0,r.isConst)(i)?s=i.value():(s=(t=new r.ReferenceCache(i)).peek(),e.updateWith(new R(t))),(0,r.isConst)(o)?a=o.value():(a=(n=new r.ReferenceCache(o)).peek(),e.updateWith(new R(n))),e.elements().pushRemoteElement(s,u,a)}),s.add(42,function(e){e.elements().popRemoteElement()}),s.add(38,function(e){var t=e.fetchValue(i.Register.t0)
...
var f=i.getTag(c);(0,r.isConstTag)(f)||e.updateWith(new N(f,i,c))})
...
t.push(n)}),s.add(79,function(e,t){var n,r,i,o,s,a,u,l=t.op1,c=e.stack,p=e.fetchValue(l),f=c.pop(),h=p.definition
y(h)&&(h=function(e,t,n){var r=e.definition=t.unwrap(n),i=r.manager,o=r.state
return e.manager=i,e.capabilities=B(i.getCapabilities(o)),r}(p,h,f))
var d=h,m=d.manager,b=d.state
if(!0===F(p.capabilities,4)){var g=f.blocks.values,v=f.blocks.names,_=m.prepareArgs(b,f)
if(_){for(f.clear(),n=0;n<g.length;n++)c.push(g[n])
for(r=_.positional,i=_.named,o=r.length,s=0;s<o;s++)c.push(r[s])
for(a=Object.keys(i),u=0;u<a.length;u++)c.push(i[a[u]])
f.setup(c,a,v,o,!0)}c.push(f)}else c.push(f)}),s.add(81,function(e,t){var n=t.op1,i=t.op2,o=e.fetchValue(i),s=o.definition,a=o.manager,u=o.capabilities=B(a.getCapabilities(s.state)),l=null
F(u,64)&&(l=e.dynamicScope())
var c=null
F(u,8)&&(c=e.stack.peek())
var p=null
F(u,128)&&(p=e.getSelf())
var f=a.create(e.env,s.state,c,l,p,!!(1&n))
o.state=f
var h=a.getTag(f)
F(u,256)&&!(0,r.isConstTag)(h)&&e.updateWith(new q(h,f,a,l))}),s.add(82,function(e,t){var n=t.op1,r=e.fetchValue(n),i=r.manager,o=r.state,s=i.getDestructor(o)
...
if(function(e){return!1===F(e,1)}(c))f=o.getLayout(p,a)
else{if(!function(e){return!0===F(e,1)}(c))throw(0,n.unreachable)()
f=o.getDynamicLayout(l,a)}u.push(f.symbolTable),u.push(f.handle)}),s.add(68,function(e,t){var n=t.op1,r=e.stack.pop(),i=e.stack.pop(),o=r.manager,s=B(o.getCapabilities(r.state)),a={definition:r,manager:o,capabilities:s,state:null,handle:i.handle,table:i.symbolTable,lookup:null}
...
W(e.getSelf().value(),function(e){return s.get(e).value()})}),s.add(95,function(e,t){var n,r,i,o,s,a,u,l,c,p,f,h,d=t.op1,m=t.op2,b=t.op3,g=e.constants,v=e.constants.resolver,y=e.stack.pop().value(),_=g.getSerializable(d),E=g.getStringArray(m),x=g.getArray(b),w=v.lookupPartial(y,_),C=v.resolve(w).getPartial(),k=C.symbolTable,T=C.handle
for(n=k.symbols,r=e.scope(),i=e.pushRootScope(n.length,!1),o=r.getEvalScope(),i.bindCallerScope(r.getCallerScope()),i.bindEvalScope(o),i.bindSelf(r.getSelf()),s=Object.create(r.getPartialMap()),a=0;a<x.length;a++)l=E[(u=x[a])-1],c=r.getSymbol(u),s[l]=c
...
return new K(i,l,a)}var fe=ce
fe=ne(ae,fe)
var he=fe=te(ae,fe,re),de=ue.DOMTreeConstruction,me=["javascript:","vbscript:"],be=["A","BODY","LINK","IMG","IFRAME","BASE","FORM"],ge=["EMBED"],ve=["href","src","background","action"],ye=["src"]
function _e(e,t){return-1!==e.indexOf(t)}function Ee(e,t){return(null===e||_e(be,e))&&_e(ve,t)}function xe(e,t){return null!==e&&(_e(ge,e)&&_e(ye,t))}function we(e,t){return Ee(e,t)||xe(e,t)}function Ce(e,t,n,r){var i,o=null
if(null==r)return r
if(w(r))return r.toHTML()
o=t?t.tagName.toUpperCase():null
var s=E(r)
return Ee(o,n)&&(i=e.protocolForURL(s),_e(me,i))?"unsafe:"+s:xe(o,n)?"unsafe:"+s:s}function ke(e,t){var n,r,i,o,s=void 0,a=void 0
...
return"attr"===s?Se(r,a,i):function(e,t,n){if(we(e,t))return new Ae(t,n)
...
return new Me(t,n)}(r,a,i)}function Se(e,t,n){return we(e,t)?new Ne(n):new Pe(n)}var Re=function(e){this.attribute=e},Pe=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.set=function(e,t){var n,r,i,o=Ie(t)
...
null===t?r.removeAttribute(i):r.setAttribute(i,t)},n}(Re),Me=function(e){function n(n,r){var i=(0,t.possibleConstructorReturn)(this,e.call(this,r))
...
n?t.removeAttributeNS(n,this.normalizedName):t.removeAttribute(this.normalizedName)},n}(Re),Ae=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.set=function(t,n,r){var i=this.attribute,o=Ce(r,i.element,i.name,n)
e.prototype.set.call(this,t,o,r)},n.prototype.update=function(t,n){var r=this.attribute,i=Ce(n,r.element,r.name,t)
e.prototype.update.call(this,i,n)},n}(Me),Ne=function(e){function n(){return(0,t.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,t.inherits)(n,e),n.prototype.set=function(t,n,r){var i=this.attribute,o=Ce(r,i.element,i.name,n)
e.prototype.set.call(this,t,o,r)},n.prototype.update=function(t,n){var r=this.attribute,i=Ce(n,r.element,r.name,t)
...
c.execute(f,function(i){o[e]=p=i.iterate(r,t),i.updatingOpcodeStack.push(new n.LinkedList),i.updateWith(p),i.updatingOpcodeStack.push(p.children)}),a.insertBefore(p,l),this.didInsert=!0},e.prototype.retain=function(){},e.prototype.move=function(e,t,n,r){var i=this.map,o=this.updating,s=i[e],a=i[r]||null
...
return-1===t?null:[this.values[3*t+2],this.values[3*t+1],this.values[3*t]]},e}(),ht=new ct(r.CONSTANT_TAG,n.EMPTY_ARRAY,n.EMPTY_ARRAY),dt=new ut(r.CONSTANT_TAG,n.EMPTY_ARRAY),mt={tag:r.CONSTANT_TAG,length:0,positional:dt,named:ht},bt=function(){function e(e,t,r,i){var o=this
...
t.insertBefore(u,o),t.append(new M(u)),t.append(e)},e.prototype.enter=function(e){var t=new n.LinkedList,r=this.capture(e),i=this.elements().pushUpdatableBlock(),o=new tt(this.heap.gethandle(this.pc),r,this.runtime,i,t)
...
if(null!==r){if((t=r.openBlockDepth)>=r.startingBlockDepth)for(;n&&(!Et(n)||xt(n)!==t);)n=this.remove(n)
...
return t&&t[1]?Number(t[1]):null}function wt(e){return 1===e.nodeType}function Ct(e){return 8===e.nodeType&&"%glmr%"===e.nodeValue}function kt(e){return 8===e.nodeType&&"% %"===e.nodeValue}function Tt(e,t){var n,r
...
return new vt(n,r)},e.LowLevelVM=bt,e.UpdatingVM=Ze,e.RenderResult=ot,e.SimpleDynamicAttribute=Pe,e.DynamicAttribute=Re,e.EMPTY_ARGS=mt,e.Scope=De,e.Environment=Fe,e.DefaultEnvironment=ze,e.DEFAULT_CAPABILITIES={dynamicLayout:!0,dynamicTag:!0,prepareArgs:!0,createArgs:!0,attributeHook:!1,elementHook:!1,dynamicScope:!0,createCaller:!1,updateHook:!0,createInstance:!0},e.MINIMAL_CAPABILITIES={dynamicLayout:!1,dynamicTag:!1,prepareArgs:!1,createArgs:!1,attributeHook:!1,elementHook:!1,dynamicScope:!1,createCaller:!1,updateHook:!1,createInstance:!1},e.CurriedComponentDefinition=_,e.isCurriedComponentDefinition=y,e.curry=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:null
return new _(e,t)},e.DOMChanges=he,e.SVG_NAMESPACE=re,e.IDOMChanges=ce,e.DOMTreeConstruction=de,e.isWhitespace=function(e){return se.test(e)},e.insertHTMLBefore=pe,e.normalizeProperty=ke,e.NewElementBuilder=Ve
...
return s}var f=function(){function e(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:{}
...
return t}},e}()
function d(e){for(var t=e(),n=t.next();!1===n.done;)n.value(),n=t.next()}var m=function(){},b=Object.freeze([])
...
return 2===arguments.length?(n=arguments[0],o=arguments[1],t=null):(t=(e=g.apply(void 0,arguments))[0],n=e[1],void 0===(i=e[2])?o=0:a(o=i.pop())||(r=!0===o,o=i.pop())),[t,n,i,o=parseInt(o,10),r]}var y=0,_=0,E=0,x=0,w=0,C=0,k=0,T=0,O=0,S=0,R=0,P=0,M=0,A=0,N=0,j=0,L=0,I=0,D=0,B=0,F=0,z=function(){function e(e,t){var n=this
...
this._autorun=e()},(0,t.createClass)(e,[{key:"counters",get:function(){return{begin:_,end:E,events:{begin:x,end:0},autoruns:{created:I,completed:D},run:w,join:C,defer:k,schedule:T,scheduleIterable:O,deferOnce:S,scheduleOnce:R,setTimeout:P,later:M,throttle:A,debounce:N,cancelTimers:j,cancel:L,loops:{total:B,nested:F}}}},{key:"defaultQueue",get:function(){return this._defaultQueue}}]),e}()
z.Queue=f,e.default=z,e.buildPlatform=i}),e("container",["exports","@ember/debug","@ember/polyfills","ember-owner","ember-utils","@ember/deprecated-features","ember-environment"],function(e,t,n,r,i,o,s){"use strict"
...
return e.factoryManagerCache[t]=o,o}}function f(e,t,n){var r,i,o,s,a,l=n.injections
...
function p(e){n([e])}var f=l.map(function(e){return a.push(s.observeRecord(e,p)),s.wrapRecord(e)}),h={didChange:function(e,n,o,u){var l,c,f
...
var T,O,S,R,P,M,A=(0,i.taggedTemplateLiteralLoose)(["template:components/-default"],["template:components/-default"]),N=(0,i.taggedTemplateLiteralLoose)(["component:-default"],["component:-default"]),j=(0,i.taggedTemplateLiteralLoose)(["template:-root"],["template:-root"]),L=(0,i.taggedTemplateLiteralLoose)(["template-compiler:main"],["template-compiler:main"])
...
return this.factory.create(e.compiler,{owner:t})},e}(),B=I({id:"Zi0CBVtc",block:'{"symbols":[],"statements":[[1,[27,"component",[[22,0,[]]],null],false]],"hasEval":false}',meta:{moduleName:"packages/ember-glimmer/lib/templates/root.hbs"}}),F=(0,l.symbol)("RECOMPUTE_TAG")
...
function q(e){return new H(e)}function U(e){return(0,u.isArray)(e)?0!==e.length:!!e}var V=(0,l.symbol)("UPDATE"),W=(0,l.symbol)("INVOKE"),Y=(0,l.symbol)("ACTION"),G=function(){function e(){}return e.prototype.get=function(e){return $.create(this,e)},e}(),Q=function(e){function t(){var t=(0,i.possibleConstructorReturn)(this,e.call(this))
...
var xe=(0,l.symbol)("EACH_IN"),we=function(){function e(e){this.inner=e,this.tag=e.tag,this[xe]=!0}return e.prototype.value=function(){return this.inner.value()},e.prototype.get=function(e){return this.inner.get(e)},e}()
function Ce(e,t){return function(e){return null!==e&&"object"==typeof e&&e[xe]}(e)?new Ne(e,t||"@key"):new je(e,t||"@identity")}var ke=function(){function e(e,t){this.length=e,this.keyFor=t,this.position=0}return e.prototype.isEmpty=function(){return!1},e.prototype.memoFor=function(e){return e},e.prototype.next=function(){var e=this.length,t=this.keyFor,n=this.position
if(n>=e)return null
...
return e.forEach(function(e){return n.push(e)}),this.from(n,t)},t.prototype.valueFor=function(e){return this.array[e]},t}(ke),Oe=function(e){function t(t,n,r){var o=(0,i.possibleConstructorReturn)(this,e.call(this,n,r))
return o.array=t,o}return(0,i.inherits)(t,e),t.from=function(e,t){var n=e.length
return 0===n?Ae:new this(e,n,t)},t.prototype.valueFor=function(e){return(0,c.objectAt)(this.array,e)},t}(ke),Se=function(e){function t(t,n,r,o){var s=(0,i.possibleConstructorReturn)(this,e.call(this,r,o))
...
return e.forEach(function(e,t){(s=s||n.length>=2)&&r.push(t),i.push(e),o++}),0===o?Ae:s?new this(r,i,o,t):new Te(i,o,t)},t.prototype.valueFor=function(e){return this.values[e]},t.prototype.memoFor=function(e){return this.keys[e]},t}(ke),Re=function(){function e(e,t,n){this.iterable=e,this.result=t,this.keyFor=n,this.position=0}return e.from=function(e,t){var n=e[Symbol.iterator](),r=n.next(),i=r.value
return r.done?Ae:Array.isArray(i)&&2===i.length?new this(n,r,t):new Pe(n,r,t)},e.prototype.isEmpty=function(){return!1},e.prototype.next=function(){var e=this.iterable,t=this.result,n=this.position,r=this.keyFor
if(t.done)return null
var i=this.valueFor(t,n),o=this.memoFor(t,n),s=r(i,o,n)
return this.position++,this.result=e.next(),{key:s,value:i,memo:o}},e}(),Pe=function(e){function t(){return(0,i.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,i.inherits)(t,e),t.prototype.valueFor=function(e){return e.value},t.prototype.memoFor=function(e,t){return t},t}(Re),Me=function(e){function t(){return(0,i.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,i.inherits)(t,e),t.prototype.valueFor=function(e){return e.value[1]},t.prototype.memoFor=function(e){return e.value[0]},t}(Re),Ae={isEmpty:function(){return!0},next:function(){return null}},Ne=function(){function e(e,t){this.ref=e,this.keyPath=t,this.valueTag=a.UpdatableTag.create(a.CONSTANT_TAG),this.tag=(0,a.combine)([e.tag,this.valueTag])}return e.prototype.iterate=function(){var e,t=this.ref,n=this.valueTag,r=t.value(),i=(0,c.tagFor)(r)
return(0,l.isProxy)(r)&&(r=(0,u._contentFor)(r)),n.inner.update(i),null===(e=r)||"object"!=typeof e&&"function"!=typeof e?Ae:Array.isArray(r)||(0,u.isEmberArray)(r)?Se.fromIndexable(r,this.keyFor(!0)):l.HAS_NATIVE_SYMBOL&&Ie(r)?Me.from(r,this.keyFor()):Le(r)?Se.fromForEachable(r,this.keyFor()):Se.fromIndexable(r,this.keyFor(!0))},e.prototype.valueReferenceFor=function(e){return new Z(e.value)},e.prototype.updateValueReference=function(e,t){e.update(t.value)},e.prototype.memoReferenceFor=function(e){return new Z(e.memo)},e.prototype.updateMemoReference=function(e,t){e.update(t.memo)},e.prototype.keyFor=function(){var e=arguments.length>0&&void 0!==arguments[0]&&arguments[0],t=this.keyPath
switch(t){case"@key":return e?Be:qe(Fe)
case"@index":return De
case"@identity":return qe(ze)
default:return qe(He(t))}},e}(),je=function(){function e(e,t){this.ref=e,this.keyPath=t,this.valueTag=a.UpdatableTag.create(a.CONSTANT_TAG),this.tag=(0,a.combine)([e.tag,this.valueTag])}return e.prototype.iterate=function(){var e=this.ref,t=this.valueTag,n=e.value()
if(t.inner.update((0,c.tagForProperty)(n,"[]")),null===n||"object"!=typeof n)return Ae
var r=this.keyFor()
return Array.isArray(n)?Te.from(n,r):(0,u.isEmberArray)(n)?Oe.from(n,r):l.HAS_NATIVE_SYMBOL&&Ie(n)?Pe.from(n,r):Le(n)?Te.fromForEachable(n,r):Ae},e.prototype.valueReferenceFor=function(e){return new Z(e.value)},e.prototype.updateValueReference=function(e,t){e.update(t.value)},e.prototype.memoReferenceFor=function(e){return new Z(e.memo)},e.prototype.updateMemoReference=function(e,t){e.update(t.memo)},e.prototype.keyFor=function(){var e=this.keyPath
switch(e){case"@index":return De
case"@identity":return qe(ze)
default:return qe(He(e))}},e}()
function Le(e){return"function"==typeof e.forEach}function Ie(e){return"function"==typeof e[Symbol.iterator]}function De(e,t,n){return String(n)}function Be(e,t){return t}function Fe(e,t){return ze(t)}function ze(e){switch(typeof e){case"string":return e
...
return void 0===s?(t[o]=0,o):(t[o]=++s,o+"be277757-bbbe-4620-9fcb-213ef433cca2"+s)}}var Ue=function(){function e(e){this.string=e}return e.prototype.toString=function(){return""+this.string},e.prototype.toHTML=function(){return this.toString()},e}(),Ve={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#x27;","`":"&#x60;","=":"&#x3D;"},We=/[&<>"'`=]/,Ye=/[&<>"'`=]/g
function Ge(e){return Ve[e]}function Qe(e){return null==e?e="":"string"!=typeof e&&(e=""+e),new Ue(e)}function Ke(e){return null!==e&&"object"==typeof e&&"function"==typeof e.toHTML}var $e=void 0,Xe=void 0
...
"style"===a&&(l=new dt(l,lt(n,"isVisible"))),i.setAttribute(a,l,!1,null)}},ht=Qe("display: none;"),dt=function(e){function t(t,n){var r=(0,i.possibleConstructorReturn)(this,e.call(this))
...
return!1!==this.isVisible.value()?t:t?(e=t+" display: none;",Ke(t)?Qe(e):e):ht},t}(a.CachedReference),mt={install:function(e,t,n){n.setAttribute("style",(0,a.map)(lt(t,"isVisible"),this.mapStyleValue),!1,null)},mapStyleValue:function(e){return!1===e?ht:null}},bt=function(e,n,r,i){var o,s,a,u,l=r.split(":"),c=l[0],p=l[1],f=l[2]
""===c?i.setAttribute("class",t.PrimitiveReference.create(p),!0,null):(s=(o=c.indexOf(".")>-1)?c.split("."):[],a=o?ct(n,s):lt(n,c),u=void 0,u=void 0===p?new gt(a,o?s[s.length-1]:c):new vt(a,p,f),i.setAttribute("class",u,!1,null))},gt=function(e){function t(t,n){var r=(0,i.possibleConstructorReturn)(this,e.call(this))
...
for(a[le]=u,t=0;t<o.length;t++)n=o[t],r=e.get(n),"function"==typeof(i=s[n])&&i[Y]?s[n]=i:r[V]&&(s[n]=new Et(r,i)),u[n]=r,a[n]=i
return a.attrs=s,a}var _t=(0,l.symbol)("REF"),Et=function(){function e(e,t){this[f.MUTABLE_CELL]=!0,this[_t]=e,this.value=t}return e.prototype.update=function(e){this[_t][V](e)},e}()
var xt=(0,x.privatize)(A),wt=function(e){function r(){return(0,i.possibleConstructorReturn)(this,e.apply(this,arguments))}return(0,i.inherits)(r,e),r.prototype.getLayout=function(e){return{handle:e.handle,symbolTable:e.symbolTable}},r.prototype.templateFor=function(e,t){var n,r=(0,c.get)(e,"layout")
...
e.finalizer=(0,d._instrumentStart)("render.component",kt,n),r&&!r.tag.validate(i)&&(t=yt(r),e.argsRevision=r.tag.value(),n[pe]=!0,n.setProperties(t),n[pe]=!1,n.trigger("didUpdateAttrs"),n.trigger("didReceiveAttrs")),o.isInteractive&&(n.trigger("willUpdate"),n.trigger("willRender"))},r.prototype.didUpdateLayout=function(e){e.finalize()},r.prototype.didUpdate=function(e){var t=e.component
e.environment.isInteractive&&(t.trigger("didUpdate"),t.trigger("didRender"))},r.prototype.getDestructor=function(e){return e},r}(tt)
function Ct(e){return e.instrumentDetails({initialRender:!0})}function kt(e){return e.instrumentDetails({initialRender:!1})}var Tt={dynamicLayout:!0,dynamicTag:!0,prepareArgs:!0,createArgs:!0,attributeHook:!0,elementHook:!0,createCaller:!0,dynamicScope:!0,updateHook:!0,createInstance:!0},Ot=new wt,St=function(e,t,n,r,i){this.name=e,this.ComponentClass=t,this.handle=n,this.manager=Ot
var o=r&&r.asLayout(),s=o?o.symbolTable:void 0
this.symbolTable=s,this.template=r,this.args=i,this.state={name:e,ComponentClass:t,handle:n,template:r,capabilities:Tt,symbolTable:s}},Rt=function(e){function t(t){var n=(0,i.possibleConstructorReturn)(this,e.call(this))
...
return Bt++,w.backburner.join(null,It)}Bt=0,null!==Dt&&(t=Dt.resolve,Dt=null,w.backburner.join(null,t))})
var Ft=function(){function e(e,n){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:f.fallbackViewRegistry,i=arguments.length>3&&void 0!==arguments[3]&&arguments[3],o=arguments.length>4&&void 0!==arguments[4]?arguments[4]:t.clientBuilder
...
this._appendDefinition(e,(0,t.curry)(a),n)},e.prototype.appendTo=function(e,n){var r=new Mt(e)
this._appendDefinition(e,(0,t.curry)(r),n)},e.prototype._appendDefinition=function(e,n,r){var i=new ie(n),o=new At(null,t.UNDEFINED_REFERENCE),s=new Nt(e,this._env,this._rootTemplate,i,r,o,this._builder)
...
Gt(e)&&e.destroyComponent(t)},e}(),Xt=function(e,t,n,r){this.name=e,this.ComponentClass=t,this.delegate=n,this.template=r,this.manager=Kt
...
return(0,d.flaggedInstrument)("interaction.ember-action",i,function(){return w.join.apply(void 0,[s,a].concat(r(t)))})}}var un=function(e){return function(e){return null==e||"function"!=typeof e.toString}(e)?"":String(e)}
...
return r!==e&&(t=cn(this.sourceReference,r),n.inner.update(t.tag),this.innerReference=t,this.lastPath=r),t.value()},n.prototype[V]=function(e){(0,c.set)(this.sourceReference.value(),this.pathReference.value(),e)},n}(Q),fn=function(e){function t(t,n,r){var o=(0,i.possibleConstructorReturn)(this,e.call(this))
...
function hn(e){var t,n=e.positional;(t=console).log.apply(t,n.value())}var dn=(0,l.symbol)("MUT"),mn=(0,l.symbol)("SOURCE")
...
delete f.ActionManager.registeredActions[t]},En=function(){function e(e,t,n,r,i,o,s,a,u){this.element=e,this.actionId=t,this.actionName=n,this.actionArgs=r,this.namedArgs=i,this.positional=o,this.implicitTarget=s,this.dom=a,this.eventName=this.getEventName(),this.tag=u}return e.prototype.getEventName=function(){return this.namedArgs.get("on").value()||"click"},e.prototype.getActionArgs=function(){var e,t=new Array(this.actionArgs.length)
...
if(null==t){if(vn.test(e.type))return(0,f.isSimpleClick)(e)
...
"function"!=typeof n[W]?"function"!=typeof n?(r.name=n,a.send?(0,d.flaggedInstrument)("interaction.ember-action",r,function(){a.send.apply(a,[n].concat(e))}):(0,d.flaggedInstrument)("interaction.ember-action",r,function(){a[n].apply(a,e)})):(0,d.flaggedInstrument)("interaction.ember-action",r,function(){n.apply(a,e)}):(0,d.flaggedInstrument)("interaction.ember-action",r,function(){n[W].apply(n,e)})}),u)},e.prototype.destroy=function(){_n(this)},e}(),xn=function(){function e(){}return e.prototype.create=function(e,t,n,r){var i,o=t.capture(),s=o.named,a=o.positional,u=o.tag,c=void 0,p=void 0,f=void 0
a.length>1&&(c=a.at(0),(f=a.at(1))[W]?p=f:(f._propertyKey,p=f.value()))
var h=[]
for(i=2;i<a.length;i++)h.push(a.at(i))
var d=(0,l.uuid)()
return new En(e,d,p,h,s,a,c,r,u)},e.prototype.install=function(e){var t=e.dom,n=e.element,r=e.actionId
...
function wn(e){return null===e?null:[e[0].map(function(e){return"@"+e}),e[1]]}function Cn(e,t,n,r){var i=r.compiler.resolver.lookupComponentDefinition("-text-area",r.referrer)
return pt(n),r.component.static(i,[t||[],wn(n),null,null]),!0}function kn(e,t,n,r){var i=r.compiler.resolver.lookupComponentDefinition(e,r.referrer)
return r.component.static(i,[t,wn(n),null,null]),!0}function Tn(e,t,n,r){var i,o,s,a,u
...
r.tag.validate(i)||(t=r.value(),e.modelRev=r.tag.value(),n.set("model",t))},t}(tt)),Pn=function(e,t){this.manager=Rn,this.state={name:e,modelRef:t}}
function Mn(e,t,n,r){var i=[_.Ops.Helper,"-mount",t||[],n]
...
return"string"==typeof i?this._lastName===i?this._lastDef:e.owner.hasRegistration("engine:"+i)?(this._lastName=i,this._lastDef=(0,t.curry)(new Pn(i,r)),this._lastDef):null:(this._lastDef=null,this._lastName=null,null)},e.prototype.get=function(){return t.UNDEFINED_REFERENCE},e}(),Nn=function(){function e(e){this.outletState=e,this.tag=a.DirtyableTag.create()}return e.prototype.get=function(e){return new Ln(this,e)},e.prototype.value=function(){return this.outletState},e.prototype.update=function(e){this.outletState.outlets.main=e,this.tag.inner.dirty()},e}(),jn=function(){function e(e,t){this.parentStateRef=e,this.outletNameRef=t,this.tag=(0,a.combine)([e.tag,t.tag])}return e.prototype.value=function(){var e=this.parentStateRef.value(),t=void 0===e?void 0:e.outlets
...
var Fn=void 0,zn=void 0,Hn=void 0
...
t.set("model",n.value())},t.prototype.getCapabilities=function(){return R},t.prototype.getTag=function(e){return e.model.tag},t.prototype.getDestructor=function(e){return e.controller},t}(T),Fn=new P,Hn=function(e,t,n){this.manager=n,this.state={name:e,template:t}})
var qn=void 0
E.RENDER_HELPER&&(qn=function(e,n){var r,i,o,s=e.env,a=n.positional.at(0),u=a.value(),l=s.owner.lookup("template:"+u),c=void 0
return c=n.named.has("controller")?n.named.get("controller").value():u,1===n.positional.length?(r=new Hn(c,l,zn),ie.create((0,t.curry)(r))):(i=new Hn(c,l,Fn),o=n.capture(),ie.create((0,t.curry)(i,o)))})
var Un=void 0
...
return null!==s&&(pt(n),o.component.static(s,[t,wn(n),r,i]),!0)}E.RENDER_HELPER&&(Un=function(e,t,n,r){var i
...
return fn.create(n.at(0),n.at(1),n.at(2))},action:function(e,t){var n=t.named,r=t.positional.capture().references,i=r[0],o=r[1],s=r.slice(2),u=(o._propertyKey,n.has("target")?n.get("target"):i),l=function(e,t){var n=void 0
...
return i[mn]=r,i[W]=r[V],i[dn]=!0,i},"query-params":function(e,t){return new re(bn,t.capture())},readonly:function(e,t){var n=function(e){return e[mn]||e}(t.positional.at(0))
return new oe(n)},unbound:function(e,t){return ie.create(t.positional.at(0).value())},unless:function(e,t){var n=t.positional
return fn.create(n.at(0),n.at(2),n.at(1))},"-class":function(e,t){return new re(tn,t.capture())},"-each-in":function(e,t){return new we(t.positional.at(0))},"-input-type":function(e,t){return new re(rn,t.capture())},"-normalize-class":function(e,t){return new re(on,t.capture())},"-html-safe":function(e,t){return new re(nn,t.capture())},"-get-dynamic-var":t.getDynamicVar,"-mount":function(e,t){var n=e.env,r=t.positional.at(0),i=t.named.has("model")?t.named.get("model"):void 0
...
var Zn={action:new xn},er=function(){function e(){this.handles=[void 0],this.objToHandle=new WeakMap,this.builtInHelpers=Jn,this.builtInModifiers=Zn,this.templateCache=new Map,this.componentDefinitionCache=new Map,this.customManagerCache=new Map,this.templateCacheHits=0,this.templateCacheMisses=0,this.componentDefinitionCount=0,this.helperDefinitionCount=0
var e=new o.Macros;(function(e){var t,n=e.inlines,r=e.blocks
for(n.add("outlet",Dn),E.RENDER_HELPER&&n.add("render",Un),n.add("mount",Mn),n.add("input",Tn),n.add("textarea",Cn),n.addMissing(Vn),r.add("let",On),r.addMissing(Wn),t=0;t<Yn.length;t++)(0,Yn[t])(r,n)})(e),this.compiler=new o.LazyCompiler(new Vt(this),this,e)}return e.prototype.lookupComponentDefinition=function(e,t){var n=this.lookupComponentHandle(e,t)
...
return void 0===n.destroy?new te(n.compute,t.capture()):(e.newDestroyable(n),ne.create(n,t.capture()))}:null},e.prototype._lookupPartial=function(e,t){var n=(0,f.lookupPartial)(e,t.owner)
...
return-1!==r&&(t=e.slice(r+2),n=e.slice(0,r)),{name:t,namespace:n}},e.prototype._lookupComponentDefinition=function(e,t){var n,r,i,o,s=e,a=(0,f.lookupComponent)(t.owner,s,Xn(t.moduleName,void 0)),u=a.layout,l=a.component,c=void 0===l?u:l
if(void 0===c)return null
var p=this.componentDefinitionCache.get(c)
if(void 0!==p)return p
var h=(0,d._instrumentStart)("render.getComponentDefinition",$n,s)
if(u&&!l&&v.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS)return n=new en(u),h(),this.componentDefinitionCache.set(c,n),n
if(l&&l.class&&(r=Kn(l.class)))return i=this._lookupComponentManager(t.owner,r),o=new Xt(s,l,i,u||t.owner.lookup((0,x.privatize)(A))),h(),this.componentDefinitionCache.set(c,o),o
var m=u||l?new St(s,l||t.owner.factoryFor((0,x.privatize)(N)),null,u):null
...
e.RootTemplate=B,e.template=I,e.Checkbox=be,e.TextField=ve,e.TextArea=ye,e.LinkComponent=Ee,e.Component=de,e.ROOT_REF=ce,e.Helper=z,e.helper=q,e.Environment=et,e.SafeString=Ue,e.escapeExpression=function(e){if("string"!=typeof e){if(e&&e.toHTML)return e.toHTML()
if(null==e)return""
if(!e)return e+""
e=""+e}return We.test(e)?e.replace(Ye,Ge):e},e.htmlSafe=Qe,e.isHTMLSafe=Ke,e.Renderer=Ft,e.InertRenderer=zt,e.InteractiveRenderer=Ht,e._resetRenderers=function(){jt.length=0},e.renderSettled=function(){return null===Dt&&(Dt=C.default.defer(),(0,w.getCurrentRunLoop)()||w.backburner.schedule("actions",null,It)),Dt.promise},e.getTemplate=function(e){if(qt.hasOwnProperty(e))return qt[e]},e.setTemplate=function(e,t){return qt[e]=t},e.hasTemplate=function(e){return qt.hasOwnProperty(e)},e.getTemplates=function(){return qt},e.setTemplates=function(e){qt=e},e.setupEngineRegistry=function(e){e.register("view:-outlet",sr),e.register("template:-outlet",rr),e.injection("view:-outlet","template","template:-outlet"),e.injection("service:-dom-changes","document","service:-document"),e.injection("service:-dom-tree-construction","document","service:-document"),e.register((0,x.privatize)(A),nr),e.register("service:-glimmer-environment",et),e.register((0,x.privatize)(L),tr),e.injection("template","compiler",(0,x.privatize)(L)),e.optionsForType("helper",{instantiate:!1}),e.register("helper:loc",Ut),e.register("component:-text-field",ve),e.register("component:-text-area",ye),e.register("component:-checkbox",be),e.register("component:link-to",Ee),v.ENV._TEMPLATE_ONLY_GLIMMER_COMPONENTS||e.register((0,x.privatize)(N),de)},e.setupApplicationRegistry=function(e){e.injection("service:-glimmer-environment","appendOperations","service:-dom-tree-construction"),e.injection("renderer","env","service:-glimmer-environment"),e.register("service:-dom-builder",{create:function(e){switch(e.bootOptions._renderMode){case"serialize":return r.serializeBuilder.bind(null)
case"rehydrate":return t.rehydrationBuilder.bind(null)
default:return t.clientBuilder.bind(null)}}}),e.injection("service:-dom-builder","bootOptions","-environment:main"),e.injection("renderer","builder","service:-dom-builder"),e.register((0,x.privatize)(j),B),e.injection("renderer","rootTemplate",(0,x.privatize)(j)),e.register("renderer:-dom",Ht),e.register("renderer:-inert",zt),h.hasDOM&&e.injection("service:-glimmer-environment","updateOperations","service:-dom-changes"),e.register("service:-dom-changes",{create:function(e){var n=e.document
...
function p(e,t){c.set(e,t)}function f(e){for(var t=e,n=void 0;null!=t;){if(void 0!==(n=c.get(t)))return n
t=l(t)}}var h=e.meta=function(e){var t=f(e)
...
e("ember-metal",["exports","ember-babel","@ember/polyfills","ember-utils","@ember/debug","@ember/deprecated-features","ember-environment","ember-meta","@ember/runloop","@glimmer/reference","@ember/error","ember/version","ember-owner"],function(e,t,n,r,i,o,s,a,u,l,c,p,f){"use strict"
...
function v(e){return"string"==typeof e&&-1!==g.get(e)}function y(e){return e+":change"}function _(e,t,n,r,i){o.DID_INIT_ATTRS&&s.ENV._ENABLE_DID_INIT_ATTRS_SUPPORT,r||"function"!=typeof n||(r=n,n=null),(0,a.meta)(e).addToListeners(t,n,r,!0===i)}function E(e,t,n,r){r||"function"!=typeof n||(r=n,n=null),(0,a.meta)(e).removeFromListeners(t,n,r)}function x(e,t,n,r,i){var o,s,u,l,c
...
for(this.added.clear(),this.queue=[],e=0;e<i.length;e+=3)t=i[e],n=i[e+1],r=i[e+2],t.isDestroying||t.isDestroyed||x(t,r,[t,n])},e}(),C=function(){return!1}
function k(){return l.DirtyableTag.create()}function T(e,t,n){if("object"!=typeof e||null===e)return l.CONSTANT_TAG
var i=void 0===n?(0,a.meta)(e):n
if((0,r.isProxy)(e))return O(e,i)
var o=i.writableTags(),s=o[t]
return s||(o[t]=k())}function O(e,t){return"object"==typeof e&&null!==e?(void 0===t?(0,a.meta)(e):t).writableTag(k):l.CONSTANT_TAG}var S=void 0
...
var M=(0,r.symbol)("PROPERTY_DID_CHANGE"),A=new w,N=0,j=void 0
...
i.forEachInDeps(n,function(n){void 0!==(s=(0,a.descriptorFor)(t,n,i))&&s._suspended===t||e(t,n,i)})}})(I,e,t,D,n),r&&(D.clear(),B=!0)}(e,t,r),function(e,t,n){var r=n.readableChainWatchers()
void 0!==r&&r.notify(t,!0,I)}(0,t,r),function(e,t,n){if(n.isSourceDestroying())return
var r=y(t)
N>0?A.add(e,t,r):x(e,r,[e,t])}(e,t,r)),M in e&&e[M](t),i){if(r.isSourceDestroying())return
R(e,t,r)}}}o.PROPERTY_DID_CHANGE&&(e.propertyDidChange=L=function(e,t,n){I(e,t,n)})
var D=new Map,B=!0
function F(e,t,n){var r=n.readableChainWatchers()
void 0!==r&&r.revalidate(t)}function z(){N++}function H(){--N<=0&&A.flush()}function q(e){z()
...
var c,p,f=void 0
n instanceof U?(f=n,Object.defineProperty(e,t,{configurable:!0,enumerable:l,get:(c=t,p=f,function(){return p.get(this,c)})}),i.writeDescriptors(t,f),n.setup(e,t)):null==n?(f=r,u||!1===l?Object.defineProperty(e,t,{configurable:!0,enumerable:l,writable:!0,value:f}):e[t]=r):(f=n,Object.defineProperty(e,t,n)),o&&F(0,t,i),"function"==typeof e.didDefineProperty&&e.didDefineProperty(e,t,f)}function W(e,t,n){var r,i=void 0===n?(0,a.meta)(e):n,o=i.peekWatching(t)
...
void 0!==i&&i.arrayDidChange(e,t,n,r)}function $(e,t,n,r){return void 0===t?(t=0,n=r=-1):(void 0===n&&(n=-1),void 0===r&&(r=-1)),Q(e,t,n,r),x(e,"@array:before",[e,t,n,r]),e}function X(e,t,n,r){void 0===t?(t=0,n=r=-1):(void 0===n&&(n=-1),void 0===r&&(r=-1))
var i,o,s,u=(0,a.peekMeta)(e);(r<0||n<0||r-n!=0)&&I(e,"length",u),I(e,"[]",u),K(e,t,n,r),x(e,"@array:change",[e,t,n,r])
var l=b(e)
...
return r(e,"@array:before",t,o),r(e,"@array:change",t,s),a===i&&I(e,"hasArrayObservers"),e}function le(e,t,n,r){_(e,y(t),n,r),Oe(e,t)}function ce(e,t,n,r){Re(e,t),E(e,y(t),n,r)}function pe(e){var t=G.get(e)
return void 0===t&&(t=new fe(e),G.set(e,t)),t}var fe=function(){function e(e){this._content=e,this._keys=void 0,(0,a.meta)(this)}return e.prototype.arrayWillChange=function(e,t,n){var r=this._keys
...
void 0!==n&&n[e]>0&&--n[e]<=0&&de(t=this._content,e,this,0,t.length)},e.prototype.contentKeyDidChange=function(e,t){I(this,t)},e}()
function he(e,t,n,r,i){for(var o;--i>=r;)(o=oe(e,i))&&le(o,t,n,"contentKeyDidChange")}function de(e,t,n,r,i){for(var o;--i>=r;)(o=oe(e,i))&&ce(o,t,n,"contentKeyDidChange")}function me(e){return"object"==typeof e&&null!==e}var be=function(){function e(){this.chains=Object.create(null)}return e.prototype.add=function(e,t){var n=this.chains[e]
...
function xe(e){e.isWatching&&(_e(e.object,e.key,e),e.isWatching=!1)}function we(e){var t=e.chains
...
for(we(e);Ee.length>0;)we(t=Ee.pop()),xe(t)}(this):xe(this)},e.prototype.copyTo=function(e){var t,n=this.paths
...
r.writeWatching(t,i+1),0===i&&r.writableChains(ve).add(t)}function Te(e,t,n){var r=void 0===n?(0,a.peekMeta)(e):n
if(void 0!==r){var i=r.peekWatching(t)
i>0&&(r.writeWatching(t,i-1),1===i&&r.writableChains(ve).remove(t))}}function Oe(e,t,n){v(t)?ke(e,t,n):W(e,t,n)}function Se(e,t){var n=(0,a.peekMeta)(e)
return void 0!==n&&n.peekWatching(t)||0}function Re(e,t,n){v(t)?Te(e,t,n):Y(e,t,n)}function Pe(e,t,n,r){var i,o,s=e._dependentKeys
if(null!=s)for(i=0;i<s.length;i++)o=s[i],r.writeDeps(o,n,r.peekDeps(o,n)+1),Oe(t,o,r)}function Me(e,t,n,r){var i,o,s=e._dependentKeys
if(null!=s)for(i=0;i<s.length;i++)o=s[i],r.writeDeps(o,n,r.peekDeps(o,n)-1),Re(t,o,r)}var Ae=/\.@each$/
...
t+=n.substring(0,r)
u=l.length
for(;s<u;)(a=c.indexOf("{"))<0?i((t+l[s++]+c).replace(Ae,".[]")):e(t+l[s++],c,a,i)}("",e,n,t)}function je(e,t,n,r){if(!e.isDestroyed){if(v(t))return function(e,t,n,r){var i=t.split("."),o=i.pop()
...
var l
return l=e[t],o.PROPERTY_BASED_DESCRIPTORS&&(0,a.isDescriptor)(l)?(i=l,Object.defineProperty(e,t,{configurable:!0,enumerable:!1===i.enumerable,get:function(){return i.get(this,t)}}),(0,a.meta)(e).writeDescriptors(t,i),i.setup(e,t),i.set(e,t,n),n):(void 0!==l||"object"!=typeof e||t in e||"function"!=typeof e.setUnknownProperty?(s=(0,a.peekMeta)(e),e[t]=n,l!==n&&I(e,t,s)):e.setUnknownProperty(t,n),n)}}function Le(){}var Ie=function(e){function n(n,r){var i,o=(0,t.possibleConstructorReturn)(this,e.call(this)),s="function"==typeof n
...
if(i&&o===s)return s
var u=(0,a.meta)(e)
return i||Pe(this,e,t,u),r.set(t,s),I(e,t,u),s},n.prototype.teardown=function(e,t,n){if(!this._volatile){var r=b(e)
...
return this.consume(e,t,(0,a.meta)(e)),n},n.prototype.unconsume=function(e,t,n){var r=m(e,t)===Fe;(r||n.peekWatching(t)>0)&&Me(this,e,t,n),r&&d(e).delete(t)},n.prototype.consume=function(e,t,n){var r=d(e)
r.get(t)!==Fe&&(r.set(t,Fe),Pe(this,e,t,n))},n.prototype.set=function(e,t,n){return je(e,this.altKey,n)},n.prototype.readOnly=function(){return this.set=He,this},n.prototype.oneWay=function(){return this.set=qe,this},n}(U)
function He(e,t){throw new c.default("Cannot set read-only property '"+t+"' on object: "+(0,r.inspect)(e))}function qe(e,t,n){return V(e,t,null),je(e,t,n)}function Ue(e){var t,n,r=null==e
if(r)return r
if("number"==typeof e.size)return!e.size
var i=typeof e
return"object"===i&&"number"==typeof(t=ne(e,"size"))?!t:"number"==typeof e.length&&"function"!==i?!e.length:"object"===i&&"number"==typeof(n=ne(e,"length"))&&!n}function Ve(e){return Ue(e)||"string"==typeof e&&!1===/\S/.test(e)}ze.prototype._meta=void 0,ze.prototype.meta=Ie.prototype.meta
...
var Ge=Object.prototype.hasOwnProperty,Qe=!1,Ke={_set:0,_unprocessedNamespaces:!1,get unprocessedNamespaces(){return this._unprocessedNamespaces},set unprocessedNamespaces(e){this._set++,this._unprocessedNamespaces=e}},$e=!1,Xe=[],Je=Object.create(null)
...
if(n)for(i=0;i<n.length;i++)r(e,n[i],null,t)}function ft(e,t,n,i){"function"==typeof n&&(pt(e,t,(0,r.getObservers)(n),ce),pt(e,t,(0,r.getListeners)(n),E)),"function"==typeof i&&(pt(e,t,(0,r.getObservers)(i),le),pt(e,t,(0,r.getListeners)(i),_))}function ht(e,t,n){var i,u,l={},c={},p=(0,a.meta)(e),f=[],h=void 0,d=void 0,m=void 0
for(e._super=r.ROOT,function e(t,n,r,i,o,s){var a,u,l,c=void 0,p=void 0,f=void 0,h=void 0,d=void 0
function m(e){delete r[e],delete i[e]}for(a=0;a<t.length;a++)if(c=t[a],u=n,(p=(l=c)instanceof dt?u.hasMixin(l)?st:(u.addMixin(l),l.properties):l)!==st)if(p){for(f in o.willMergeMixin&&o.willMergeMixin(p),h=at("concatenatedProperties",p,i,o),d=at("mergedProperties",p,i,o),p)p.hasOwnProperty(f)&&(s.push(f),lt(o,f,p[f],n,r,i,h,d))
p.hasOwnProperty("toString")&&(o.toString=p.toString)}else c.mixins&&(e(c.mixins,n,r,i,o,s),c._without&&c._without.forEach(m))}(t,p,l,c,e,f),i=0;i<f.length;i++)if("constructor"!==(h=f[i])&&c.hasOwnProperty(h)){for(m=l[h],d=c[h];m&&m instanceof bt;)m=(u=ct(e,m,l,c)).desc,d=u.value
void 0===m&&void 0===d||(void 0!==(0,a.descriptorFor)(e,h)?ft(e,h,null,d):ft(e,h,e[h],d),o.BINDING_SUPPORT&&s.ENV._ENABLE_BINDING_SUPPORT&&"function"==typeof dt.detectBinding&&dt.detectBinding(h)&&p.writeBindings(h,d),V(e,h,m,d,p))}return o.BINDING_SUPPORT&&s.ENV._ENABLE_BINDING_SUPPORT&&!n&&"function"==typeof dt.finishPartial&&dt.finishPartial(e,p),e}var dt=function(){function e(e,t){this.properties=t,this.mixins=mt(e),this.ownerConstructor=void 0,this._without=void 0}return e.create=function(){$e=!0
var e,t,n
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
...
return r.methodName=n,r}return(0,t.inherits)(n,e),n.prototype.teardown=function(){throw new Error("Method not implemented.")},n.prototype.get=function(){throw new Error("Method not implemented.")},n.prototype.set=function(){throw new Error("Method not implemented.")},n}(U),gt=function(e){function n(n,r){var i=(0,t.possibleConstructorReturn)(this,e.call(this,vt))
return i.type=n,i.name=r,i}return(0,t.inherits)(n,e),n}(Ie)
function vt(e){var t=(0,a.descriptorFor)(this,e),n=(0,f.getOwner)(this)||this.container,r=t.type+":"+(t.name||e)
...
e.computed=De,e.ComputedProperty=Ie,e._globalsComputed=Be,e.getCacheFor=d,e.getCachedValueFor=m,e.peekCacheFor=b,e.alias=function(e){return new ze(e)},e.deprecateProperty=function(e,t,n,r){Object.defineProperty(e,t,{configurable:!0,enumerable:!1,set:function(e){je(this,n,e)},get:function(){return ne(this,n)}})},e.PROXY_CONTENT=te,e._getPath=re,e.get=ne,e.getWithDefault=function(e,t,n){var r=ne(e,t)
...
e.isEmpty=Ue,e.isBlank=Ve,e.isPresent=function(e){return!Ve(e)},e.beginPropertyChanges=z,e.changeProperties=q,e.endPropertyChanges=H,e.notifyPropertyChange=I,e.overrideChains=F,e.propertyDidChange=L,e.propertyWillChange=j,e.PROPERTY_DID_CHANGE=M,e.defineProperty=V,e.Descriptor=U,e.watchKey=W,e.unwatchKey=Y,e.ChainNode=Ce,e.finishChains=function(e){var t=e.readableChainWatchers()
void 0!==t&&t.revalidateAll(),void 0!==e.readableChains()&&e.writableChains(ve)},e.removeChainWatcher=_e,e.watchPath=ke,e.unwatchPath=Te,e.isWatching=function(e,t){return Se(e,t)>0},e.unwatch=Re,e.watch=Oe,e.watcherCount=Se,e.libraries=Ye,e.Libraries=We,e.getProperties=function(e){var t={},n=arguments,r=1
...
e.removeObserver=ce,e.Mixin=dt,e.aliasMethod=function(e){return new bt(e)},e.mixin=function(e){var t,n,r
...
return(0,r.setObservers)(o,a),o},e.applyMixin=ht,e.InjectedProperty=gt,e.setHasViews=function(e){C=e},e.tagForProperty=T,e.tagFor=O,e.markObjectAsDirty=R,e.runInTransaction=P,e.didRender=void 0,e.assertNotRendered=void 0,e.descriptor=function(e){return new yt(e)},e.tracked=function(e,t,n){return"value"in n?function(e,t){var n=Symbol(e)
return{enumerable:!0,configurable:!0,get:function(){return Z&&Z.add(T(this,e)),n in this||(this[n]=t.value),this[n]},set:function(t){O(this).inner.dirty(),S(T(this,e)),this[n]=t,ee()}}}(t,n):function(e,t){var n=t.get,r=t.set
return{enumerable:!0,configurable:!1,get:n&&function(){var t=Z,r=Z=new J,i=n.call(this)
Z=t
var o=r.combine()
return Z&&Z.add(o),(void 0)(T(this,e),o),i},set:r&&function(){S(T(this,e)),r.apply(this,arguments)}}}(t,n)},e.NAMESPACES=Xe,e.NAMESPACES_BY_ID=Je,e.addNamespace=function(e){Ke.unprocessedNamespaces=!0,Xe.push(e)},e.classToString=nt,e.findNamespace=function(e){return Qe||tt(),Je[e]},e.findNamespaces=Ze,e.processNamespace=et,e.processAllNamespaces=tt,e.removeNamespace=function(e){var t=(0,r.getName)(e)
...
return""!==r&&("/"!==r[0]&&(r="/"+r),n+="#"+r),n}e.getHistoryPath=l,e.getHashPath=c,e.default=o.Object.extend({location:s.location,history:s.history,global:s.window,userAgent:s.userAgent,cancelRouterSetup:!1,rootURL:"/",detect:function(){var e=this.rootURL,n=function(e){var t,n,r=e.location,i=e.userAgent,o=e.history,s=e.documentMode,u=e.global,p=e.rootURL,f="none",h=!1,d=(0,a.getFullPath)(r);(0,a.supportsHistory)(i,o)?(t=l(p,r),d===t?f="history":"/#"===d.substr(0,2)?(o.replaceState({path:t},null,t),f="history"):(h=!0,(0,a.replacePath)(r,t))):(0,a.supportsHashChange)(s,u)&&(n=c(p,r),d===n||"/"===d&&"/#/"===n?f="hash":(h=!0,(0,a.replacePath)(r,n)))
if(h)return!1
...
f.as&&(d=f.as)
var m=o(this,d,f.resetNamespace),b={name:n,instanceId:r++,mountPoint:m,fullName:m},g=f.path
"string"!=typeof g&&(g="/"+d)
...
this.enableLoadingSubstates&&(l=d+"_loading",c="application_loading",p=(0,t.assign)({localFullName:c},b),s(this,l,{resetNamespace:f.resetNamespace}),this.options.addRouteForEngine(l,p),l=d+"_error",c="application_error",p=(0,t.assign)({localFullName:c},b),s(this,l,{resetNamespace:f.resetNamespace,path:y}),this.options.addRouteForEngine(l,p)),this.options.addRouteForEngine(m,_),this.push(g,m,v)},e}()
...
var h=u.Object.extend(u.ActionHandler,u.Evented,{queryParams:{},router:n.ROUTER_ROUTER?(0,o.computed)("_router",function(){return this._router}):void 0,_setRouteName:function(e){this.routeName=e,this.fullRouteName=g((0,r.getOwner)(this),e)},_qp:(0,o.computed)(function(){var e,n,i,s,a,p,f,h,d,m,b=this,g=void 0,v=this.controllerName||this.routeName,y=(0,r.getOwner)(this),_=y.lookup("controller:"+v),E=(0,o.get)(this,"queryParams"),x=Object.keys(E).length>0
_?(e=(0,o.get)(_,"queryParams")||{},g=function(e,n){var r,i,o={},s={defaultValue:!0,type:!0,scope:!0,as:!0}
for(var a in e)e.hasOwnProperty(a)&&(r={},(0,t.assign)(r,e[a],n[a]),o[a]=r,s[a]=!0)
for(var u in n)n.hasOwnProperty(u)&&!s[u]&&(i={},(0,t.assign)(i,n[u],e[u]),o[u]=i)
return o}((0,c.normalizeControllerQueryParams)(e),E)):x&&(_=(0,l.default)(y,v),g=E)
var w=[],C={},k=[]
for(var T in g)g.hasOwnProperty(T)&&"unknownProperty"!==T&&"_super"!==T&&(s=void 0,"controller"===(i=(n=g[T]).scope||"model")&&(s=[]),a=n.as||this.serializeQueryParamKey(T),p=(0,o.get)(_,T),Array.isArray(p)&&(p=(0,u.A)(p.slice())),f=n.type||(0,u.typeOf)(p),h=this.serializeQueryParam(p,a,f),d=v+":"+T,m={undecoratedDefaultValue:(0,o.get)(_,T),defaultValue:p,serializedDefaultValue:h,serializedValue:h,type:f,urlKey:a,prop:T,scopedPropertyName:d,controllerName:v,route:this,parts:s,values:null,scope:i},C[T]=C[a]=C[d]=m,w.push(m),k.push(T))
return{qps:w,map:C,propertyNames:k,states:{inactive:function(e,t){var n=C[e]
...
if(n){var r,i,s,a,u,l,p,f,h,d=n.state.handlerInfos,m=this._router,g=m._queryParamsFor(d),v=m._qpUpdates,y=void 0
for((0,c.stashParamNames)(m,d),r=0;r<g.qps.length;++r)a=(s=(i=g.qps[r]).route).controller,u=i.urlKey in e&&i.urlKey,l=void 0,p=void 0,v&&i.urlKey in v?(l=(0,o.get)(a,i.prop),p=s.serializeQueryParam(l,i.urlKey,i.type)):u?void 0!==(p=e[u])&&(l=s.deserializeQueryParam(p,i.urlKey,i.type)):(p=i.serializedDefaultValue,l=b(i.defaultValue)),a._qpDelegate=(0,o.get)(s,"_qp.states.inactive"),p!==i.serializedValue&&(n.queryParamsOnly&&!1!==y&&(f=s._optionsForQueryParam(i),(h=(0,o.get)(f,"replace"))?y=!0:!1===h&&(y=!1)),(0,o.set)(a,i.prop,l)),i.serializedValue=p,i.serializedDefaultValue===p&&!n._keepDefaultQueryParamValues||t.push({value:p,visible:!0,key:u||i.urlKey})
...
a._qpDelegate=f.allowOverrides,t&&((0,c.stashParamNames)(this._router,t.state.handlerInfos),r=this._bucketCache,i=t.params,p.propertyNames.forEach(function(e){var t=p.map[e]
t.values=i
...
var s=function(e,t,n,i){var o,s=(0,r.getOwner)(e),a=void 0,u=void 0,l=void 0,c=void 0,p=void 0,f=void 0
...
var f={qps:p,map:c}
return l&&(this._qpCache[a]=f),f},_fullyScopeQueryParams:function(e,t,n){var r,i,o,s,a,u,l,c=C(this,e,t).handlerInfos
...
for(r=0;r<c.length;++r)if(i=this._getQPMeta(c[r]))for(o=0,s=i.qps.length;o<s;++o)a=i.qps[o],(u=a.prop in t&&a.prop||a.scopedPropertyName in t&&a.scopedPropertyName||a.urlKey in t&&a.urlKey)?u!==a.scopedPropertyName&&(t[a.scopedPropertyName]=t[u],delete t[u]):(l=(0,p.calculateCacheKey)(a.route.fullRouteName,a.parts,e.params),t[a.scopedPropertyName]=f.lookup(l,a.prop,a.defaultValue))},_scheduleLoadingEvent:function(e,t){this._cancelSlowTransitionTimer(),this._slowTransitionTimer=(0,r.scheduleOnce)("routerTransitions",this,"_handleSlowTransition",e,t)},currentState:null,targetState:null,_handleSlowTransition:function(e,t){if(this._routerMicrolib.activeTransition){var n=new f.default(this,this._routerMicrolib,this._routerMicrolib.activeTransition.state)
...
return x(r,e._router,i+"_"+n,o)?o:""}function E(e,n){var r=(0,t.getOwner)(e),i=e.routeName,o=e.fullRouteName,s="application"===o?n:o+"."+n
...
a&&("currentPath"in a||(0,i.defineProperty)(a,"currentPath"),(0,i.set)(a,"currentPath",r),"currentRouteName"in a||(0,i.defineProperty)(a,"currentRouteName"),(0,i.set)(a,"currentRouteName",o))}}function T(e,t){var n=new f.default(t,t._routerMicrolib,e.state)
...
for(var o in r=n.outlets)i.push(r[o])}}function R(e,t,n){var o=void 0,s={render:n,outlets:Object.create(null),wasUsed:!1}
...
function v(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:g,r=A(),i=new Set,o="function"==typeof t?t:function(e){return(0,n.get)(e,t)}
...
return-1===i?void 0:(0,n.objectAt)(e,i)}function x(e,t,n){return-1!==_(e,t.bind(n),0)}function w(e,t,n){var r=t.bind(n)
...
if("array"===n)return!0
var r=t.length
return"number"==typeof r&&r==r&&"object"===n}var T=n.Mixin.create(o.default,((h={})[b]=!0,h.objectsAt=function(e){var t=this
...
e.replace(t,n,m)}return e}var R=n.Mixin.create(T,p.default,{clear:function(){var e=this.length
...
return(0,n.beginPropertyChanges)(),e.forEach(function(e){return t.addObject(e)}),(0,n.endPropertyChanges)(),this}}),P=n.Mixin.create(R,u.default,{objectAt:function(e){return this[e]},replace:function(e,t){var r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:m
...
P.keys().forEach(function(e){Array.prototype[e]&&M.push(e)}),e.NativeArray=P=(d=P).without.apply(d,M)
var A=void 0
a.ENV.EXTEND_PROTOTYPES.Array?(P.apply(Array.prototype),e.A=A=function(e){return e||[]}):e.A=A=function(e){return e||(e=[]),T.detect(e)?e:P.apply(e)},e.A=A,e.NativeArray=P,e.MutableArray=R,e.default=T}),e("ember-runtime/lib/mixins/comparable",["exports","ember-metal"],function(e,t){"use strict"
...
var f=u.Mixin.prototype.reopen,h=new o.WeakSet,d=new WeakMap,m=new WeakMap,b=function(){function e(e){var t,s,l,c,f,h,m,b,g,v,y,_,E=d.get(this.constructor)
void 0!==E&&(d.delete(this.constructor),n.FACTORY_FOR.set(this,E)),this.constructor.proto()
var x=(0,a.meta)(this),w=x.proto
if(x.proto=this,void 0!==e)for(s=this.concatenatedProperties,l=this.mergedProperties,c=void 0!==s&&s.length>0,f=void 0!==l&&l.length>0,h=Object.keys(e),m=0;m<h.length;m++)g=e[b=h[m]],r.BINDING_SUPPORT&&p.ENV._ENABLE_BINDING_SUPPORT&&u.Mixin.detectBinding(b)&&x.writeBindings(b,g),(y=void 0!==(v=(0,a.descriptorFor)(this,b,x)))||(_=this[b],c&&s.indexOf(b)>-1&&(g=_?(0,o.makeArray)(_).concat(g):(0,o.makeArray)(g)),f&&l.indexOf(b)>-1&&(g=(0,i.assign)({},_,g))),y?v.set(this,b,g):"function"!=typeof this.setUnknownProperty||b in this?this[b]=g:this.setUnknownProperty(b,g)
r.BINDING_SUPPORT&&p.ENV._ENABLE_BINDING_SUPPORT&&u.Mixin.finishPartial(this,x),(t=this).init.apply(t,arguments),x.proto=w,(0,u.finishChains)(x),(0,u.sendEvent)(this,"init",void 0,void 0,void 0,x)}return e._initFactory=function(e){d.set(this,e)},e.prototype.reopen=function(){var e,t,n
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
...
return f.apply(e.PrototypeMixin,arguments),e},e.create=function(e,t){return new this(void 0===t?e:function(){var e,t,n,r,s,a,u,l,c,p,f,h,d=this.concatenatedProperties,m=this.mergedProperties,b=void 0!==d&&d.length>0,g=void 0!==m&&m.length>0,v={}
for(e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
for(r=0;r<t.length;r++)for(s=t[r],a=Object.keys(s),u=0,l=a.length;u<l;u++)c=a[u],p=s[c],b&&d.indexOf(c)>-1&&(f=v[c],p=f?(0,o.makeArray)(f).concat(p):(0,o.makeArray)(p)),g&&m.indexOf(c)>-1&&(h=v[c],p=(0,i.assign)({},h,p)),v[c]=p
...
function b(e){var t=d.get(e)
return void 0===t&&(t=h(e),d.set(e,t)),t}d.set(m,!1)
var g=new WeakMap
function v(e,t){t&&g.set(e,t)}function y(e){return g.get(e)}var _=new WeakMap
function E(e,t){t&&_.set(e,t)}function x(e){return _.get(e)}var w=new c
function C(e,t){function n(){var n=this._super
this._super=t
var r=e.apply(this,arguments)
return this._super=n,r}return w.add(n),v(n,y(e)),E(n,x(e)),n}var k=Object.prototype.toString,T=Function.prototype.toString,O=Array.isArray,S=Object.keys,R=JSON.stringify,P=100,M=4,A=/^[\w$]+$/
...
return n.add(e),r?function(e,t,n){if(t>M)return"[Array]"
var r,i="["
for(r=0;r<e.length;r++){if(i+=0===r?" ":", ",r>=P){i+="... "+(e.length-P)+" more items"
break}i+=N(e[r],t,n)}return i+=" ]"}(e,t+1,n):function(e,t,n){if(t>M)return"[Object]"
var r,i,o="{",s=S(e)
for(r=0;r<s.length;r++){if(o+=0===r?" ":", ",r>=P){o+="... "+(s.length-P)+" more keys"
break}i=s[r],o+=j(i)+": "+N(e[i],t,n)}return o+=" }"}(e,t+1,n)}function j(e){return A.test(e)?e:R(e)}function L(e,t){return null!=e&&"function"==typeof e[t]}var I=Array.isArray,D=new WeakMap,B=Object.prototype.toString
function F(e){return null==e}var z="function"==typeof Symbol&&"[object Symbol]"===Object.prototype.toString.call(Symbol()),H="function"==typeof Proxy,q=new c,U=function(){function e(e,t,n){this.limit=e,this.func=t,this.store=n,this.size=0,this.misses=0,this.hits=0,this.store=n||new Map}return e.prototype.get=function(e){this.store.get(e)
...
return n(e)?void 0===(r=o.get(e))&&(r="ember"+i(),o.set(e,r)):void 0===(r=s.get(e))&&(r="string"===(t=typeof e)?"st"+i():"number"===t?"nu"+i():"symbol"===t?"sy"+i():"("+e+")",s.set(e,r)),r},e.intern=t,e.checkHasSuper=h,e.ROOT=m,e.wrap=function(e,t){return b(e)?!w.has(t)&&b(t)?C(e,C(t,m)):C(e,t):e},e.getObservers=y,e.getListeners=x,e.setObservers=v,e.setListeners=E,e.inspect=function(e){return"number"==typeof e&&2===arguments.length?this:N(e,0)},e.lookupDescriptor=function(e,t){var n,r=e
...
for(var l in r)r.hasOwnProperty(l)&&this.setupHandler(a,l,r[l],u)},setupHandler:function(e,t,n,r){var i,o,u,p,f,h,d
...
if(p)for(u=0;u<p.length;u++)if((l=p[u])&&l.eventName===n)return l.handler(t)},void 0!==c[t]?(u=c[t],p=t,f=function(e,t){var n=document.createEvent("MouseEvent")
return n.initMouseEvent(e,!1,!1,t.view,t.detail,t.screenX,t.screenY,t.clientX,t.clientY,t.ctrlKey,t.altKey,t.shiftKey,t.metaKey,t.button,t.relatedTarget),Object.defineProperty(n,"target",{value:t.target,enumerable:!0}),n},h=this._eventHandlers[u]=function(e){for(var t=e.target,n=e.relatedTarget;t&&1===t.nodeType&&(!n||n!==t&&!t.contains(n));)r[t.id]?i(t,f(p,e)):t.hasAttribute("data-ember-action")&&o(t,f(p,e)),t=t.parentNode},e.addEventListener(u,h)):(d=this._eventHandlers[t]=function(e){var t=e.target
...
return{names:u||_,shouldDecodes:c||_}}function x(e,t,n){return e.char===t&&e.negate===n}var w=function(e,t,n,r,i){this.states=e,this.id=t,this.char=n,this.negate=r,this.nextStates=i?t:null,this.pattern="",this._regex=void 0,this.handlers=void 0,this.types=void 0}
...
if(null!==o)if(h(o)){for(n=0;n<o.length;n++)if(x(r=this.states[o[n]],e,t))return r}else if(x(i=this.states[o],e,t))return i},w.prototype.put=function(e,t,n){var r
if(r=this.get(e,t))return r
var i=this.states
return r=new w(i,i.length,e,t,n),i[i.length]=r,null==this.nextStates?this.nextStates=r.id:h(this.nextStates)?this.nextStates.push(r.id):this.nextStates=[this.nextStates,r.id],r},w.prototype.match=function(e){var t,n,r,i=this.nextStates
if(!i)return[]
var o=[]
...
for(n=0;n<e.length;n++){for(o=(i=E(h,(r=e[n]).path,p)).names,s=i.shouldDecodes;m<h.length;m++)4!==(a=h[m]).type&&(d=!1,l=l.put(47,!1,!1),c+="/",l=b[a.type](a,l),c+=g[a.type](a))
...
var f=e.length
for(f>1&&"/"===e.charAt(f-1)&&(e=e.substr(0,f-1),p=p.substr(0,p.length-1),u=!0),r=0;r<e.length&&(o=k(o,e.charCodeAt(r))).length;r++);var h=[]
...
var d=t.match(h),m=1,b=new T(n)
for(b.length=f.length,r=0;r<f.length;r++){if(o=(i=f[r]).names,s=i.shouldDecodes,a=y,u=!1,o!==_&&s!==_)for(l=0;l<o.length;l++)u=!0,c=o[l],p=d&&d[m++],a===y&&(a={}),S.ENCODE_AND_DECODE_PATH_SEGMENTS&&s[l]?a[c]=p&&decodeURIComponent(p):a[c]=p
b[r]={handler:i.handler,params:a,isDynamic:u}}return b}(d,p,s)),t},S.VERSION="0.3.3",S.ENCODE_AND_DECODE_PATH_SEGMENTS=!0,S.Normalizer={normalizeSegment:l,normalizePath:a,encodePathSegment:p},S.prototype.map=function(e,t){var n=new i
...
return r.isResolved=!0,r}return(0,t.inherits)(r,e),r.prototype.resolve=function(e,t){return t&&t.resolvedModels&&(t.resolvedModels[this.name]=this.context),n.Promise.resolve(this,this.promiseLabel("Resolve"))},r.prototype.getUnresolved=function(){return this.factory("param",{name:this.name,handler:this.handler,params:this.params})},r}(w),k=function(e){function r(n){var r=(0,t.possibleConstructorReturn)(this,e.call(this,n))
...
return/_id$/.test(i)?r[i]=t.id:r[i]=t,r}},r}(w),T=function(e){function n(n){var r=(0,t.possibleConstructorReturn)(this,e.call(this,n))
return r.params=r.params||{},r}return(0,t.inherits)(n,e),n.prototype.getModel=function(e){var t=this.params
e&&e.queryParams&&(s(t={},this.params),t.queryParams=e.queryParams)
var n=this.handler,r=m(n,"deserialize")||m(n,"model")
return this.runSharedModelHook(e,r,[t])},n}(w)
function O(e,t){var n=new(0,O.klasses[e])(t||{})
return n.factory=O,n}O.klasses={resolved:C,param:T,object:k}
...
return this.applyToHandlers(e,s,n,u,r,null,i)},n.prototype.applyToHandlers=function(e,t,n,r,i,o,a){var u,l,c,p,f,h,d,m,b,v=new g,y=this.contexts.slice(0),_=t.length
if(this.pivotHandler)for(u=0,l=t.length;u<l;++u)if(t[u].handler===this.pivotHandler._handlerName){_=u
break}for(u=t.length-1;u>=0;--u)p=(c=t[u]).handler,f=e.handlerInfos[u],h=null,c.names.length>0?u>=_?h=this.createParamHandlerInfo(p,n,c.names,y,f):(d=a(p),h=this.getHandlerInfoForDynamicSegment(p,n,c.names,y,f,r,u,d)):h=this.createParamHandlerInfo(p,n,c.names,y,f),o&&(h=h.becomeResolved(null,h.context),m=f&&f.context,c.names.length>0&&"context"in f&&h.context===m&&(h.params=f&&f.params),h.context=m),b=f,(u>=_||h.shouldSupercede(f))&&(_=Math.min(u,_),b=h),i&&!o&&(b=b.becomeResolved(null,b.context)),v.handlerInfos.unshift(b)
...
return e}for(u=0,l=p.length;u<l;++u)(o=(i=O("param",{name:(r=p[u]).handler,getHandler:n,params:r.params})).handler)?d(o):i.handlerPromise=i.handlerPromise.then(d),a=e.handlerInfos[u],f||i.shouldSupercede(a)?(f=!0,c.handlerInfos[u]=i):c.handlerInfos[u]=a
return s(c.queryParams,p.queryParams),c},n}(E),M=Array.prototype.pop,A=function(){function e(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{}
...
function N(e,t,n){n&&(e._changedQueryParams=n.all,f(e,t.handlerInfos,!0,["queryParamsDidChange",n.changed,n.all,n.removed]),e._changedQueryParams=null)}function j(e,t,n){var r,i,o,s=function(e,t){var n,r,i,o,s,a=e.handlerInfos,u=t.handlerInfos,l={updatedContext:[],exited:[],entered:[],unchanged:[],reset:void 0},c=!1
...
for(n=f.length-1;n>=0;--n)s(d,(r=f[n]).params),r.handler.inaccessibleByURL&&(c=null)
...
return l}e.default=A,e.Transition=y}),e("rsvp",["exports","ember-babel","node-module"],function(e,t,n){"use strict"
...
t.constructor===e.constructor&&n===S&&e.constructor.resolve===c?function(e,t){t._state===h?w(e,t._result):t._state===d?(t._onError=null,C(e,t._result)):k(t,void 0,function(n){t===n?w(e,n):E(e,n)},function(t){return C(e,t)})}(e,t):n===m?(r=m.error,m.error=null,C(e,r)):"function"==typeof n?function(e,t,n){s.async(function(e){var r,i=!1,o=y(n).call(t,function(n){i||(i=!0,t===n?w(e,n):E(e,n))},function(t){i||(i=!0,C(e,t))},"Settle: "+(e._label||" unknown promise"))
i||o!==m||(i=!0,r=m.error,m.error=null,C(e,r))},e)}(e,t,n):w(e,t)}function E(e,t){var n,r
e===t?w(e,t):(r=typeof(n=t),null===n||"object"!==r&&"function"!==r?w(e,t):_(e,t,b(t)))}function x(e){e._onError&&e._onError(e._result),T(e)}function w(e,t){e._state===f&&(e._result=t,e._state=h,0===e._subscribers.length?s.instrument&&l("fulfilled",e):s.async(T,e))}function C(e,t){e._state===f&&(e._state=d,e._result=t,s.async(x,e))}function k(e,t,n,r){var i=e._subscribers,o=i.length
e._onError=null,i[o]=t,i[o+h]=n,i[o+d]=r,0===o&&e._state&&s.async(T,e)}function T(e){var t,n=e._subscribers,r=e._state
...
s=o?y(n)(r):r,t._state!==f||(s===t?C(t,new TypeError("A promises callback cannot return that same promise.")):s===m?(i=m.error,m.error=null,C(t,i)):o?E(t,s):e===h?w(t,s):e===d&&C(t,s))}function S(e,t,n){var r,i=this._state
if(i===h&&!e||i===d&&!t)return s.instrument&&l("chained",this,this),this
this._onError=null
var o=new this.constructor(p,n),a=this._result
return s.instrument&&l("chained",this,o),i===f?k(this,o,e,t):(r=i===h?e:t,s.async(function(){return O(i,o,r,a)})),o}var R=function(){function e(e,t,n,r){this._instanceConstructor=e,this.promise=new e(p,r),this._abortOnReject=n,this._isUsingOwnPromise=e===N,this._isUsingOwnResolve=e.resolve===c,this._init.apply(this,arguments)}return e.prototype._init=function(e,t){var n=t.length||0
...
this._isUsingOwnResolve?(r=b(e))===S&&e._state!==f?(e._onError=null,this._settledAt(e._state,t,e._result,n)):"function"!=typeof r?this._settledAt(h,t,e,n):this._isUsingOwnPromise?(_(i=new o(p),e,r),this._willSettleAt(i,t,n)):this._willSettleAt(new o(function(t){return t(e)}),t,n):this._willSettleAt(o.resolve(e),t,n)},e.prototype._eachEntry=function(e,t,n){null!==e&&"object"==typeof e?this._settleMaybeThenable(e,t,n):this._setResultAt(h,t,e,n)},e.prototype._settledAt=function(e,t,n,r){var i=this.promise
i._state===f&&(this._abortOnReject&&e===d?C(i,n):(this._setResultAt(e,t,n,r),this._checkFullfillment()))},e.prototype._setResultAt=function(e,t,n){this._remaining--,this._result[t]=n},e.prototype._willSettleAt=function(e,t,n){var r=this
k(e,void 0,function(e){return r._settledAt(h,t,e,n)},function(e){return r._settledAt(d,t,e,n)})},e}()
function P(e,t,n){this._remaining--,this._result[t]=e===h?{state:"fulfilled",value:n}:{state:"rejected",reason:n}}var M="rsvp_"+Date.now()+"-",A=0
...
for(n=0;n<s;++n){if(r=arguments[n],!u){if((u=D(r))===m)return i=m.error,m.error=null,C(o=new N(p),i),o
...
return i}(arguments,t)):E(l,n)},u?function(e,t,n,r){return N.all(t).then(function(t){return I(e,t,n,r)})}(l,a,e,this):I(l,a,e,this)}
return n.__proto__=e,n}function I(e,t,n,r){var i
return y(n).apply(r,t)===m&&(i=m.error,m.error=null,C(e,i)),e}function D(e){return null!==e&&"object"==typeof e&&(e.constructor===N||b(e))}function B(e,t){return N.all(e,t)}N.cast=c,N.all=function(e,t){return Array.isArray(e)?new R(this,e,!0,t).promise:this.reject(new TypeError("Promise.all must be called with an array"),t)},N.race=function(e,t){var n,r=new this(p,t)
if(!Array.isArray(e))return C(r,new TypeError("Promise.race must be called with an array")),r
for(n=0;r._state===f&&n<e.length;n++)k(this.resolve(e[n]),void 0,function(e){return E(r,e)},function(e){return C(r,e)})
return r},N.resolve=c,N.reject=function(e,t){var n=new this(p,t)
return C(n,e),n},N.prototype._guidKey=M,N.prototype.then=S
var F=function(e){function n(n,r,i){return(0,t.possibleConstructorReturn)(this,e.call(this,n,r,!1,i))}return(0,t.inherits)(n,e),n}(R)
function z(e,t){return Array.isArray(e)?new F(N,e,t).promise:N.reject(new TypeError("Promise.allSettled must be called with an array"),t)}function H(e,t){return N.race(e,t)}F.prototype._setResultAt=P
...
function U(e,t){return null===e||"object"!=typeof e?N.reject(new TypeError("Promise.hash must be called with an object"),t):new q(N,e,t).promise}var V=function(e){function n(n,r,i){return(0,t.possibleConstructorReturn)(this,e.call(this,n,r,!1,i))}return(0,t.inherits)(n,e),n}(q)
...
r?(i=y(this._mapFn)(n,t))===m?this._settledAt(d,t,i.error,!1):this._eachEntry(i,t,!1):(this._remaining--,this._result[t]=n)},n}(R)
...
r?(this._result[t]=n,(i=y(this._mapFn)(n,t))===m?this._settledAt(d,t,i.error,!1):this._eachEntry(i,t,!1)):(this._remaining--,n||(this._result[t]=J))},n}(Q)
...
te=0}var fe,he,de,me,be,ge,ve=void 0
ae?(be=process.nextTick,ge=process.versions.node.match(/^(?:(\d+)\.)?(?:(\d+)\.)?(\*|\d+)$/),Array.isArray(ge)&&"0"===ge[1]&&"10"===ge[2]&&(be=setImmediate),ve=function(){return be(pe)}):se?(he=0,de=new se(pe),me=document.createTextNode(""),de.observe(me,{characterData:!0}),ve=function(){return me.data=he=++he%2}):ue?((fe=new MessageChannel).port1.onmessage=pe,ve=function(){return fe.port2.postMessage(0)}):ve=void 0===ie&&"function"==typeof n.require?function(){var e
...
e.default={asap:re,cast:ye,Promise:N,EventTarget:o,all:B,allSettled:z,race:H,hash:U,hashSettled:W,rethrow:Y,defer:G,denodeify:L,configure:a,on:Ee,off:xe,resolve:$,reject:X,map:K,async:_e,filter:ee},e.asap=re,e.cast=ye,e.Promise=N,e.EventTarget=o,e.all=B,e.allSettled=z,e.race=H,e.hash=U,e.hashSettled=W,e.rethrow=Y,e.defer=G,e.denodeify=L,e.configure=a,e.on=Ee,e.off=xe,e.resolve=$,e.reject=X,e.map=K,e.async=_e,e.filter=ee}),t("ember")}(),"undefined"==typeof FastBoot&&function(e,t){"object"==typeof exports&&"undefined"!=typeof module?module.exports=t():"function"==typeof define&&define.amd?define(t):e.Popper=t()}(this,function(){"use strict"
...
var r=n&&n.nodeName
return r&&"BODY"!==r&&"HTML"!==r?-1!==["TH","TD","TABLE"].indexOf(n.nodeName)&&"static"===s(n,"position")?f(n):n:e?e.ownerDocument.documentElement:document.documentElement}function h(e){return null!==e.parentNode?h(e.parentNode):e}function d(e,t){if(!(e&&e.nodeType&&t&&t.nodeType))return document.documentElement
...
function w(e){return x({},e,{right:e.left+e.width,bottom:e.top+e.height})}function C(e){var t={}
...
if(l||c){var f=s(e)
l-=b(f,"x"),c-=b(f,"y"),i.width-=l,i.height-=c}return w(i)}function k(e,t){var n=arguments.length>2&&void 0!==arguments[2]&&arguments[2],r=p(10),i="HTML"===t.nodeName,o=C(e),a=C(t),l=u(e),c=s(t),f=parseFloat(c.borderTopWidth,10),h=parseFloat(c.borderLeftWidth,10)
n&&i&&(a.top=Math.max(a.top,0),a.left=Math.max(a.left,0))
var d=w({top:o.top-a.top-f,left:o.left-a.left-h,width:o.width,height:o.height})
if(d.marginTop=0,d.marginLeft=0,!r&&i){var b=parseFloat(c.marginTop,10),g=parseFloat(c.marginLeft,10)
d.top-=f-b,d.bottom-=f-b,d.left-=h-g,d.right-=h-g,d.marginTop=b,d.marginLeft=g}return(r&&!n?t.contains(l):t===l&&"BODY"!==l.nodeName)&&(d=function(e,t){var n=arguments.length>2&&void 0!==arguments[2]&&arguments[2],r=m(t,"top"),i=m(t,"left"),o=n?-1:1
return e.top+=r*o,e.bottom+=r*o,e.left+=i*o,e.right+=i*o,e}(d,t)),d}function T(e){if(!e||!e.parentElement||p())return document.documentElement
for(var t=e.parentElement;t&&"none"===s(t,"transform");)t=t.parentElement
return t||document.documentElement}function O(e,t,n,r){var i=arguments.length>4&&void 0!==arguments[4]&&arguments[4],o={top:0,left:0},l=i?T(e):d(e,t)
...
return w({top:s-r.top+r.marginTop,left:a-r.left+r.marginLeft,width:i,height:o})}(l,i)
else{var c=void 0
...
else{var f=v(e.ownerDocument),h=f.height,b=f.width
...
var s=O(n,r,o,i),a={top:{width:s.width,height:t.top-s.top},right:{width:s.right-t.right,height:s.height},bottom:{width:s.width,height:s.bottom-t.bottom},left:{width:t.left-s.left,height:s.height}},u=Object.keys(a).map(function(e){return x({key:e},a[e],{area:(t=a[e],t.width*t.height)})
...
return k(n,r?T(t):d(t,n),r)}function P(e){var t=e.ownerDocument.defaultView.getComputedStyle(e),n=parseFloat(t.marginTop)+parseFloat(t.marginBottom),r=parseFloat(t.marginLeft)+parseFloat(t.marginRight)
...
return i[s]=t[s]+t[u]/2-r[u]/2,i[a]=n===a?t[a]-r[l]:t[M(a)],i}function N(e,t){return Array.prototype.find?e.find(t):e.filter(t)[0]}function j(e,t,n){return(void 0===n?e:e.slice(0,function(e,t,n){if(Array.prototype.findIndex)return e.findIndex(function(e){return e[t]===n})
...
e.enabled&&o(n)&&(t.offsets.popper=w(t.offsets.popper),t.offsets.reference=w(t.offsets.reference),t=n(t,e))}),t}function L(e,t){return e.some(function(e){var n=e.name
...
e.offsets.popper=x({},s,c[r])}return e}},offset:{order:200,enabled:!0,fn:function(e,t){var n=t.offset,r=e.placement,i=e.offsets,o=i.popper,s=i.reference,a=r.split("-")[0],u=void 0
return u=z(+n)?[+n,0]:G(n,o,s,a),"left"===a?(o.top+=u[0],o.left-=u[1]):"right"===a?(o.top+=u[0],o.left+=u[1]):"top"===a?(o.left+=u[0],o.top-=u[1]):"bottom"===a&&(o.left+=u[0],o.top+=u[1]),e.popper=o,e},offset:0},preventOverflow:{order:300,enabled:!0,fn:function(e,t){var n=t.boundariesElement||f(e.instance.popper)
...
c=x({},c,p[t](e))}),e.offsets.popper=c,e},priority:["left","right","top","bottom"],padding:5,boundariesElement:"scrollParent"},keepTogether:{order:400,enabled:!0,fn:function(e){var t=e.offsets,n=t.popper,r=t.reference,i=e.placement.split("-")[0],o=Math.floor,s=-1!==["top","bottom"].indexOf(i),a=s?"right":"bottom",u=s?"left":"top",l=s?"width":"height"
...
var i=e.placement.split("-")[0],o=e.offsets,a=o.popper,u=o.reference,l=-1!==["left","right"].indexOf(i),c=l?"height":"width",p=l?"Top":"Left",f=p.toLowerCase(),h=l?"left":"top",d=l?"bottom":"right",m=P(r)[c]
u[d]-m<a[f]&&(e.offsets.popper[f]-=a[f]-(u[d]-m)),u[f]+m>a[d]&&(e.offsets.popper[f]+=u[f]+m-a[d]),e.offsets.popper=w(e.offsets.popper)
...
return _=Math.max(Math.min(a[c]-m,_),0),e.arrowElement=r,e.offsets.arrow=(E(n={},f,Math.round(_)),E(n,h,""),n),e},element:"[x-arrow]"},flip:{order:600,enabled:!0,fn:function(e,t){if(L(e.instance.modifiers,"inner"))return e
if(e.flipped&&e.placement===e.originalPlacement)return e
var n=O(e.instance.popper,e.instance.reference,t.padding,t.boundariesElement,e.positionFixed),r=e.placement.split("-")[0],i=M(r),o=e.placement.split("-")[1]||"",s=[]
...
var l=e.offsets.popper,c=e.offsets.reference,p=Math.floor,f="left"===r&&p(l.right)>p(c.left)||"right"===r&&p(l.left)<p(c.right)||"top"===r&&p(l.bottom)>p(c.top)||"bottom"===r&&p(l.top)<p(c.bottom),h=p(l.left)<p(n.left),d=p(l.right)>p(n.right),m=p(l.top)<p(n.top),b=p(l.bottom)>p(n.bottom),g="left"===r&&h||"right"===r&&d||"top"===r&&m||"bottom"===r&&b,v=-1!==["top","bottom"].indexOf(r),y=!!t.flipVariations&&(v&&"start"===o&&h||v&&"end"===o&&d||!v&&"start"===o&&m||!v&&"end"===o&&b);(f||g||y)&&(e.flipped=!0,(f||g)&&(r=s[u+1]),y&&(o=function(e){return"end"===e?"start":"start"===e?"end":e}(o)),e.placement=r+(o?"-"+o:""),e.offsets.popper=x({},e.offsets.popper,A(e.instance.popper,e.offsets.reference,e.placement)),e=j(e.instance.modifiers,e,"flip"))}),e},behavior:"flip",padding:5,boundariesElement:"viewport"},inner:{order:700,enabled:!1,fn:function(e){var t=e.placement,n=t.split("-")[0],r=e.offsets,i=r.popper,o=r.reference,s=-1!==["left","right"].indexOf(n),a=-1===["top","left"].indexOf(n)
return i[s?"left":"top"]=o[n]-(a?i[s?"width":"height"]:0),e.placement=M(t),e.offsets.popper=w(i),e}},hide:{order:800,enabled:!0,fn:function(e){if(!q(e.instance.modifiers,"hide","preventOverflow"))return e
...
var s=void 0!==o?o:t.gpuAcceleration,a=f(e.instance.popper),u=C(a),l={position:i.position},c={left:Math.floor(i.left),top:Math.round(i.top),bottom:Math.round(i.bottom),right:Math.floor(i.right)},p="bottom"===n?"top":"bottom",h="right"===r?"left":"right",d=I("transform"),m=void 0,b=void 0
if(b="bottom"===p?"HTML"===a.nodeName?-a.clientHeight+c.bottom:-u.height+c.bottom:c.top,m="right"===h?"HTML"===a.nodeName?-a.clientWidth+c.right:-u.width+c.right:c.left,s&&d)l[d]="translate3d("+m+"px, "+b+"px, 0)",l[p]=0,l[h]=0,l.willChange="transform"
else{var g="bottom"===p?-1:1,v="right"===h?-1:1
l[p]=b*g,l[h]=m*v,l.willChange=p+", "+h}var y={"x-placement":e.placement}
return e.attributes=x({},y,e.attributes),e.styles=x({},l,e.styles),e.arrowStyles=x({},e.offsets.arrow,e.arrowStyles),e},gpuAcceleration:!0,x:"bottom",y:"right"},applyStyle:{order:900,enabled:!0,fn:function(e){var t,n
return H(e.instance.popper,e.styles),t=e.instance.popper,n=e.attributes,Object.keys(n).forEach(function(e){!1!==n[e]?t.setAttribute(e,n[e]):t.removeAttribute(e)}),e.arrowElement&&Object.keys(e.arrowStyles).length&&H(e.arrowElement,e.arrowStyles),e},onLoad:function(e,t,n,r,i){var o=R(i,t,e,n.positionFixed),s=S(n.placement,o,t,e,n.modifiers.flip.boundariesElement,n.modifiers.flip.padding)
...
for(var n in t)e(n,t[n])}}(),e("jquery",{default:self.jQuery}),e("rsvp",{default:Ember.RSVP})}(),function(){var e={version:"3.4.11"}
Date.now||(Date.now=function(){return+new Date})
var t=[].slice,n=function(e){return t.call(e)},r=document,i=r.documentElement,o=window
try{n(i.childNodes)[0].nodeType}catch(Ma){n=function(e){for(var t=e.length,n=new Array(t);t--;)n[t]=e[t]
return n}}try{r.createElement("div").style.setProperty("opacity",0,"")}catch(Aa){var s=o.Element.prototype,a=s.setAttribute,u=s.setAttributeNS,l=o.CSSStyleDeclaration.prototype,c=l.setProperty
s.setAttribute=function(e,t){a.call(this,e,t+"")},s.setAttributeNS=function(e,t,n){u.call(this,e,t,n+"")},l.setProperty=function(e,t,n){c.call(this,e,t+"",n)}}function p(e,t){return e<t?-1:e>t?1:e>=t?0:NaN}function f(e){return null!=e&&!isNaN(e)}function h(e){return{left:function(t,n,r,i){for(arguments.length<3&&(r=0),arguments.length<4&&(i=t.length);r<i;){var o=r+i>>>1
...
e(t[o],n)>0?i=o:r=o+1}return r}}}e.ascending=p,e.descending=function(e,t){return t<e?-1:t>e?1:t>=e?0:NaN},e.min=function(e,t){var n,r,i=-1,o=e.length
...
for(;++i<o;)null!=(r=t.call(e,e[i],i))&&r>n&&(n=r)}return n},e.extent=function(e,t){var n,r,i,o=-1,s=e.length
if(1===arguments.length){for(;++o<s&&!(null!=(n=i=e[o])&&n<=n);)n=i=void 0
for(;++o<s;)null!=(r=e[o])&&(n>r&&(n=r),i<r&&(i=r))}else{for(;++o<s&&!(null!=(n=i=t.call(e,e[o],o))&&n<=n);)n=void 0
for(;++o<s;)null!=(r=t.call(e,e[o],o))&&(n>r&&(n=r),i<r&&(i=r))}return[n,i]},e.sum=function(e,t){var n,r=0,i=e.length,o=-1
if(1===arguments.length)for(;++o<i;)isNaN(n=+e[o])||(r+=n)
else for(;++o<i;)isNaN(n=+t.call(e,e[o],o))||(r+=n)
return r},e.mean=function(e,t){var n,r=0,i=e.length,o=-1,s=i
if(1===arguments.length)for(;++o<i;)f(n=e[o])?r+=n:--s
else for(;++o<i;)f(n=t.call(e,e[o],o))?r+=n:--s
return s?r/s:void 0},e.quantile=function(e,t){var n=(e.length-1)*t+1,r=Math.floor(n),i=+e[r-1],o=n-r
return o?i+o*(e[r]-i):i},e.median=function(t,n){return arguments.length>1&&(t=t.map(n)),(t=t.filter(f)).length?e.quantile(t.sort(p),.5):void 0}
var d=h(p)
function m(e){return e.length}e.bisectLeft=d.left,e.bisect=e.bisectRight=d.right,e.bisector=function(e){return h(1===e.length?function(t,n){return p(e(t),n)}:e)},e.shuffle=function(e){for(var t,n,r=e.length;r;)n=Math.random()*r--|0,t=e[r],e[r]=e[n],e[n]=t
...
for(var t=-1,n=e.min(arguments,m),r=new Array(n);++t<n;)for(var i,o=-1,s=r[t]=new Array(i);++o<i;)s[o]=arguments[o][t]
...
return t},e.merge=function(e){for(var t,n,r,i=e.length,o=-1,s=0;++o<i;)s+=e[o].length
for(n=new Array(s);--i>=0;)for(t=(r=e[i]).length;--t>=0;)n[--s]=r[t]
return n}
var b=Math.abs
function g(e,t){try{for(var n in t)Object.defineProperty(e.prototype,n,{value:t[n],enumerable:!1})}catch(Ma){e.prototype=t}}function v(){}e.range=function(e,t,n){if(arguments.length<3&&(n=1,arguments.length<2&&(t=e,e=0)),(t-e)/n==1/0)throw new Error("infinite range")
var r,i=[],o=function(e){var t=1
for(;e*t%1;)t*=10
return t}(b(n)),s=-1
if(e*=o,t*=o,(n*=o)<0)for(;(r=e+n*++s)>t;)i.push(r/o)
else for(;(r=e+n*++s)<t;)i.push(r/o)
return i},e.map=function(e){var t=new v
if(e instanceof v)e.forEach(function(e,n){t.set(e,n)})
else for(var n in e)t.set(n,e[n])
return t},g(v,{has:E,get:function(e){return this[y+e]},set:function(e,t){return this[y+e]=t},remove:function(e){return(e=y+e)in this&&delete this[e]},keys:x,values:function(){var e=[]
return this.forEach(function(t,n){e.push(n)}),e},entries:function(){var e=[]
return this.forEach(function(t,n){e.push({key:t,value:n})}),e},size:w,empty:C,forEach:function(e){for(var t in this)t.charCodeAt(0)===_&&e.call(this,t.substring(1),this[t])}})
var y="\0",_=y.charCodeAt(0)
function E(e){return y+e in this}function x(){var e=[]
return this.forEach(function(t){e.push(t)}),e}function w(){var e=0
for(var t in this)t.charCodeAt(0)===_&&++e
return e}function C(){for(var e in this)if(e.charCodeAt(0)===_)return!1
return!0}function k(){}function T(e,t,n){return function(){var r=n.apply(t,arguments)
return r===t?e:r}}function O(e,t){if(t in e)return t
t=t.charAt(0).toUpperCase()+t.substring(1)
for(var n=0,r=S.length;n<r;++n){var i=S[n]+t
if(i in e)return i}}e.nest=function(){var t,n,r={},i=[],o=[]
function s(e,o,a){if(a>=i.length)return n?n.call(r,o):t?o.sort(t):o
for(var u,l,c,p,f=-1,h=o.length,d=i[a++],m=new v;++f<h;)(p=m.get(u=d(l=o[f])))?p.push(l):m.set(u,[l])
return e?(l=e(),c=function(t,n){l.set(t,s(e,n,a))}):(l={},c=function(t,n){l[t]=s(e,n,a)}),m.forEach(c),l}return r.map=function(e,t){return s(t,e,0)},r.entries=function(t){return function e(t,n){if(n>=i.length)return t
var r=[],s=o[n++]
return t.forEach(function(t,i){r.push({key:t,values:e(i,n)})}),s?r.sort(function(e,t){return s(e.key,t.key)}):r}(s(e.map,t,0),0)},r.key=function(e){return i.push(e),r},r.sortKeys=function(e){return o[i.length-1]=e,r},r.sortValues=function(e){return t=e,r},r.rollup=function(e){return n=e,r},r},e.set=function(e){var t=new k
if(e)for(var n=0,r=e.length;n<r;++n)t.add(e[n])
return t},g(k,{has:E,add:function(e){return this[y+e]=!0,e},remove:function(e){return(e=y+e)in this&&delete this[e]},values:x,size:w,empty:C,forEach:function(e){for(var t in this)t.charCodeAt(0)===_&&e.call(this,t.substring(1))}}),e.behavior={},e.rebind=function(e,t){for(var n,r=1,i=arguments.length;++r<i;)e[n=arguments[r]]=T(e,t,t[n])
return e}
var S=["webkit","ms","moz","Moz","o","O"]
function R(){}function P(){}function M(e){var t=[],n=new v
function r(){for(var n,r=t,i=-1,o=r.length;++i<o;)(n=r[i].on)&&n.apply(this,arguments)
return e}return r.on=function(r,i){var o,s=n.get(r)
return arguments.length<2?s&&s.on:(s&&(s.on=null,t=t.slice(0,o=t.indexOf(s)).concat(t.slice(o+1)),n.remove(r)),i&&t.push(n.set(r,{on:i})),e)},r}function A(){e.event.preventDefault()}function N(){for(var t,n=e.event;t=n.sourceEvent;)n=t
return n}function j(t){for(var n=new P,r=0,i=arguments.length;++r<i;)n[arguments[r]]=M(n)
return n.of=function(r,i){return function(o){try{var s=o.sourceEvent=e.event
o.target=t,e.event=o,n[o.type].apply(r,i)}finally{e.event=s}}},n}e.dispatch=function(){for(var e=new P,t=-1,n=arguments.length;++t<n;)e[arguments[t]]=M(e)
return e},P.prototype.on=function(e,t){var n=e.indexOf("."),r=""
...
var L=/[\\\^\$\*\+\?\|\[\]\(\)\.\{\}]/g,I={}.__proto__?function(e,t){e.__proto__=t}:function(e,t){for(var n in t)e[n]=t[n]}
function D(e){return I(e,q),e}var B=function(e,t){return t.querySelector(e)},F=function(e,t){return t.querySelectorAll(e)},z=i.matches||i[O(i,"matchesSelector")],H=function(e,t){return z.call(e,t)}
"function"==typeof Sizzle&&(B=function(e,t){return Sizzle(e,t)[0]||null},F=Sizzle,H=Sizzle.matchesSelector),e.selection=function(){return ae}
var q=e.selection.prototype=[]
function U(e){return"function"==typeof e?e:function(){return B(e,this)}}function V(e){return"function"==typeof e?e:function(){return F(e,this)}}q.select=function(e){var t,n,r,i,o=[]
e=U(e)
for(var s=-1,a=this.length;++s<a;){o.push(t=[]),t.parentNode=(r=this[s]).parentNode
for(var u=-1,l=r.length;++u<l;)(i=r[u])?(t.push(n=e.call(i,i.__data__,u,s)),n&&"__data__"in i&&(n.__data__=i.__data__)):t.push(null)}return D(o)},q.selectAll=function(e){var t,r,i=[]
e=V(e)
for(var o=-1,s=this.length;++o<s;)for(var a=this[o],u=-1,l=a.length;++u<l;)(r=a[u])&&(i.push(t=n(e.call(r,r.__data__,u,o))),t.parentNode=r)
return D(i)}
...
null==e?this.removeAttribute(t):this.setAttribute(t,e)}:t.local?function(){this.setAttributeNS(t.space,t.local,n)}:function(){this.setAttribute(t,n)}}function G(e){return e.trim().replace(/\s+/g," ")}function Q(t){return new RegExp("(?:^|\\s+)"+e.requote(t)+"(?:\\s+|$)","g")}function K(e){return(e+"").trim().split(/^|\s+/)}function $(e,t){var n=(e=K(e).map(X)).length
return"function"==typeof t?function(){for(var r=-1,i=t.apply(this,arguments);++r<n;)e[r](this,i)}:function(){for(var r=-1;++r<n;)e[r](this,t)}}function X(e){var t=Q(e)
return function(n,r){if(i=n.classList)return r?i.add(e):i.remove(e)
var i=n.getAttribute("class")||""
r?(t.lastIndex=0,t.test(i)||n.setAttribute("class",G(i+" "+e))):n.setAttribute("class",G(i.replace(t," ")))}}function J(e,t,n){return null==t?function(){this.style.removeProperty(e)}:"function"==typeof t?function(){var r=t.apply(this,arguments)
null==r?this.style.removeProperty(e):this.style.setProperty(e,r,n)}:function(){this.style.setProperty(e,t,n)}}function Z(e,t){return null==t?function(){delete this[e]}:"function"==typeof t?function(){var n=t.apply(this,arguments)
null==n?delete this[e]:this[e]=n}:function(){this[e]=t}}function ee(t){return"function"==typeof t?t:(t=e.ns.qualify(t)).local?function(){return this.ownerDocument.createElementNS(t.space,t.local)}:function(){return this.ownerDocument.createElementNS(this.namespaceURI,t)}}function te(e){return{__data__:e}}function ne(e){return function(){return H(this,e)}}function re(e,t){for(var n=0,r=e.length;n<r;n++)for(var i,o=e[n],s=0,a=o.length;s<a;s++)(i=o[s])&&t(i,s,n)
return e}function ie(e){return I(e,oe),e}e.ns={prefix:W,qualify:function(e){var t=e.indexOf(":"),n=e
return t>=0&&(n=e.substring(0,t),e=e.substring(t+1)),W.hasOwnProperty(n)?{space:W[n],local:e}:e}},q.attr=function(t,n){if(arguments.length<2){if("string"==typeof t){var r=this.node()
return(t=e.ns.qualify(t)).local?r.getAttributeNS(t.space,t.local):r.getAttribute(t)}for(n in t)this.each(Y(n,t[n]))
return this}return this.each(Y(t,n))},q.classed=function(e,t){if(arguments.length<2){if("string"==typeof e){var n=this.node(),r=(e=K(e)).length,i=-1
if(t=n.classList){for(;++i<r;)if(!t.contains(e[i]))return!1}else for(t=n.getAttribute("class");++i<r;)if(!Q(e[i]).test(t))return!1
return!0}for(t in e)this.each($(t,e[t]))
return this}return this.each($(e,t))},q.style=function(e,t,n){var r=arguments.length
...
n=""}return this.each(J(e,t,n))},q.property=function(e,t){if(arguments.length<2){if("string"==typeof e)return this.node()[e]
for(t in e)this.each(Z(t,e[t]))
return this}return this.each(Z(e,t))},q.text=function(e){return arguments.length?this.each("function"==typeof e?function(){var t=e.apply(this,arguments)
this.textContent=null==t?"":t}:null==e?function(){this.textContent=""}:function(){this.textContent=e}):this.node().textContent},q.html=function(e){return arguments.length?this.each("function"==typeof e?function(){var t=e.apply(this,arguments)
this.innerHTML=null==t?"":t}:null==e?function(){this.innerHTML=""}:function(){this.innerHTML=e}):this.node().innerHTML},q.append=function(e){return e=ee(e),this.select(function(){return this.appendChild(e.apply(this,arguments))})},q.insert=function(e,t){return e=ee(e),t=U(t),this.select(function(){return this.insertBefore(e.apply(this,arguments),t.apply(this,arguments)||null)})},q.remove=function(){return this.each(function(){var e=this.parentNode
e&&e.removeChild(this)})},q.data=function(e,t){var n,r,i=-1,o=this.length
if(!arguments.length){for(e=new Array(o=(n=this[0]).length);++i<o;)(r=n[i])&&(e[i]=r.__data__)
return e}function s(e,n){var r,i,o,s=e.length,c=n.length,p=Math.min(s,c),f=new Array(c),h=new Array(c),d=new Array(s)
if(t){var m,b=new v,g=new v,y=[]
for(r=-1;++r<s;)m=t.call(i=e[r],i.__data__,r),b.has(m)?d[r]=i:b.set(m,i),y.push(m)
for(r=-1;++r<c;)m=t.call(n,o=n[r],r),(i=b.get(m))?(f[r]=i,i.__data__=o):g.has(m)||(h[r]=te(o)),g.set(m,o),b.remove(m)
for(r=-1;++r<s;)b.has(y[r])&&(d[r]=e[r])}else{for(r=-1;++r<p;)i=e[r],o=n[r],i?(i.__data__=o,f[r]=i):h[r]=te(o)
for(;r<c;++r)h[r]=te(n[r])
for(;r<s;++r)d[r]=e[r]}h.update=f,h.parentNode=f.parentNode=d.parentNode=e.parentNode,a.push(h),u.push(f),l.push(d)}var a=ie([]),u=D([]),l=D([])
if("function"==typeof e)for(;++i<o;)s(n=this[i],e.call(n,n.parentNode.__data__,i))
else for(;++i<o;)s(n=this[i],e)
return u.enter=function(){return a},u.exit=function(){return l},u},q.datum=function(e){return arguments.length?this.property("__data__",e):this.property("__data__")},q.filter=function(e){var t,n,r,i=[]
"function"!=typeof e&&(e=ne(e))
for(var o=0,s=this.length;o<s;o++){i.push(t=[]),t.parentNode=(n=this[o]).parentNode
for(var a=0,u=n.length;a<u;a++)(r=n[a])&&e.call(r,r.__data__,a,o)&&t.push(r)}return D(i)},q.order=function(){for(var e=-1,t=this.length;++e<t;)for(var n,r=this[e],i=r.length-1,o=r[i];--i>=0;)(n=r[i])&&(o&&o!==n.nextSibling&&o.parentNode.insertBefore(n,o),o=n)
return this},q.sort=function(e){e=function(e){arguments.length||(e=p)
return function(t,n){return t&&n?e(t.__data__,n.__data__):!t-!n}}.apply(this,arguments)
for(var t=-1,n=this.length;++t<n;)this[t].sort(e)
return this.order()},q.each=function(e){return re(this,function(t,n,r){e.call(t,t.__data__,n,r)})},q.call=function(e){var t=n(arguments)
return e.apply(t[0]=this,t),this},q.empty=function(){return!this.node()},q.node=function(){for(var e=0,t=this.length;e<t;e++)for(var n=this[e],r=0,i=n.length;r<i;r++){var o=n[r]
if(o)return o}return null},q.size=function(){var e=0
return this.each(function(){++e}),e}
var oe=[]
function se(){var e=this.__transition__
e&&++e.active}e.selection.enter=ie,e.selection.enter.prototype=oe,oe.append=q.append,oe.empty=q.empty,oe.node=q.node,oe.call=q.call,oe.size=q.size,oe.select=function(e){for(var t,n,r,i,o,s=[],a=-1,u=this.length;++a<u;){r=(i=this[a]).update,s.push(t=[]),t.parentNode=i.parentNode
for(var l=-1,c=i.length;++l<c;)(o=i[l])?(t.push(r[l]=n=e.call(i.parentNode,o.__data__,l,a)),n.__data__=o.__data__):t.push(null)}return D(s)},oe.insert=function(e,t){var n,r,i
return arguments.length<2&&(n=this,t=function(e,t,o){var s,a=n[o].update,u=a.length
for(o!=i&&(i=o,r=0),t>=r&&(r=t+1);!(s=a[r])&&++r<u;);return s}),q.insert.call(this,e,t)},q.transition=function(){for(var e,t,n=ia||++aa,r=[],i=oa||{time:Date.now(),ease:no,delay:0,duration:250},o=-1,s=this.length;++o<s;){r.push(e=[])
for(var a=this[o],u=-1,l=a.length;++u<l;)(t=a[u])&&ca(t,u,n,i),e.push(t)}return ra(r,n)},q.interrupt=function(){return this.each(se)},e.select=function(e){var t=["string"==typeof e?B(e,r):e]
return t.parentNode=i,D([t])},e.selectAll=function(e){var t=n("string"==typeof e?F(e,r):e)
return t.parentNode=i,D([t])}
var ae=e.select(i)
function ue(t,r,i){var o="__on"+t,s=t.indexOf("."),a=ce
s>0&&(t=t.substring(0,s))
var u=le.get(t)
function l(){var e=this[o]
e&&(this.removeEventListener(t,e,e.$),delete this[o])}return u&&(t=u,a=pe),s?r?function(){var e=a(r,n(arguments))
l.call(this),this.addEventListener(t,this[o]=e,e.$=i),e._=r}:l:r?R:function(){var n,r=new RegExp("^__on([^.]+)"+e.requote(t)+"$")
for(var i in this)if(n=i.match(r)){var o=this[i]
this.removeEventListener(n[1],o,o.$),delete this[i]}}}q.on=function(e,t,n){var r=arguments.length
if(r<3){if("string"!=typeof e){for(n in r<2&&(t=!1),e)this.each(ue(n,e[n],t))
return this}if(r<2)return(r=this.node()["__on"+e])&&r._
n=!1}return this.each(ue(e,t,n))}
var le=e.map({mouseenter:"mouseover",mouseleave:"mouseout"})
function ce(t,n){return function(r){var i=e.event
e.event=r,n[0]=this.__data__
try{t.apply(this,n)}finally{e.event=i}}}function pe(e,t){var n=ce(e,t)
return function(e){var t=e.relatedTarget
t&&(t===this||8&t.compareDocumentPosition(this))||n.call(this,e)}}le.forEach(function(e){"on"+e in r&&le.remove(e)})
var fe="onselectstart"in r?null:O(i.style,"userSelect"),he=0
function de(){var t=".dragsuppress-"+ ++he,n="click"+t,r=e.select(o).on("touchmove"+t,A).on("dragstart"+t,A).on("selectstart"+t,A)
if(fe){var s=i.style,a=s[fe]
s[fe]="none"}return function(e){if(r.on(t,null),fe&&(s[fe]=a),e){function i(){r.on(n,null)}r.on(n,function(){A(),i()},!0),setTimeout(i,0)}}}e.mouse=function(e){return be(e,N())}
var me=/WebKit/.test(o.navigator.userAgent)?-1:0
function be(t,n){n.changedTouches&&(n=n.changedTouches[0])
var r=t.ownerSVGElement||t
if(r.createSVGPoint){var i=r.createSVGPoint()
if(me<0&&(o.scrollX||o.scrollY)){var s=(r=e.select("body").append("svg").style({position:"absolute",top:0,left:0,margin:0,padding:0,border:"none"},"important"))[0][0].getScreenCTM()
me=!(s.f||s.e),r.remove()}return me?(i.x=n.pageX,i.y=n.pageY):(i.x=n.clientX,i.y=n.clientY),[(i=i.matrixTransform(t.getScreenCTM().inverse())).x,i.y]}var a=t.getBoundingClientRect()
return[n.clientX-a.left-t.clientLeft,n.clientY-a.top-t.clientTop]}function ge(){return e.event.changedTouches[0].identifier}function ve(){return e.event.target}function ye(){return o}e.touches=function(e,t){return arguments.length<2&&(t=N().touches),t?n(t).map(function(t){var n=be(e,t)
return n.identifier=t.identifier,n}):[]},e.behavior.drag=function(){var t=j(o,"drag","dragstart","dragend"),n=null,r=s(R,e.mouse,ye,"mousemove","mouseup"),i=s(ge,e.touch,ve,"touchmove","touchend")
function o(){this.on("mousedown.drag",r).on("touchstart.drag",i)}function s(r,i,o,s,a){return function(){var u,l=e.event.target,c=this.parentNode,p=t.of(this,arguments),f=0,h=r(),d=".drag"+(null==h?"":"-"+h),m=e.select(o()).on(s+d,function(){var e,t,n=i(c,h)
if(!n)return
e=n[0]-g[0],t=n[1]-g[1],f|=e|t,g=n,p({type:"drag",x:n[0]+u[0],y:n[1]+u[1],dx:e,dy:t})}).on(a+d,function(){if(!i(c,h))return
m.on(s+d,null).on(a+d,null),b(f&&e.event.target===l),p({type:"dragend"})}),b=de(),g=i(c,h)
u=n?[(u=n.apply(this,arguments)).x-g[0],u.y-g[1]]:[0,0],p({type:"dragstart"})}}return o.origin=function(e){return arguments.length?(n=e,o):n},e.rebind(o,t,"on")}
var _e=Math.PI,Ee=2*_e,xe=_e/2,we=1e-6,Ce=we*we,ke=_e/180,Te=180/_e
function Oe(e){return e>0?1:e<0?-1:0}function Se(e,t,n){return(t[0]-e[0])*(n[1]-e[1])-(t[1]-e[1])*(n[0]-e[0])}function Re(e){return e>1?0:e<-1?_e:Math.acos(e)}function Pe(e){return e>1?xe:e<-1?-xe:Math.asin(e)}function Me(e){return((e=Math.exp(e))+1/e)/2}function Ae(e){return(e=Math.sin(e/2))*e}var Ne=Math.SQRT2,je=2
e.interpolateZoom=function(e,t){var n=e[0],r=e[1],i=e[2],o=t[0],s=t[1],a=t[2],u=o-n,l=s-r,c=u*u+l*l,p=Math.sqrt(c),f=(a*a-i*i+4*c)/(2*i*je*p),h=(a*a-i*i-4*c)/(2*a*je*p),d=Math.log(Math.sqrt(f*f+1)-f),m=Math.log(Math.sqrt(h*h+1)-h)-d,b=(m||Math.log(a/i))/Ne
function g(e){var t,o=e*b
if(m){var s=Me(d),a=i/(je*p)*(s*(t=Ne*o+d,((t=Math.exp(2*t))-1)/(t+1))-function(e){return((e=Math.exp(e))-1/e)/2}(d))
return[n+a*u,r+a*l,i*s/Me(Ne*o+d)]}return[n+e*u,r+e*l,i*Math.exp(Ne*o)]}return g.duration=1e3*b,g},e.behavior.zoom=function(){var t,n,r,i,s,a,u,l,c,p={x:0,y:0,k:1},f=[960,500],h=Ie,d="mousedown.zoom",m="mousemove.zoom",b="mouseup.zoom",g="touchstart.zoom",v=j(y,"zoomstart","zoom","zoomend")
function y(e){e.on(d,O).on(De+".zoom",R).on("dblclick.zoom",P).on(g,S)}function _(e){return[(e[0]-p.x)/p.k,(e[1]-p.y)/p.k]}function E(e){p.k=Math.max(h[0],Math.min(h[1],e))}function x(e,t){t=function(e){return[e[0]*p.k+p.x,e[1]*p.k+p.y]}(t),p.x+=e[0]-t[0],p.y+=e[1]-t[1]}function w(){u&&u.domain(a.range().map(function(e){return(e-p.x)/p.k}).map(a.invert)),c&&c.domain(l.range().map(function(e){return(e-p.y)/p.k}).map(l.invert))}function C(e){e({type:"zoomstart"})}function k(e){w(),e({type:"zoom",scale:p.k,translate:[p.x,p.y]})}function T(e){e({type:"zoomend"})}function O(){var t=this,n=e.event.target,r=v.of(t,arguments),i=0,s=e.select(o).on(m,function(){i=1,x(e.mouse(t),a),k(r)}).on(b,function(){s.on(m,null).on(b,null),u(i&&e.event.target===n),T(r)}),a=_(e.mouse(t)),u=de()
se.call(t),C(r)}function S(){var t,n=this,r=v.of(n,arguments),i={},o=0,a=".zoom-"+e.event.changedTouches[0].identifier,u="touchmove"+a,l="touchend"+a,c=[],f=e.select(n).on(d,null).on(g,b),h=de()
function m(){var r=e.touches(n)
return t=p.k,r.forEach(function(e){e.identifier in i&&(i[e.identifier]=_(e))}),r}function b(){var t=e.event.target
e.select(t).on(u,y).on(l,w),c.push(t)
for(var n=e.event.changedTouches,a=0,f=n.length;a<f;++a)i[n[a].identifier]=null
var h=m(),d=Date.now()
if(1===h.length){if(d-s<500){var b=h[0],g=i[b.identifier]
E(2*p.k),x(b,g),A(),k(r)}s=d}else if(h.length>1){b=h[0]
var v=h[1],_=b[0]-v[0],C=b[1]-v[1]
o=_*_+C*C}}function y(){for(var a,u,l,c,p=e.touches(n),f=0,h=p.length;f<h;++f,c=null)if(l=p[f],c=i[l.identifier]){if(u)break
a=l,u=c}if(c){var d=(d=l[0]-a[0])*d+(d=l[1]-a[1])*d,m=o&&Math.sqrt(d/o)
a=[(a[0]+l[0])/2,(a[1]+l[1])/2],u=[(u[0]+c[0])/2,(u[1]+c[1])/2],E(m*t)}s=null,x(a,u),k(r)}function w(){if(e.event.touches.length){for(var t=e.event.changedTouches,n=0,o=t.length;n<o;++n)delete i[t[n].identifier]
for(var s in i)return void m()}e.selectAll(c).on(a,null),f.on(d,O).on(g,S),h(),T(r)}se.call(n),b(),C(r)}function R(){var o=v.of(this,arguments)
i?clearTimeout(i):(t=_(n=r||e.mouse(this)),se.call(this),C(o)),i=setTimeout(function(){i=null,T(o)},50),A(),E(Math.pow(2,.002*Le())*p.k),x(n,t),k(o)}function P(){var t=v.of(this,arguments),n=e.mouse(this),r=_(n),i=Math.log(p.k)/Math.LN2
C(t),E(Math.pow(2,e.event.shiftKey?Math.ceil(i)-1:Math.floor(i)+1)),x(n,r),k(t),T(t)}return y.event=function(t){t.each(function(){var t=v.of(this,arguments),n=p
ia?e.select(this).transition().each("start.zoom",function(){p=this.__chart__||{x:0,y:0,k:1},C(t)}).tween("zoom:zoom",function(){var r=f[0],i=f[1],o=r/2,s=i/2,a=e.interpolateZoom([(o-p.x)/p.k,(s-p.y)/p.k,r/p.k],[(o-n.x)/n.k,(s-n.y)/n.k,r/n.k])
return function(e){var n=a(e),i=r/n[2]
this.__chart__=p={x:o-n[0]*i,y:s-n[1]*i,k:i},k(t)}}).each("end.zoom",function(){T(t)}):(this.__chart__=p,C(t),k(t),T(t))})},y.translate=function(e){return arguments.length?(p={x:+e[0],y:+e[1],k:p.k},w(),y):[p.x,p.y]},y.scale=function(e){return arguments.length?(p={x:p.x,y:p.y,k:+e},w(),y):p.k},y.scaleExtent=function(e){return arguments.length?(h=null==e?Ie:[+e[0],+e[1]],y):h},y.center=function(e){return arguments.length?(r=e&&[+e[0],+e[1]],y):r},y.size=function(e){return arguments.length?(f=e&&[+e[0],+e[1]],y):f},y.x=function(e){return arguments.length?(u=e,a=e.copy(),p={x:0,y:0,k:1},y):u},y.y=function(e){return arguments.length?(c=e,l=e.copy(),p={x:0,y:0,k:1},y):c},e.rebind(y,v,"on")}
var Le,Ie=[0,1/0],De="onwheel"in r?(Le=function(){return-e.event.deltaY*(e.event.deltaMode?120:1)},"wheel"):"onmousewheel"in r?(Le=function(){return e.event.wheelDelta},"mousewheel"):(Le=function(){return-e.event.detail},"MozMousePixelScroll")
function Be(){}function Fe(e,t,n){return this instanceof Fe?(this.h=+e,this.s=+t,void(this.l=+n)):arguments.length<2?e instanceof Fe?new Fe(e.h,e.s,e.l):at(""+e,ut,Fe):new Fe(e,t,n)}e.color=Be,Be.prototype.toString=function(){return this.rgb()+""},e.hsl=Fe
var ze=Fe.prototype=new Be
function He(e,t,n){var r,i
function o(e){return Math.round(255*function(e){return e>360?e-=360:e<0&&(e+=360),e<60?r+(i-r)*e/60:e<180?i:e<240?r+(i-r)*(240-e)/60:r}(e))}return e=isNaN(e)?0:(e%=360)<0?e+360:e,t=isNaN(t)?0:t<0?0:t>1?1:t,r=2*(n=n<0?0:n>1?1:n)-(i=n<=.5?n*(1+t):n+t-n*t),new nt(o(e+120),o(e),o(e-120))}function qe(t,n,r){return this instanceof qe?(this.h=+t,this.c=+n,void(this.l=+r)):arguments.length<2?t instanceof qe?new qe(t.h,t.c,t.l):Je(t instanceof We?t.l:(t=lt((t=e.rgb(t)).r,t.g,t.b)).l,t.a,t.b):new qe(t,n,r)}ze.brighter=function(e){return e=Math.pow(.7,arguments.length?e:1),new Fe(this.h,this.s,this.l/e)},ze.darker=function(e){return e=Math.pow(.7,arguments.length?e:1),new Fe(this.h,this.s,e*this.l)},ze.rgb=function(){return He(this.h,this.s,this.l)},e.hcl=qe
var Ue=qe.prototype=new Be
function Ve(e,t,n){return isNaN(e)&&(e=0),isNaN(t)&&(t=0),new We(n,Math.cos(e*=ke)*t,Math.sin(e)*t)}function We(e,t,n){return this instanceof We?(this.l=+e,this.a=+t,void(this.b=+n)):arguments.length<2?e instanceof We?new We(e.l,e.a,e.b):e instanceof qe?Ve(e.l,e.c,e.h):lt((e=nt(e)).r,e.g,e.b):new We(e,t,n)}Ue.brighter=function(e){return new qe(this.h,this.c,Math.min(100,this.l+Ye*(arguments.length?e:1)))},Ue.darker=function(e){return new qe(this.h,this.c,Math.max(0,this.l-Ye*(arguments.length?e:1)))},Ue.rgb=function(){return Ve(this.h,this.c,this.l).rgb()},e.lab=We
var Ye=18,Ge=.95047,Qe=1,Ke=1.08883,$e=We.prototype=new Be
function Xe(e,t,n){var r=(e+16)/116,i=r+t/500,o=r-n/200
return new nt(tt(3.2404542*(i=Ze(i)*Ge)-1.5371385*(r=Ze(r)*Qe)-.4985314*(o=Ze(o)*Ke)),tt(-.969266*i+1.8760108*r+.041556*o),tt(.0556434*i-.2040259*r+1.0572252*o))}function Je(e,t,n){return e>0?new qe(Math.atan2(n,t)*Te,Math.sqrt(t*t+n*n),e):new qe(NaN,NaN,e)}function Ze(e){return e>.206893034?e*e*e:(e-4/29)/7.787037}function et(e){return e>.008856?Math.pow(e,1/3):7.787037*e+4/29}function tt(e){return Math.round(255*(e<=.00304?12.92*e:1.055*Math.pow(e,1/2.4)-.055))}function nt(e,t,n){return this instanceof nt?(this.r=~~e,this.g=~~t,void(this.b=~~n)):arguments.length<2?e instanceof nt?new nt(e.r,e.g,e.b):at(""+e,nt,He):new nt(e,t,n)}function rt(e){return new nt(e>>16,e>>8&255,255&e)}function it(e){return rt(e)+""}$e.brighter=function(e){return new We(Math.min(100,this.l+Ye*(arguments.length?e:1)),this.a,this.b)},$e.darker=function(e){return new We(Math.max(0,this.l-Ye*(arguments.length?e:1)),this.a,this.b)},$e.rgb=function(){return Xe(this.l,this.a,this.b)},e.rgb=nt
var ot=nt.prototype=new Be
function st(e){return e<16?"0"+Math.max(0,e).toString(16):Math.min(255,e).toString(16)}function at(e,t,n){var r,i,o,s=0,a=0,u=0
if(r=/([a-z]+)\((.*)\)/i.exec(e))switch(i=r[2].split(","),r[1]){case"hsl":return n(parseFloat(i[0]),parseFloat(i[1])/100,parseFloat(i[2])/100)
case"rgb":return t(pt(i[0]),pt(i[1]),pt(i[2]))}return(o=ft.get(e))?t(o.r,o.g,o.b):(null==e||"#"!==e.charAt(0)||isNaN(o=parseInt(e.substring(1),16))||(4===e.length?(s=(3840&o)>>4,s|=s>>4,a=240&o,a|=a>>4,u=15&o,u|=u<<4):7===e.length&&(s=(16711680&o)>>16,a=(65280&o)>>8,u=255&o)),t(s,a,u))}function ut(e,t,n){var r,i,o=Math.min(e/=255,t/=255,n/=255),s=Math.max(e,t,n),a=s-o,u=(s+o)/2
return a?(i=u<.5?a/(s+o):a/(2-s-o),r=e==s?(t-n)/a+(t<n?6:0):t==s?(n-e)/a+2:(e-t)/a+4,r*=60):(r=NaN,i=u>0&&u<1?0:r),new Fe(r,i,u)}function lt(e,t,n){var r=et((.4124564*(e=ct(e))+.3575761*(t=ct(t))+.1804375*(n=ct(n)))/Ge),i=et((.2126729*e+.7151522*t+.072175*n)/Qe)
return We(116*i-16,500*(r-i),200*(i-et((.0193339*e+.119192*t+.9503041*n)/Ke)))}function ct(e){return(e/=255)<=.04045?e/12.92:Math.pow((e+.055)/1.055,2.4)}function pt(e){var t=parseFloat(e)
return"%"===e.charAt(e.length-1)?Math.round(2.55*t):t}ot.brighter=function(e){e=Math.pow(.7,arguments.length?e:1)
var t=this.r,n=this.g,r=this.b,i=30
return t||n||r?(t&&t<i&&(t=i),n&&n<i&&(n=i),r&&r<i&&(r=i),new nt(Math.min(255,t/e),Math.min(255,n/e),Math.min(255,r/e))):new nt(i,i,i)},ot.darker=function(e){return new nt((e=Math.pow(.7,arguments.length?e:1))*this.r,e*this.g,e*this.b)},ot.hsl=function(){return ut(this.r,this.g,this.b)},ot.toString=function(){return"#"+st(this.r)+st(this.g)+st(this.b)}
var ft=e.map({aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074})
function ht(e){return"function"==typeof e?e:function(){return e}}function dt(e){return e}function mt(e){return function(t,n,r){return 2===arguments.length&&"function"==typeof n&&(r=n,n=null),bt(t,n,e,r)}}function bt(t,r,i,s){var a={},u=e.dispatch("beforesend","progress","load","error"),l={},c=new XMLHttpRequest,p=null
function f(){var e,t=c.status
if(!t&&c.responseText||t>=200&&t<300||304===t){try{e=i.call(a,c)}catch(Ma){return void u.error.call(a,Ma)}u.load.call(a,e)}else u.error.call(a,c)}return!o.XDomainRequest||"withCredentials"in c||!/^(http(s)?:)?\/\//.test(t)||(c=new XDomainRequest),"onload"in c?c.onload=c.onerror=f:c.onreadystatechange=function(){c.readyState>3&&f()},c.onprogress=function(t){var n=e.event
e.event=t
try{u.progress.call(a,c)}finally{e.event=n}},a.header=function(e,t){return e=(e+"").toLowerCase(),arguments.length<2?l[e]:(null==t?delete l[e]:l[e]=t+"",a)},a.mimeType=function(e){return arguments.length?(r=null==e?null:e+"",a):r},a.responseType=function(e){return arguments.length?(p=e,a):p},a.response=function(e){return i=e,a},["get","post"].forEach(function(e){a[e]=function(){return a.send.apply(a,[e].concat(n(arguments)))}}),a.send=function(e,n,i){if(2===arguments.length&&"function"==typeof n&&(i=n,n=null),c.open(e,t,!0),null==r||"accept"in l||(l.accept=r+",*/*"),c.setRequestHeader)for(var o in l)c.setRequestHeader(o,l[o])
return null!=r&&c.overrideMimeType&&c.overrideMimeType(r),null!=p&&(c.responseType=p),null!=i&&a.on("error",i).on("load",function(e){i(null,e)}),u.beforesend.call(a,c),c.send(null==n?null:n),a},a.abort=function(){return c.abort(),a},e.rebind(a,u,"on"),null==s?a:a.get(function(e){return 1===e.length?function(t,n){e(null==t?n:null)}:e}(s))}ft.forEach(function(e,t){ft.set(e,rt(t))}),e.functor=ht,e.xhr=mt(dt),e.dsv=function(e,t){var n=new RegExp('["'+e+"\n]"),r=e.charCodeAt(0)
function i(e,n,r){arguments.length<3&&(r=n,n=null)
var i=bt(e,t,null==n?o:s(n),r)
return i.row=function(e){return arguments.length?i.response(null==(n=e)?o:s(e)):n},i}function o(e){return i.parse(e.responseText)}function s(e){return function(t){return i.parse(t.responseText,e)}}function a(t){return t.map(u).join(e)}function u(e){return n.test(e)?'"'+e.replace(/\"/g,'""')+'"':e}return i.parse=function(e,t){var n
...
n=t?function(e,n){return t(i(e),n)}:i})},i.parseRows=function(e,t){var n,i,o={},s={},a=[],u=e.length,l=0,c=0
function p(){if(l>=u)return s
if(i)return i=!1,o
var t=l
if(34===e.charCodeAt(t)){for(var n=t;n++<u;)if(34===e.charCodeAt(n)){if(34!==e.charCodeAt(n+1))break;++n}return l=n+2,13===(a=e.charCodeAt(n+1))?(i=!0,10===e.charCodeAt(n+2)&&++l):10===a&&(i=!0),e.substring(t+1,n).replace(/""/g,'"')}for(;l<u;){var a,c=1
if(10===(a=e.charCodeAt(l++)))i=!0
else if(13===a)i=!0,10===e.charCodeAt(l)&&(++l,++c)
else if(a!==r)continue
return e.substring(t,l-c)}return e.substring(t)}for(;(n=p())!==s;){for(var f=[];n!==o&&n!==s;)f.push(n),n=p()
t&&!(f=t(f,c++))||a.push(f)}return a},i.format=function(t){if(Array.isArray(t[0]))return i.formatRows(t)
var n=new k,r=[]
return t.forEach(function(e){for(var t in e)n.has(t)||r.push(n.add(t))}),[r.map(u).join(e)].concat(t.map(function(t){return r.map(function(e){return u(t[e])}).join(e)})).join("\n")},i.formatRows=function(e){return e.map(a).join("\n")},i},e.csv=e.dsv(",","text/csv"),e.tsv=e.dsv("\t","text/tab-separated-values"),e.touch=function(e,t,n){if(arguments.length<3&&(n=t,t=N().changedTouches),t)for(var r,i=0,o=t.length;i<o;++i)if((r=t[i]).identifier===n)return be(e,r)}
var gt,vt,yt,_t,Et,xt=o[O(o,"requestAnimationFrame")]||function(e){setTimeout(e,17)}
function wt(){var e=Ct(),t=kt()-e
t>24?(isFinite(t)&&(clearTimeout(_t),_t=setTimeout(wt,t)),yt=0):(yt=1,xt(wt))}function Ct(){var e=Date.now()
for(Et=gt;Et;)e>=Et.t&&(Et.f=Et.c(e-Et.t)),Et=Et.n
return e}function kt(){for(var e,t=gt,n=1/0;t;)t.f?t=e?e.n=t.n:gt=t.n:(t.t<n&&(n=t.t),t=(e=t).n)
return vt=e,n}function Tt(e,t){return t-(e?Math.ceil(Math.log(e)/Math.LN10):1)}e.timer=function(e,t,n){var r=arguments.length
r<2&&(t=0),r<3&&(n=Date.now())
var i={c:e,t:n+t,f:!1,n:null}
vt?vt.n=i:gt=i,vt=i,yt||(_t=clearTimeout(_t),yt=1,xt(wt))},e.timer.flush=function(){Ct(),kt()},e.round=function(e,t){return t?Math.round(e*(t=Math.pow(10,t)))/t:Math.round(e)}
var Ot=["y","z","a","f","p","n","µ","m","","k","M","G","T","P","E","Z","Y"].map(function(e,t){var n=Math.pow(10,3*b(8-t))
return{scale:t>8?function(e){return e/n}:function(e){return e*n},symbol:e}})
e.formatPrefix=function(t,n){var r=0
return t&&(t<0&&(t*=-1),n&&(t=e.round(t,Tt(t,n))),r=1+Math.floor(1e-12+Math.log(t)/Math.LN10),r=Math.max(-24,Math.min(24,3*Math.floor((r-1)/3)))),Ot[8+r/3]}
var St=/(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,Rt=e.map({b:function(e){return e.toString(2)},c:function(e){return String.fromCharCode(e)},o:function(e){return e.toString(8)},x:function(e){return e.toString(16)},X:function(e){return e.toString(16).toUpperCase()},g:function(e,t){return e.toPrecision(t)},e:function(e,t){return e.toExponential(t)},f:function(e,t){return e.toFixed(t)},r:function(t,n){return(t=e.round(t,Tt(t,n))).toFixed(Math.max(0,Math.min(20,Tt(t*(1+1e-15),n))))}})
function Pt(e){return e+""}var Mt=e.time={},At=Date
function Nt(){this._=new Date(arguments.length>1?Date.UTC.apply(this,arguments):arguments[0])}Nt.prototype={getDate:function(){return this._.getUTCDate()},getDay:function(){return this._.getUTCDay()},getFullYear:function(){return this._.getUTCFullYear()},getHours:function(){return this._.getUTCHours()},getMilliseconds:function(){return this._.getUTCMilliseconds()},getMinutes:function(){return this._.getUTCMinutes()},getMonth:function(){return this._.getUTCMonth()},getSeconds:function(){return this._.getUTCSeconds()},getTime:function(){return this._.getTime()},getTimezoneOffset:function(){return 0},valueOf:function(){return this._.valueOf()},setDate:function(){jt.setUTCDate.apply(this._,arguments)},setDay:function(){jt.setUTCDay.apply(this._,arguments)},setFullYear:function(){jt.setUTCFullYear.apply(this._,arguments)},setHours:function(){jt.setUTCHours.apply(this._,arguments)},setMilliseconds:function(){jt.setUTCMilliseconds.apply(this._,arguments)},setMinutes:function(){jt.setUTCMinutes.apply(this._,arguments)},setMonth:function(){jt.setUTCMonth.apply(this._,arguments)},setSeconds:function(){jt.setUTCSeconds.apply(this._,arguments)},setTime:function(){jt.setTime.apply(this._,arguments)}}
var jt=Date.prototype
function Lt(e,t,n){function r(t){var n=e(t),r=o(n,1)
return t-n<r-t?n:r}function i(n){return t(n=e(new At(n-1)),1),n}function o(e,n){return t(e=new At(+e),n),e}function s(e,r,o){var s=i(e),a=[]
if(o>1)for(;s<r;)n(s)%o||a.push(new Date(+s)),t(s,1)
else for(;s<r;)a.push(new Date(+s)),t(s,1)
return a}e.floor=e,e.round=r,e.ceil=i,e.offset=o,e.range=s
var a=e.utc=It(e)
return a.floor=a,a.round=It(r),a.ceil=It(i),a.offset=It(o),a.range=function(e,t,n){try{At=Nt
var r=new Nt
return r._=e,s(r,t,n)}finally{At=Date}},e}function It(e){return function(t,n){try{At=Nt
var r=new Nt
return r._=t,e(r,n)._}finally{At=Date}}}Mt.year=Lt(function(e){return(e=Mt.day(e)).setMonth(0,1),e},function(e,t){e.setFullYear(e.getFullYear()+t)},function(e){return e.getFullYear()}),Mt.years=Mt.year.range,Mt.years.utc=Mt.year.utc.range,Mt.day=Lt(function(e){var t=new At(2e3,0)
return t.setFullYear(e.getFullYear(),e.getMonth(),e.getDate()),t},function(e,t){e.setDate(e.getDate()+t)},function(e){return e.getDate()-1}),Mt.days=Mt.day.range,Mt.days.utc=Mt.day.utc.range,Mt.dayOfYear=function(e){var t=Mt.year(e)
...
var n=Mt[e]=Lt(function(e){return(e=Mt.day(e)).setDate(e.getDate()-(e.getDay()+t)%7),e},function(e,t){e.setDate(e.getDate()+7*Math.floor(t))},function(e){var n=Mt.year(e).getDay()
return Math.floor((Mt.dayOfYear(e)+(n+t)%7)/7)-(n!==t)})
Mt[e+"s"]=n.range,Mt[e+"s"].utc=n.utc.range,Mt[e+"OfYear"]=function(e){var n=Mt.year(e).getDay()
return Math.floor((Mt.dayOfYear(e)+(n+t)%7)/7)}}),Mt.week=Mt.sunday,Mt.weeks=Mt.sunday.range,Mt.weeks.utc=Mt.sunday.utc.range,Mt.weekOfYear=Mt.sundayOfYear
var Dt={"-":"",_:" ",0:"0"},Bt=/^\s*\d+/,Ft=/^%/
function zt(e,t,n){var r=e<0?"-":"",i=(r?-e:e)+"",o=i.length
return r+(o<n?new Array(n-o+1).join(t)+i:i)}function Ht(t){return new RegExp("^(?:"+t.map(e.requote).join("|")+")","i")}function qt(e){for(var t=new v,n=-1,r=e.length;++n<r;)t.set(e[n].toLowerCase(),n)
return t}function Ut(e,t,n){Bt.lastIndex=0
var r=Bt.exec(t.substring(n,n+1))
return r?(e.w=+r[0],n+r[0].length):-1}function Vt(e,t,n){Bt.lastIndex=0
var r=Bt.exec(t.substring(n))
return r?(e.U=+r[0],n+r[0].length):-1}function Wt(e,t,n){Bt.lastIndex=0
var r=Bt.exec(t.substring(n))
return r?(e.W=+r[0],n+r[0].length):-1}function Yt(e,t,n){Bt.lastIndex=0
var r=Bt.exec(t.substring(n,n+4))
return r?(e.y=+r[0],n+r[0].length):-1}function Gt(e,t,n){Bt.lastIndex=0
var r,i=Bt.exec(t.substring(n,n+2))
return i?(e.y=(r=+i[0])+(r>68?1900:2e3),n+i[0].length):-1}function Qt(e,t,n){return/^[+-]\d{4}$/.test(t=t.substring(n,n+5))?(e.Z=-t,n+5):-1}function Kt(e,t,n){Bt.lastIndex=0
var r=Bt.exec(t.substring(n,n+2))
return r?(e.m=r[0]-1,n+r[0].length):-1}function $t(e,t,n){Bt.lastIndex=0
var r=Bt.exec(t.substring(n,n+2))
return r?(e.d=+r[0],n+r[0].length):-1}function Xt(e,t,n){Bt.lastIndex=0
var r=Bt.exec(t.substring(n,n+3))
return r?(e.j=+r[0],n+r[0].length):-1}function Jt(e,t,n){Bt.lastIndex=0
var r=Bt.exec(t.substring(n,n+2))
return r?(e.H=+r[0],n+r[0].length):-1}function Zt(e,t,n){Bt.lastIndex=0
var r=Bt.exec(t.substring(n,n+2))
return r?(e.M=+r[0],n+r[0].length):-1}function en(e,t,n){Bt.lastIndex=0
var r=Bt.exec(t.substring(n,n+2))
return r?(e.S=+r[0],n+r[0].length):-1}function tn(e,t,n){Bt.lastIndex=0
var r=Bt.exec(t.substring(n,n+3))
return r?(e.L=+r[0],n+r[0].length):-1}function nn(e){var t=e.getTimezoneOffset(),n=t>0?"-":"+",r=~~(b(t)/60),i=b(t)%60
return n+zt(r,"0",2)+zt(i,"0",2)}function rn(e,t,n){Ft.lastIndex=0
var r=Ft.exec(t.substring(n,n+1))
return r?n+r[0].length:-1}function on(e){for(var t=e.length,n=-1;++n<t;)e[n][0]=this(e[n][0])
return function(t){for(var n=0,r=e[n];!r[1](t);)r=e[++n]
return r[0](t)}}e.locale=function(t){return{numberFormat:function(t){var n=t.decimal,r=t.thousands,i=t.grouping,o=t.currency,s=i?function(e){for(var t=e.length,n=[],o=0,s=i[0];t>0&&s>0;)n.push(e.substring(t-=s,t+s)),s=i[o=(o+1)%i.length]
return n.reverse().join(r)}:dt
return function(t){var r=St.exec(t),i=r[1]||" ",a=r[2]||">",u=r[3]||"",l=r[4]||"",c=r[5],p=+r[6],f=r[7],h=r[8],d=r[9],m=1,b="",g="",v=!1
switch(h&&(h=+h.substring(1)),(c||"0"===i&&"="===a)&&(c=i="0",a="=",f&&(p-=Math.floor((p-1)/4))),d){case"n":f=!0,d="g"
break
case"%":m=100,g="%",d="f"
break
case"p":m=100,g="%",d="r"
break
case"b":case"o":case"x":case"X":"#"===l&&(b="0"+d.toLowerCase())
case"c":case"d":v=!0,h=0
break
case"s":m=-1,d="r"}"$"===l&&(b=o[0],g=o[1]),"r"!=d||h||(d="g"),null!=h&&("g"==d?h=Math.max(1,Math.min(21,h)):"e"!=d&&"f"!=d||(h=Math.max(0,Math.min(20,h)))),d=Rt.get(d)||Pt
var y=c&&f
return function(t){var r=g
if(v&&t%1)return""
var o=t<0||0===t&&1/t<0?(t=-t,"-"):u
if(m<0){var l=e.formatPrefix(t,h)
t=l.scale(t),r=l.symbol+g}else t*=m
var _=(t=d(t,h)).lastIndexOf("."),E=_<0?t:t.substring(0,_),x=_<0?"":n+t.substring(_+1)
!c&&f&&(E=s(E))
var w=b.length+E.length+x.length+(y?0:o.length),C=w<p?new Array(w=p-w+1).join(i):""
return y&&(E=s(C+E)),o+=b,t=E+x,("<"===a?o+t+C:">"===a?C+o+t:"^"===a?C.substring(0,w>>=1)+o+t+C.substring(w):o+(y?t:C+t))+r}}}(t),timeFormat:function(t){var n=t.dateTime,r=t.date,i=t.time,o=t.periods,s=t.days,a=t.shortDays,u=t.months,l=t.shortMonths
function c(e){var t=e.length
function n(n){for(var r,i,o,s=[],a=-1,u=0;++a<t;)37===e.charCodeAt(a)&&(s.push(e.substring(u,a)),null!=(i=Dt[r=e.charAt(++a)])&&(r=e.charAt(++a)),(o=E[r])&&(r=o(n,null==i?"e"===r?" ":"0":i)),s.push(r),u=a+1)
return s.push(e.substring(u,a)),s.join("")}return n.parse=function(t){var n={y:1900,m:0,d:1,H:0,M:0,S:0,L:0,Z:null}
if(p(n,e,t,0)!=t.length)return null
"p"in n&&(n.H=n.H%12+12*n.p)
var r=null!=n.Z&&At!==Nt,i=new(r?Nt:At)
return"j"in n?i.setFullYear(n.y,0,n.j):"w"in n&&("W"in n||"U"in n)?(i.setFullYear(n.y,0,1),i.setFullYear(n.y,0,"W"in n?(n.w+6)%7+7*n.W-(i.getDay()+5)%7:n.w+7*n.U-(i.getDay()+6)%7)):i.setFullYear(n.y,n.m,n.d),i.setHours(n.H+Math.floor(n.Z/100),n.M+n.Z%100,n.S,n.L),r?i._:i},n.toString=function(){return e},n}function p(e,t,n,r){for(var i,o,s,a=0,u=t.length,l=n.length;a<u;){if(r>=l)return-1
if(37===(i=t.charCodeAt(a++))){if(s=t.charAt(a++),!(o=x[s in Dt?t.charAt(a++):s])||(r=o(e,n,r))<0)return-1}else if(i!=n.charCodeAt(r++))return-1}return r}c.utc=function(e){var t=c(e)
function n(e){try{var n=new(At=Nt)
return n._=e,t(n)}finally{At=Date}}return n.parse=function(e){try{At=Nt
var n=t.parse(e)
return n&&n._}finally{At=Date}},n.toString=t.toString,n},c.multi=c.utc.multi=on
var f=e.map(),h=Ht(s),d=qt(s),m=Ht(a),b=qt(a),g=Ht(u),v=qt(u),y=Ht(l),_=qt(l)
o.forEach(function(e,t){f.set(e.toLowerCase(),t)})
var E={a:function(e){return a[e.getDay()]},A:function(e){return s[e.getDay()]},b:function(e){return l[e.getMonth()]},B:function(e){return u[e.getMonth()]},c:c(n),d:function(e,t){return zt(e.getDate(),t,2)},e:function(e,t){return zt(e.getDate(),t,2)},H:function(e,t){return zt(e.getHours(),t,2)},I:function(e,t){return zt(e.getHours()%12||12,t,2)},j:function(e,t){return zt(1+Mt.dayOfYear(e),t,3)},L:function(e,t){return zt(e.getMilliseconds(),t,3)},m:function(e,t){return zt(e.getMonth()+1,t,2)},M:function(e,t){return zt(e.getMinutes(),t,2)},p:function(e){return o[+(e.getHours()>=12)]},S:function(e,t){return zt(e.getSeconds(),t,2)},U:function(e,t){return zt(Mt.sundayOfYear(e),t,2)},w:function(e){return e.getDay()},W:function(e,t){return zt(Mt.mondayOfYear(e),t,2)},x:c(r),X:c(i),y:function(e,t){return zt(e.getFullYear()%100,t,2)},Y:function(e,t){return zt(e.getFullYear()%1e4,t,4)},Z:nn,"%":function(){return"%"}},x={a:function(e,t,n){m.lastIndex=0
var r=m.exec(t.substring(n))
return r?(e.w=b.get(r[0].toLowerCase()),n+r[0].length):-1},A:function(e,t,n){h.lastIndex=0
var r=h.exec(t.substring(n))
return r?(e.w=d.get(r[0].toLowerCase()),n+r[0].length):-1},b:function(e,t,n){y.lastIndex=0
var r=y.exec(t.substring(n))
return r?(e.m=_.get(r[0].toLowerCase()),n+r[0].length):-1},B:function(e,t,n){g.lastIndex=0
var r=g.exec(t.substring(n))
return r?(e.m=v.get(r[0].toLowerCase()),n+r[0].length):-1},c:function(e,t,n){return p(e,E.c.toString(),t,n)},d:$t,e:$t,H:Jt,I:Jt,j:Xt,L:tn,m:Kt,M:Zt,p:function(e,t,n){var r=f.get(t.substring(n,n+=2).toLowerCase())
return null==r?-1:(e.p=r,n)},S:en,U:Vt,w:Ut,W:Wt,x:function(e,t,n){return p(e,E.x.toString(),t,n)},X:function(e,t,n){return p(e,E.X.toString(),t,n)},y:Gt,Y:Yt,Z:Qt,"%":rn}
return c}(t)}}
var sn=e.locale({decimal:".",thousands:",",grouping:[3],currency:["$",""],dateTime:"%a %b %e %X %Y",date:"%m/%d/%Y",time:"%H:%M:%S",periods:["AM","PM"],days:["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"],shortDays:["Sun","Mon","Tue","Wed","Thu","Fri","Sat"],months:["January","February","March","April","May","June","July","August","September","October","November","December"],shortMonths:["Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec"]})
function an(){}e.format=sn.numberFormat,e.geo={},an.prototype={s:0,t:0,add:function(e){ln(e,this.t,un),ln(un.s,this.s,this),this.s?this.t+=un.t:this.s=un.t},reset:function(){this.s=this.t=0},valueOf:function(){return this.s}}
var un=new an
function ln(e,t,n){var r=n.s=e+t,i=r-e,o=r-i
n.t=e-o+(t-i)}function cn(e,t){e&&fn.hasOwnProperty(e.type)&&fn[e.type](e,t)}e.geo.stream=function(e,t){e&&pn.hasOwnProperty(e.type)?pn[e.type](e,t):cn(e,t)}
var pn={Feature:function(e,t){cn(e.geometry,t)},FeatureCollection:function(e,t){for(var n=e.features,r=-1,i=n.length;++r<i;)cn(n[r].geometry,t)}},fn={Sphere:function(e,t){t.sphere()},Point:function(e,t){e=e.coordinates,t.point(e[0],e[1],e[2])},MultiPoint:function(e,t){for(var n=e.coordinates,r=-1,i=n.length;++r<i;)e=n[r],t.point(e[0],e[1],e[2])},LineString:function(e,t){hn(e.coordinates,t,0)},MultiLineString:function(e,t){for(var n=e.coordinates,r=-1,i=n.length;++r<i;)hn(n[r],t,0)},Polygon:function(e,t){dn(e.coordinates,t)},MultiPolygon:function(e,t){for(var n=e.coordinates,r=-1,i=n.length;++r<i;)dn(n[r],t)},GeometryCollection:function(e,t){for(var n=e.geometries,r=-1,i=n.length;++r<i;)cn(n[r],t)}}
function hn(e,t,n){var r,i=-1,o=e.length-n
for(t.lineStart();++i<o;)r=e[i],t.point(r[0],r[1],r[2])
t.lineEnd()}function dn(e,t){var n=-1,r=e.length
for(t.polygonStart();++n<r;)hn(e[n],t,1)
t.polygonEnd()}e.geo.area=function(t){return mn=0,e.geo.stream(t,Sn),mn}
var mn,bn,gn,vn,yn,_n,En,xn,wn,Cn,kn,Tn,On=new an,Sn={sphere:function(){mn+=4*_e},point:R,lineStart:R,lineEnd:R,polygonStart:function(){On.reset(),Sn.lineStart=Rn},polygonEnd:function(){var e=2*On
mn+=e<0?4*_e+e:e,Sn.lineStart=Sn.lineEnd=Sn.point=R}}
function Rn(){var e,t,n,r,i
function o(e,t){t=t*ke/2+_e/4
var o=(e*=ke)-n,s=o>=0?1:-1,a=s*o,u=Math.cos(t),l=Math.sin(t),c=i*l,p=r*u+c*Math.cos(a),f=c*s*Math.sin(a)
On.add(Math.atan2(f,p)),n=e,r=u,i=l}Sn.point=function(s,a){Sn.point=o,n=(e=s)*ke,r=Math.cos(a=(t=a)*ke/2+_e/4),i=Math.sin(a)},Sn.lineEnd=function(){o(e,t)}}function Pn(e){var t=e[0],n=e[1],r=Math.cos(n)
return[r*Math.cos(t),r*Math.sin(t),Math.sin(n)]}function Mn(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]}function An(e,t){return[e[1]*t[2]-e[2]*t[1],e[2]*t[0]-e[0]*t[2],e[0]*t[1]-e[1]*t[0]]}function Nn(e,t){e[0]+=t[0],e[1]+=t[1],e[2]+=t[2]}function jn(e,t){return[e[0]*t,e[1]*t,e[2]*t]}function Ln(e){var t=Math.sqrt(e[0]*e[0]+e[1]*e[1]+e[2]*e[2])
e[0]/=t,e[1]/=t,e[2]/=t}function In(e){return[Math.atan2(e[1],e[0]),Pe(e[2])]}function Dn(e,t){return b(e[0]-t[0])<we&&b(e[1]-t[1])<we}e.geo.bounds=function(){var t,n,r,i,o,s,a,u,l,c,p,f={point:h,lineStart:m,lineEnd:g,polygonStart:function(){f.point=v,f.lineStart=y,f.lineEnd=_,l=0,Sn.polygonStart()},polygonEnd:function(){Sn.polygonEnd(),f.point=h,f.lineStart=m,f.lineEnd=g,On<0?(t=-(r=180),n=-(i=90)):l>we?i=90:l<-we&&(n=-90),p[0]=t,p[1]=r}}
function h(e,o){c.push(p=[t=e,r=e]),o<n&&(n=o),o>i&&(i=o)}function d(e,s){var a=Pn([e*ke,s*ke])
if(u){var l=An(u,a),c=An([l[1],-l[0],0],l)
Ln(c),c=In(c)
var p=e-o,f=p>0?1:-1,d=c[0]*Te*f,m=b(p)>180
if(m^(f*o<d&&d<f*e))(g=c[1]*Te)>i&&(i=g)
else if(m^(f*o<(d=(d+360)%360-180)&&d<f*e)){var g;(g=-c[1]*Te)<n&&(n=g)}else s<n&&(n=s),s>i&&(i=s)
m?e<o?E(t,e)>E(t,r)&&(r=e):E(e,r)>E(t,r)&&(t=e):r>=t?(e<t&&(t=e),e>r&&(r=e)):e>o?E(t,e)>E(t,r)&&(r=e):E(e,r)>E(t,r)&&(t=e)}else h(e,s)
u=a,o=e}function m(){f.point=d}function g(){p[0]=t,p[1]=r,f.point=h,u=null}function v(e,t){if(u){var n=e-o
l+=b(n)>180?n+(n>0?360:-360):n}else s=e,a=t
Sn.point(e,t),d(e,t)}function y(){Sn.lineStart()}function _(){v(s,a),Sn.lineEnd(),b(l)>we&&(t=-(r=180)),p[0]=t,p[1]=r,u=null}function E(e,t){return(t-=e)<0?t+360:t}function x(e,t){return e[0]-t[0]}function w(e,t){return t[0]<=t[1]?t[0]<=e&&e<=t[1]:e<t[0]||t[1]<e}return function(o){if(i=r=-(t=n=1/0),c=[],e.geo.stream(o,f),l=c.length){c.sort(x)
for(var s=1,a=[m=c[0]];s<l;++s)w((h=c[s])[0],m)||w(h[1],m)?(E(m[0],h[1])>E(m[0],m[1])&&(m[1]=h[1]),E(h[0],m[1])>E(m[0],m[1])&&(m[0]=h[0])):a.push(m=h)
for(var u,l,h,d=-1/0,m=(s=0,a[l=a.length-1]);s<=l;m=h,++s)h=a[s],(u=E(m[1],h[0]))>d&&(d=u,t=h[0],r=m[1])}return c=p=null,t===1/0||n===1/0?[[NaN,NaN],[NaN,NaN]]:[[t,n],[r,i]]}}(),e.geo.centroid=function(t){bn=gn=vn=yn=_n=En=xn=wn=Cn=kn=Tn=0,e.geo.stream(t,Bn)
var n=Cn,r=kn,i=Tn,o=n*n+r*r+i*i
return o<Ce&&(n=En,r=xn,i=wn,gn<we&&(n=vn,r=yn,i=_n),(o=n*n+r*r+i*i)<Ce)?[NaN,NaN]:[Math.atan2(r,n)*Te,Pe(i/Math.sqrt(o))*Te]}
var Bn={sphere:R,point:Fn,lineStart:Hn,lineEnd:qn,polygonStart:function(){Bn.lineStart=Un},polygonEnd:function(){Bn.lineStart=Hn}}
function Fn(e,t){e*=ke
var n=Math.cos(t*=ke)
zn(n*Math.cos(e),n*Math.sin(e),Math.sin(t))}function zn(e,t,n){vn+=(e-vn)/++bn,yn+=(t-yn)/bn,_n+=(n-_n)/bn}function Hn(){var e,t,n
function r(r,i){r*=ke
var o=Math.cos(i*=ke),s=o*Math.cos(r),a=o*Math.sin(r),u=Math.sin(i),l=Math.atan2(Math.sqrt((l=t*u-n*a)*l+(l=n*s-e*u)*l+(l=e*a-t*s)*l),e*s+t*a+n*u)
gn+=l,En+=l*(e+(e=s)),xn+=l*(t+(t=a)),wn+=l*(n+(n=u)),zn(e,t,n)}Bn.point=function(i,o){i*=ke
var s=Math.cos(o*=ke)
e=s*Math.cos(i),t=s*Math.sin(i),n=Math.sin(o),Bn.point=r,zn(e,t,n)}}function qn(){Bn.point=Fn}function Un(){var e,t,n,r,i
function o(e,t){e*=ke
var o=Math.cos(t*=ke),s=o*Math.cos(e),a=o*Math.sin(e),u=Math.sin(t),l=r*u-i*a,c=i*s-n*u,p=n*a-r*s,f=Math.sqrt(l*l+c*c+p*p),h=n*s+r*a+i*u,d=f&&-Re(h)/f,m=Math.atan2(f,h)
Cn+=d*l,kn+=d*c,Tn+=d*p,gn+=m,En+=m*(n+(n=s)),xn+=m*(r+(r=a)),wn+=m*(i+(i=u)),zn(n,r,i)}Bn.point=function(s,a){e=s,t=a,Bn.point=o,s*=ke
var u=Math.cos(a*=ke)
n=u*Math.cos(s),r=u*Math.sin(s),i=Math.sin(a),zn(n,r,i)},Bn.lineEnd=function(){o(e,t),Bn.lineEnd=qn,Bn.point=Fn}}function Vn(){return!0}function Wn(e,t,n,r,i){var o=[],s=[]
if(e.forEach(function(e){if(!((t=e.length-1)<=0)){var t,n=e[0],r=e[t]
if(Dn(n,r)){i.lineStart()
for(var a=0;a<t;++a)i.point((n=e[a])[0],n[1])
i.lineEnd()}else{var u=new Gn(n,e,null,!0),l=new Gn(n,null,u,!1)
u.o=l,o.push(u),s.push(l),u=new Gn(r,e,null,!1),l=new Gn(r,null,u,!0),u.o=l,o.push(u),s.push(l)}}}),s.sort(t),Yn(o),Yn(s),o.length){for(var a=0,u=n,l=s.length;a<l;++a)s[a].e=u=!u
for(var c,p,f=o[0];;){for(var h=f,d=!0;h.v;)if((h=h.n)===f)return
c=h.z,i.lineStart()
do{if(h.v=h.o.v=!0,h.e){if(d)for(a=0,l=c.length;a<l;++a)i.point((p=c[a])[0],p[1])
else r(h.x,h.n.x,1,i)
h=h.n}else{if(d)for(a=(c=h.p.z).length-1;a>=0;--a)i.point((p=c[a])[0],p[1])
else r(h.x,h.p.x,-1,i)
h=h.p}c=(h=h.o).z,d=!d}while(!h.v)
i.lineEnd()}}}function Yn(e){if(t=e.length){for(var t,n,r=0,i=e[0];++r<t;)i.n=n=e[r],n.p=i,i=n
i.n=n=e[0],n.p=i}}function Gn(e,t,n,r){this.x=e,this.z=t,this.o=n,this.e=r,this.v=!1,this.n=this.p=null}function Qn(t,n,r,i){return function(o,s){var a,u=n(s),l=o.invert(i[0],i[1]),c={point:p,lineStart:h,lineEnd:d,polygonStart:function(){c.point=_,c.lineStart=E,c.lineEnd=x,a=[],m=[]},polygonEnd:function(){c.point=p,c.lineStart=h,c.lineEnd=d,a=e.merge(a)
var t=function(e,t){var n=e[0],r=e[1],i=[Math.sin(n),-Math.cos(n),0],o=0,s=0
On.reset()
for(var a=0,u=t.length;a<u;++a){var l=t[a],c=l.length
if(c)for(var p=l[0],f=p[0],h=p[1]/2+_e/4,d=Math.sin(h),m=Math.cos(h),b=1;;){b===c&&(b=0)
var g=(e=l[b])[0],v=e[1]/2+_e/4,y=Math.sin(v),_=Math.cos(v),E=g-f,x=E>=0?1:-1,w=x*E,C=w>_e,k=d*y
if(On.add(Math.atan2(k*x*Math.sin(w),m*_+k*Math.cos(w))),o+=C?E+x*Ee:E,C^f>=n^g>=n){var T=An(Pn(p),Pn(e))
Ln(T)
var O=An(i,T)
Ln(O)
var S=(C^E>=0?-1:1)*Pe(O[2]);(r>S||r===S&&(T[0]||T[1]))&&(s+=C^E>=0?1:-1)}if(!b++)break
f=g,d=y,m=_,p=e}}return(o<-we||o<we&&On<0)^1&s}(l,m)
a.length?(y||(s.polygonStart(),y=!0),Wn(a,Xn,t,r,s)):t&&(y||(s.polygonStart(),y=!0),s.lineStart(),r(null,null,1,s),s.lineEnd()),y&&(s.polygonEnd(),y=!1),a=m=null},sphere:function(){s.polygonStart(),s.lineStart(),r(null,null,1,s),s.lineEnd(),s.polygonEnd()}}
function p(e,n){var r=o(e,n)
t(e=r[0],n=r[1])&&s.point(e,n)}function f(e,t){var n=o(e,t)
u.point(n[0],n[1])}function h(){c.point=f,u.lineStart()}function d(){c.point=p,u.lineEnd()}var m,b,g=$n(),v=n(g),y=!1
function _(e,t){b.push([e,t])
var n=o(e,t)
v.point(n[0],n[1])}function E(){v.lineStart(),b=[]}function x(){_(b[0][0],b[0][1]),v.lineEnd()
var e,t=v.clean(),n=g.buffer(),r=n.length
if(b.pop(),m.push(b),b=null,r)if(1&t){var i,o=-1
if((r=(e=n[0]).length-1)>0){for(y||(s.polygonStart(),y=!0),s.lineStart();++o<r;)s.point((i=e[o])[0],i[1])
s.lineEnd()}}else r>1&&2&t&&n.push(n.pop().concat(n.shift())),a.push(n.filter(Kn))}return c}}function Kn(e){return e.length>1}function $n(){var e,t=[]
return{lineStart:function(){t.push(e=[])},point:function(t,n){e.push([t,n])},lineEnd:R,buffer:function(){var n=t
return t=[],e=null,n},rejoin:function(){t.length>1&&t.push(t.pop().concat(t.shift()))}}}function Xn(e,t){return((e=e.x)[0]<0?e[1]-xe-we:xe-e[1])-((t=t.x)[0]<0?t[1]-xe-we:xe-t[1])}var Jn=Qn(Vn,function(e){var t,n=NaN,r=NaN,i=NaN
return{lineStart:function(){e.lineStart(),t=1},point:function(o,s){var a=o>0?_e:-_e,u=b(o-n)
b(u-_e)<we?(e.point(n,r=(r+s)/2>0?xe:-xe),e.point(i,r),e.lineEnd(),e.lineStart(),e.point(a,r),e.point(o,r),t=0):i!==a&&u>=_e&&(b(n-i)<we&&(n-=i*we),b(o-a)<we&&(o-=a*we),r=function(e,t,n,r){var i,o,s=Math.sin(e-n)
return b(s)>we?Math.atan((Math.sin(t)*(o=Math.cos(r))*Math.sin(n)-Math.sin(r)*(i=Math.cos(t))*Math.sin(e))/(i*o*s)):(t+r)/2}(n,r,o,s),e.point(i,r),e.lineEnd(),e.lineStart(),e.point(a,r),t=0),e.point(n=o,r=s),i=a},lineEnd:function(){e.lineEnd(),n=r=NaN},clean:function(){return 2-t}}},function(e,t,n,r){var i
if(null==e)i=n*xe,r.point(-_e,i),r.point(0,i),r.point(_e,i),r.point(_e,0),r.point(_e,-i),r.point(0,-i),r.point(-_e,-i),r.point(-_e,0),r.point(-_e,i)
else if(b(e[0]-t[0])>we){var o=e[0]<t[0]?_e:-_e
i=n*o/2,r.point(-o,i),r.point(0,i),r.point(o,i)}else r.point(t[0],t[1])},[-_e,-_e/2])
function Zn(e,t,n,r){return function(i){var o,s=i.a,a=i.b,u=s.x,l=s.y,c=0,p=1,f=a.x-u,h=a.y-l
if(o=e-u,f||!(o>0)){if(o/=f,f<0){if(o<c)return
o<p&&(p=o)}else if(f>0){if(o>p)return
o>c&&(c=o)}if(o=n-u,f||!(o<0)){if(o/=f,f<0){if(o>p)return
o>c&&(c=o)}else if(f>0){if(o<c)return
o<p&&(p=o)}if(o=t-l,h||!(o>0)){if(o/=h,h<0){if(o<c)return
o<p&&(p=o)}else if(h>0){if(o>p)return
o>c&&(c=o)}if(o=r-l,h||!(o<0)){if(o/=h,h<0){if(o>p)return
o>c&&(c=o)}else if(h>0){if(o<c)return
o<p&&(p=o)}return c>0&&(i.a={x:u+c*f,y:l+c*h}),p<1&&(i.b={x:u+p*f,y:l+p*h}),i}}}}}}var er=1e9
function tr(t,n,r,i){return function(u){var l,c,p,f,h,d,m,b,g,v,y,_=u,E=$n(),x=Zn(t,n,r,i),w={point:T,lineStart:function(){w.point=O,c&&c.push(p=[])
v=!0,g=!1,m=b=NaN},lineEnd:function(){l&&(O(f,h),d&&g&&E.rejoin(),l.push(E.buffer()))
w.point=T,g&&u.lineEnd()},polygonStart:function(){u=E,l=[],c=[],y=!0},polygonEnd:function(){u=_,l=e.merge(l)
var n=function(e){for(var t=0,n=c.length,r=e[1],i=0;i<n;++i)for(var o,s=1,a=c[i],u=a.length,l=a[0];s<u;++s)o=a[s],l[1]<=r?o[1]>r&&Se(l,o,e)>0&&++t:o[1]<=r&&Se(l,o,e)<0&&--t,l=o
return 0!==t}([t,i]),r=y&&n,o=l.length;(r||o)&&(u.polygonStart(),r&&(u.lineStart(),C(null,null,1,u),u.lineEnd()),o&&Wn(l,s,n,C,u),u.polygonEnd()),l=c=p=null}}
function C(e,s,u,l){var c=0,p=0
if(null==e||(c=o(e,u))!==(p=o(s,u))||a(e,s)<0^u>0)do{l.point(0===c||3===c?t:r,c>1?i:n)}while((c=(c+u+4)%4)!==p)
else l.point(s[0],s[1])}function k(e,o){return t<=e&&e<=r&&n<=o&&o<=i}function T(e,t){k(e,t)&&u.point(e,t)}function O(e,t){var n=k(e=Math.max(-er,Math.min(er,e)),t=Math.max(-er,Math.min(er,t)))
if(c&&p.push([e,t]),v)f=e,h=t,d=n,v=!1,n&&(u.lineStart(),u.point(e,t))
else if(n&&g)u.point(e,t)
else{var r={a:{x:m,y:b},b:{x:e,y:t}}
x(r)?(g||(u.lineStart(),u.point(r.a.x,r.a.y)),u.point(r.b.x,r.b.y),n||u.lineEnd(),y=!1):n&&(u.lineStart(),u.point(e,t),y=!1)}m=e,b=t,g=n}return w}
function o(e,i){return b(e[0]-t)<we?i>0?0:3:b(e[0]-r)<we?i>0?2:1:b(e[1]-n)<we?i>0?1:0:i>0?3:2}function s(e,t){return a(e.x,t.x)}function a(e,t){var n=o(e,1),r=o(t,1)
return n!==r?n-r:0===n?t[1]-e[1]:1===n?e[0]-t[0]:2===n?e[1]-t[1]:t[0]-e[0]}}function nr(e,t){function n(n,r){return n=e(n,r),t(n[0],n[1])}return e.invert&&t.invert&&(n.invert=function(n,r){return(n=t.invert(n,r))&&e.invert(n[0],n[1])}),n}function rr(e){var t=0,n=_e/3,r=Or(e),i=r(t,n)
return i.parallels=function(e){return arguments.length?r(t=e[0]*_e/180,n=e[1]*_e/180):[t/_e*180,n/_e*180]},i}function ir(e,t){var n=Math.sin(e),r=(n+Math.sin(t))/2,i=1+n*(2*r-n),o=Math.sqrt(i)/r
function s(e,t){var n=Math.sqrt(i-2*r*Math.sin(t))/r
return[n*Math.sin(e*=r),o-n*Math.cos(e)]}return s.invert=function(e,t){var n=o-t
return[Math.atan2(e,n)/r,Pe((i-(e*e+n*n)*r*r)/(2*r))]},s}e.geo.clipExtent=function(){var e,t,n,r,i,o,s={stream:function(e){return i&&(i.valid=!1),(i=o(e)).valid=!0,i},extent:function(a){return arguments.length?(o=tr(e=+a[0][0],t=+a[0][1],n=+a[1][0],r=+a[1][1]),i&&(i.valid=!1,i=null),s):[[e,t],[n,r]]}}
return s.extent([[0,0],[960,500]])},(e.geo.conicEqualArea=function(){return rr(ir)}).raw=ir,e.geo.albers=function(){return e.geo.conicEqualArea().rotate([96,0]).center([-.6,38.7]).parallels([29.5,45.5]).scale(1070)},e.geo.albersUsa=function(){var t,n,r,i,o=e.geo.albers(),s=e.geo.conicEqualArea().rotate([154,0]).center([-2,58.5]).parallels([55,65]),a=e.geo.conicEqualArea().rotate([157,0]).center([-3,19.9]).parallels([8,18]),u={point:function(e,n){t=[e,n]}}
function l(e){var o=e[0],s=e[1]
return t=null,n(o,s),t||(r(o,s),t)||i(o,s),t}return l.invert=function(e){var t=o.scale(),n=o.translate(),r=(e[0]-n[0])/t,i=(e[1]-n[1])/t
return(i>=.12&&i<.234&&r>=-.425&&r<-.214?s:i>=.166&&i<.234&&r>=-.214&&r<-.115?a:o).invert(e)},l.stream=function(e){var t=o.stream(e),n=s.stream(e),r=a.stream(e)
return{point:function(e,i){t.point(e,i),n.point(e,i),r.point(e,i)},sphere:function(){t.sphere(),n.sphere(),r.sphere()},lineStart:function(){t.lineStart(),n.lineStart(),r.lineStart()},lineEnd:function(){t.lineEnd(),n.lineEnd(),r.lineEnd()},polygonStart:function(){t.polygonStart(),n.polygonStart(),r.polygonStart()},polygonEnd:function(){t.polygonEnd(),n.polygonEnd(),r.polygonEnd()}}},l.precision=function(e){return arguments.length?(o.precision(e),s.precision(e),a.precision(e),l):o.precision()},l.scale=function(e){return arguments.length?(o.scale(e),s.scale(.35*e),a.scale(e),l.translate(o.translate())):o.scale()},l.translate=function(e){if(!arguments.length)return o.translate()
var t=o.scale(),c=+e[0],p=+e[1]
return n=o.translate(e).clipExtent([[c-.455*t,p-.238*t],[c+.455*t,p+.238*t]]).stream(u).point,r=s.translate([c-.307*t,p+.201*t]).clipExtent([[c-.425*t+we,p+.12*t+we],[c-.214*t-we,p+.234*t-we]]).stream(u).point,i=a.translate([c-.205*t,p+.212*t]).clipExtent([[c-.214*t+we,p+.166*t+we],[c-.115*t-we,p+.234*t-we]]).stream(u).point,l},l.scale(1070)}
var or,sr,ar,ur,lr,cr,pr={point:R,lineStart:R,lineEnd:R,polygonStart:function(){sr=0,pr.lineStart=fr},polygonEnd:function(){pr.lineStart=pr.lineEnd=pr.point=R,or+=b(sr/2)}}
function fr(){var e,t,n,r
function i(e,t){sr+=r*e-n*t,n=e,r=t}pr.point=function(o,s){pr.point=i,e=n=o,t=r=s},pr.lineEnd=function(){i(e,t)}}var hr={point:function(e,t){e<ar&&(ar=e)
e>lr&&(lr=e)
t<ur&&(ur=t)
t>cr&&(cr=t)},lineStart:R,lineEnd:R,polygonStart:R,polygonEnd:R}
function dr(){var e=mr(4.5),t=[],n={point:r,lineStart:function(){n.point=i},lineEnd:s,polygonStart:function(){n.lineEnd=a},polygonEnd:function(){n.lineEnd=s,n.point=r},pointRadius:function(t){return e=mr(t),n},result:function(){if(t.length){var e=t.join("")
return t=[],e}}}
function r(n,r){t.push("M",n,",",r,e)}function i(e,r){t.push("M",e,",",r),n.point=o}function o(e,n){t.push("L",e,",",n)}function s(){n.point=r}function a(){t.push("Z")}return n}function mr(e){return"m0,"+e+"a"+e+","+e+" 0 1,1 0,"+-2*e+"a"+e+","+e+" 0 1,1 0,"+2*e+"z"}var br,gr={point:vr,lineStart:yr,lineEnd:_r,polygonStart:function(){gr.lineStart=Er},polygonEnd:function(){gr.point=vr,gr.lineStart=yr,gr.lineEnd=_r}}
function vr(e,t){vn+=e,yn+=t,++_n}function yr(){var e,t
function n(n,r){var i=n-e,o=r-t,s=Math.sqrt(i*i+o*o)
En+=s*(e+n)/2,xn+=s*(t+r)/2,wn+=s,vr(e=n,t=r)}gr.point=function(r,i){gr.point=n,vr(e=r,t=i)}}function _r(){gr.point=vr}function Er(){var e,t,n,r
function i(e,t){var i=e-n,o=t-r,s=Math.sqrt(i*i+o*o)
En+=s*(n+e)/2,xn+=s*(r+t)/2,wn+=s,Cn+=(s=r*e-n*t)*(n+e),kn+=s*(r+t),Tn+=3*s,vr(n=e,r=t)}gr.point=function(o,s){gr.point=i,vr(e=n=o,t=r=s)},gr.lineEnd=function(){i(e,t)}}function xr(e){var t=4.5,n={point:r,lineStart:function(){n.point=i},lineEnd:s,polygonStart:function(){n.lineEnd=a},polygonEnd:function(){n.lineEnd=s,n.point=r},pointRadius:function(e){return t=e,n},result:R}
function r(n,r){e.moveTo(n,r),e.arc(n,r,t,0,Ee)}function i(t,r){e.moveTo(t,r),n.point=o}function o(t,n){e.lineTo(t,n)}function s(){n.point=r}function a(){e.closePath()}return n}function wr(e){var t=.5,n=Math.cos(30*ke),r=16
function i(t){return(r?function(t){var n,i,s,a,u,l,c,p,f,h,d,m,b={point:g,lineStart:v,lineEnd:_,polygonStart:function(){t.polygonStart(),b.lineStart=E},polygonEnd:function(){t.polygonEnd(),b.lineStart=v}}
function g(n,r){n=e(n,r),t.point(n[0],n[1])}function v(){p=NaN,b.point=y,t.lineStart()}function y(n,i){var s=Pn([n,i]),a=e(n,i)
o(p,f,c,h,d,m,p=a[0],f=a[1],c=n,h=s[0],d=s[1],m=s[2],r,t),t.point(p,f)}function _(){b.point=g,t.lineEnd()}function E(){v(),b.point=x,b.lineEnd=w}function x(e,t){y(n=e,t),i=p,s=f,a=h,u=d,l=m,b.point=y}function w(){o(p,f,c,h,d,m,i,s,n,a,u,l,r,t),b.lineEnd=_,_()}return b}:function(t){return kr(t,function(n,r){n=e(n,r),t.point(n[0],n[1])})})(t)}function o(r,i,s,a,u,l,c,p,f,h,d,m,g,v){var y=c-r,_=p-i,E=y*y+_*_
if(E>4*t&&g--){var x=a+h,w=u+d,C=l+m,k=Math.sqrt(x*x+w*w+C*C),T=Math.asin(C/=k),O=b(b(C)-1)<we||b(s-f)<we?(s+f)/2:Math.atan2(w,x),S=e(O,T),R=S[0],P=S[1],M=R-r,A=P-i,N=_*M-y*A;(N*N/E>t||b((y*M+_*A)/E-.5)>.3||a*h+u*d+l*m<n)&&(o(r,i,s,a,u,l,R,P,O,x/=k,w/=k,C,g,v),v.point(R,P),o(R,P,O,x,w,C,c,p,f,h,d,m,g,v))}}return i.precision=function(e){return arguments.length?(r=(t=e*e)>0&&16,i):Math.sqrt(t)},i}function Cr(e){this.stream=e}function kr(e,t){return{point:t,sphere:function(){e.sphere()},lineStart:function(){e.lineStart()},lineEnd:function(){e.lineEnd()},polygonStart:function(){e.polygonStart()},polygonEnd:function(){e.polygonEnd()}}}function Tr(e){return Or(function(){return e})()}function Or(t){var n,r,i,o,s,a,u=wr(function(e,t){return[(e=n(e,t))[0]*l+o,s-e[1]*l]}),l=150,c=480,p=250,f=0,h=0,d=0,m=0,g=0,v=Jn,y=dt,_=null,E=null
function x(e){return[(e=i(e[0]*ke,e[1]*ke))[0]*l+o,s-e[1]*l]}function w(e){return(e=i.invert((e[0]-o)/l,(s-e[1])/l))&&[e[0]*Te,e[1]*Te]}function C(){i=nr(r=Mr(d,m,g),n)
var e=n(f,h)
return o=c-e[0]*l,s=p+e[1]*l,k()}function k(){return a&&(a.valid=!1,a=null),x}return x.stream=function(e){return a&&(a.valid=!1),(a=Sr(v(r,u(y(e))))).valid=!0,a},x.clipAngle=function(e){return arguments.length?(v=null==e?(_=e,Jn):function(e){var t=Math.cos(e),n=t>0,r=b(t)>we
return Qn(i,function(e){var t,a,u,l,c
return{lineStart:function(){l=u=!1,c=1},point:function(p,f){var h,d=[p,f],m=i(p,f),b=n?m?0:s(p,f):m?s(p+(p<0?_e:-_e),f):0
if(!t&&(l=u=m)&&e.lineStart(),m!==u&&(h=o(t,d),(Dn(t,h)||Dn(d,h))&&(d[0]+=we,d[1]+=we,m=i(d[0],d[1]))),m!==u)c=0,m?(e.lineStart(),h=o(d,t),e.point(h[0],h[1])):(h=o(t,d),e.point(h[0],h[1]),e.lineEnd()),t=h
else if(r&&t&&n^m){var g
b&a||!(g=o(d,t,!0))||(c=0,n?(e.lineStart(),e.point(g[0][0],g[0][1]),e.point(g[1][0],g[1][1]),e.lineEnd()):(e.point(g[1][0],g[1][1]),e.lineEnd(),e.lineStart(),e.point(g[0][0],g[0][1])))}!m||t&&Dn(t,d)||e.point(d[0],d[1]),t=d,u=m,a=b},lineEnd:function(){u&&e.lineEnd(),t=null},clean:function(){return c|(l&&u)<<1}}},Lr(e,6*ke),n?[0,-e]:[-_e,e-_e])
function i(e,n){return Math.cos(e)*Math.cos(n)>t}function o(e,n,r){var i=[1,0,0],o=An(Pn(e),Pn(n)),s=Mn(o,o),a=o[0],u=s-a*a
if(!u)return!r&&e
var l=t*s/u,c=-t*a/u,p=An(i,o),f=jn(i,l)
Nn(f,jn(o,c))
var h=p,d=Mn(f,h),m=Mn(h,h),g=d*d-m*(Mn(f,f)-1)
if(!(g<0)){var v=Math.sqrt(g),y=jn(h,(-d-v)/m)
if(Nn(y,f),y=In(y),!r)return y
var _,E=e[0],x=n[0],w=e[1],C=n[1]
x<E&&(_=E,E=x,x=_)
var k=x-E,T=b(k-_e)<we
if(!T&&C<w&&(_=w,w=C,C=_),T||k<we?T?w+C>0^y[1]<(b(y[0]-E)<we?w:C):w<=y[1]&&y[1]<=C:k>_e^(E<=y[0]&&y[0]<=x)){var O=jn(h,(-d+v)/m)
return Nn(O,f),[y,In(O)]}}}function s(t,r){var i=n?e:_e-e,o=0
return t<-i?o|=1:t>i&&(o|=2),r<-i?o|=4:r>i&&(o|=8),o}}((_=+e)*ke),k()):_},x.clipExtent=function(e){return arguments.length?(E=e,y=e?tr(e[0][0],e[0][1],e[1][0],e[1][1]):dt,k()):E},x.scale=function(e){return arguments.length?(l=+e,C()):l},x.translate=function(e){return arguments.length?(c=+e[0],p=+e[1],C()):[c,p]},x.center=function(e){return arguments.length?(f=e[0]%360*ke,h=e[1]%360*ke,C()):[f*Te,h*Te]},x.rotate=function(e){return arguments.length?(d=e[0]%360*ke,m=e[1]%360*ke,g=e.length>2?e[2]%360*ke:0,C()):[d*Te,m*Te,g*Te]},e.rebind(x,u,"precision"),function(){return n=t.apply(this,arguments),x.invert=n.invert&&w,C()}}function Sr(e){return kr(e,function(t,n){e.point(t*ke,n*ke)})}function Rr(e,t){return[e,t]}function Pr(e,t){return[e>_e?e-Ee:e<-_e?e+Ee:e,t]}function Mr(e,t,n){return e?t||n?nr(Nr(e),jr(t,n)):Nr(e):t||n?jr(t,n):Pr}function Ar(e){return function(t,n){return[(t+=e)>_e?t-Ee:t<-_e?t+Ee:t,n]}}function Nr(e){var t=Ar(e)
return t.invert=Ar(-e),t}function jr(e,t){var n=Math.cos(e),r=Math.sin(e),i=Math.cos(t),o=Math.sin(t)
function s(e,t){var s=Math.cos(t),a=Math.cos(e)*s,u=Math.sin(e)*s,l=Math.sin(t),c=l*n+a*r
return[Math.atan2(u*i-c*o,a*n-l*r),Pe(c*i+u*o)]}return s.invert=function(e,t){var s=Math.cos(t),a=Math.cos(e)*s,u=Math.sin(e)*s,l=Math.sin(t),c=l*i-u*o
return[Math.atan2(u*i+l*o,a*n+c*r),Pe(c*n-a*r)]},s}function Lr(e,t){var n=Math.cos(e),r=Math.sin(e)
return function(i,o,s,a){var u=s*t
null!=i?(i=Ir(n,i),o=Ir(n,o),(s>0?i<o:i>o)&&(i+=s*Ee)):(i=e+s*Ee,o=e-.5*u)
for(var l,c=i;s>0?c>o:c<o;c-=u)a.point((l=In([n,-r*Math.cos(c),-r*Math.sin(c)]))[0],l[1])}}function Ir(e,t){var n=Pn(t)
n[0]-=e,Ln(n)
var r=Re(-n[1])
return((-n[2]<0?-r:r)+2*Math.PI-we)%(2*Math.PI)}function Dr(t,n,r){var i=e.range(t,n-we,r).concat(n)
return function(e){return i.map(function(t){return[e,t]})}}function Br(t,n,r){var i=e.range(t,n-we,r).concat(n)
return function(e){return i.map(function(t){return[t,e]})}}function Fr(e){return e.source}function zr(e){return e.target}e.geo.path=function(){var t,n,r,i,o,s=4.5
function a(t){return t&&("function"==typeof s&&i.pointRadius(+s.apply(this,arguments)),o&&o.valid||(o=r(i)),e.geo.stream(t,o)),i.result()}function u(){return o=null,a}return a.area=function(t){return or=0,e.geo.stream(t,r(pr)),or},a.centroid=function(t){return vn=yn=_n=En=xn=wn=Cn=kn=Tn=0,e.geo.stream(t,r(gr)),Tn?[Cn/Tn,kn/Tn]:wn?[En/wn,xn/wn]:_n?[vn/_n,yn/_n]:[NaN,NaN]},a.bounds=function(t){return lr=cr=-(ar=ur=1/0),e.geo.stream(t,r(hr)),[[ar,ur],[lr,cr]]},a.projection=function(e){return arguments.length?(r=(t=e)?e.stream||(n=e,i=wr(function(e,t){return n([e*Te,t*Te])}),function(e){return Sr(i(e))}):dt,u()):t
var n,i},a.context=function(e){return arguments.length?(i=null==(n=e)?new dr:new xr(e),"function"!=typeof s&&i.pointRadius(s),u()):n},a.pointRadius=function(e){return arguments.length?(s="function"==typeof e?e:(i.pointRadius(+e),+e),a):s},a.projection(e.geo.albersUsa()).context(null)},e.geo.transform=function(e){return{stream:function(t){var n=new Cr(t)
for(var r in e)n[r]=e[r]
return n}}},Cr.prototype={point:function(e,t){this.stream.point(e,t)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}},e.geo.projection=Tr,e.geo.projectionMutator=Or,(e.geo.equirectangular=function(){return Tr(Rr)}).raw=Rr.invert=Rr,e.geo.rotation=function(e){function t(t){return(t=e(t[0]*ke,t[1]*ke))[0]*=Te,t[1]*=Te,t}return e=Mr(e[0]%360*ke,e[1]*ke,e.length>2?e[2]*ke:0),t.invert=function(t){return(t=e.invert(t[0]*ke,t[1]*ke))[0]*=Te,t[1]*=Te,t},t},Pr.invert=Rr,e.geo.circle=function(){var e,t,n=[0,0],r=6
function i(){var e="function"==typeof n?n.apply(this,arguments):n,r=Mr(-e[0]*ke,-e[1]*ke,0).invert,i=[]
return t(null,null,1,{point:function(e,t){i.push(e=r(e,t)),e[0]*=Te,e[1]*=Te}}),{type:"Polygon",coordinates:[i]}}return i.origin=function(e){return arguments.length?(n=e,i):n},i.angle=function(n){return arguments.length?(t=Lr((e=+n)*ke,r*ke),i):e},i.precision=function(n){return arguments.length?(t=Lr(e*ke,(r=+n)*ke),i):r},i.angle(90)},e.geo.distance=function(e,t){var n,r=(t[0]-e[0])*ke,i=e[1]*ke,o=t[1]*ke,s=Math.sin(r),a=Math.cos(r),u=Math.sin(i),l=Math.cos(i),c=Math.sin(o),p=Math.cos(o)
return Math.atan2(Math.sqrt((n=p*s)*n+(n=l*c-u*p*a)*n),u*c+l*p*a)},e.geo.graticule=function(){var t,n,r,i,o,s,a,u,l,c,p,f,h=10,d=h,m=90,g=360,v=2.5
function y(){return{type:"MultiLineString",coordinates:_()}}function _(){return e.range(Math.ceil(i/m)*m,r,m).map(p).concat(e.range(Math.ceil(u/g)*g,a,g).map(f)).concat(e.range(Math.ceil(n/h)*h,t,h).filter(function(e){return b(e%m)>we}).map(l)).concat(e.range(Math.ceil(s/d)*d,o,d).filter(function(e){return b(e%g)>we}).map(c))}return y.lines=function(){return _().map(function(e){return{type:"LineString",coordinates:e}})},y.outline=function(){return{type:"Polygon",coordinates:[p(i).concat(f(a).slice(1),p(r).reverse().slice(1),f(u).reverse().slice(1))]}},y.extent=function(e){return arguments.length?y.majorExtent(e).minorExtent(e):y.minorExtent()},y.majorExtent=function(e){return arguments.length?(i=+e[0][0],r=+e[1][0],u=+e[0][1],a=+e[1][1],i>r&&(e=i,i=r,r=e),u>a&&(e=u,u=a,a=e),y.precision(v)):[[i,u],[r,a]]},y.minorExtent=function(e){return arguments.length?(n=+e[0][0],t=+e[1][0],s=+e[0][1],o=+e[1][1],n>t&&(e=n,n=t,t=e),s>o&&(e=s,s=o,o=e),y.precision(v)):[[n,s],[t,o]]},y.step=function(e){return arguments.length?y.majorStep(e).minorStep(e):y.minorStep()},y.majorStep=function(e){return arguments.length?(m=+e[0],g=+e[1],y):[m,g]},y.minorStep=function(e){return arguments.length?(h=+e[0],d=+e[1],y):[h,d]},y.precision=function(e){return arguments.length?(v=+e,l=Dr(s,o,90),c=Br(n,t,v),p=Dr(u,a,90),f=Br(i,r,v),y):v},y.majorExtent([[-180,-90+we],[180,90-we]]).minorExtent([[-180,-80-we],[180,80+we]])},e.geo.greatArc=function(){var t,n,r=Fr,i=zr
function o(){return{type:"LineString",coordinates:[t||r.apply(this,arguments),n||i.apply(this,arguments)]}}return o.distance=function(){return e.geo.distance(t||r.apply(this,arguments),n||i.apply(this,arguments))},o.source=function(e){return arguments.length?(r=e,t="function"==typeof e?null:e,o):r},o.target=function(e){return arguments.length?(i=e,n="function"==typeof e?null:e,o):i},o.precision=function(){return arguments.length?o:0},o},e.geo.interpolate=function(e,t){return n=e[0]*ke,r=e[1]*ke,i=t[0]*ke,o=t[1]*ke,s=Math.cos(r),a=Math.sin(r),u=Math.cos(o),l=Math.sin(o),c=s*Math.cos(n),p=s*Math.sin(n),f=u*Math.cos(i),h=u*Math.sin(i),d=2*Math.asin(Math.sqrt(Ae(o-r)+s*u*Ae(i-n))),m=1/Math.sin(d),(b=d?function(e){var t=Math.sin(e*=d)*m,n=Math.sin(d-e)*m,r=n*c+t*f,i=n*p+t*h,o=n*a+t*l
return[Math.atan2(i,r)*Te,Math.atan2(o,Math.sqrt(r*r+i*i))*Te]}:function(){return[n*Te,r*Te]}).distance=d,b
var n,r,i,o,s,a,u,l,c,p,f,h,d,m,b},e.geo.length=function(t){return br=0,e.geo.stream(t,Hr),br}
var Hr={sphere:R,point:R,lineStart:function(){var e,t,n
function r(r,i){var o=Math.sin(i*=ke),s=Math.cos(i),a=b((r*=ke)-e),u=Math.cos(a)
br+=Math.atan2(Math.sqrt((a=s*Math.sin(a))*a+(a=n*o-t*s*u)*a),t*o+n*s*u),e=r,t=o,n=s}Hr.point=function(i,o){e=i*ke,t=Math.sin(o*=ke),n=Math.cos(o),Hr.point=r},Hr.lineEnd=function(){Hr.point=Hr.lineEnd=R}},lineEnd:R,polygonStart:R,polygonEnd:R}
function qr(e,t){function n(t,n){var r=Math.cos(t),i=Math.cos(n),o=e(r*i)
return[o*i*Math.sin(t),o*Math.sin(n)]}return n.invert=function(e,n){var r=Math.sqrt(e*e+n*n),i=t(r),o=Math.sin(i),s=Math.cos(i)
return[Math.atan2(e*o,r*s),Math.asin(r&&n*o/r)]},n}var Ur=qr(function(e){return Math.sqrt(2/(1+e))},function(e){return 2*Math.asin(e/2)});(e.geo.azimuthalEqualArea=function(){return Tr(Ur)}).raw=Ur
var Vr=qr(function(e){var t=Math.acos(e)
return t&&t/Math.sin(t)},dt)
function Wr(e,t){var n=Math.cos(e),r=function(e){return Math.tan(_e/4+e/2)},i=e===t?Math.sin(e):Math.log(n/Math.cos(t))/Math.log(r(t)/r(e)),o=n*Math.pow(r(e),i)/i
if(!i)return Qr
function s(e,t){o>0?t<-xe+we&&(t=-xe+we):t>xe-we&&(t=xe-we)
var n=o/Math.pow(r(t),i)
return[n*Math.sin(i*e),o-n*Math.cos(i*e)]}return s.invert=function(e,t){var n=o-t,r=Oe(i)*Math.sqrt(e*e+n*n)
return[Math.atan2(e,n)/i,2*Math.atan(Math.pow(o/r,1/i))-xe]},s}function Yr(e,t){var n=Math.cos(e),r=e===t?Math.sin(e):(n-Math.cos(t))/(t-e),i=n/r+e
if(b(r)<we)return Rr
function o(e,t){var n=i-t
return[n*Math.sin(r*e),i-n*Math.cos(r*e)]}return o.invert=function(e,t){var n=i-t
return[Math.atan2(e,n)/r,i-Oe(r)*Math.sqrt(e*e+n*n)]},o}(e.geo.azimuthalEquidistant=function(){return Tr(Vr)}).raw=Vr,(e.geo.conicConformal=function(){return rr(Wr)}).raw=Wr,(e.geo.conicEquidistant=function(){return rr(Yr)}).raw=Yr
var Gr=qr(function(e){return 1/e},Math.atan)
function Qr(e,t){return[e,Math.log(Math.tan(_e/4+t/2))]}function Kr(e){var t,n=Tr(e),r=n.scale,i=n.translate,o=n.clipExtent
...
return e===n?t?n.clipExtent(null):n:e},n.clipExtent=function(e){var s=o.apply(n,arguments)
if(s===n){if(t=null==e){var a=_e*r(),u=i()
o([[u[0]-a,u[1]-a],[u[0]+a,u[1]+a]])}}else t&&(s=null)
return s},n.clipExtent(null)}(e.geo.gnomonic=function(){return Tr(Gr)}).raw=Gr,Qr.invert=function(e,t){return[e,2*Math.atan(Math.exp(t))-xe]},(e.geo.mercator=function(){return Kr(Qr)}).raw=Qr
var $r=qr(function(){return 1},Math.asin);(e.geo.orthographic=function(){return Tr($r)}).raw=$r
var Xr=qr(function(e){return 1/(1+e)},function(e){return 2*Math.atan(e)})
function Jr(e,t){return[Math.log(Math.tan(_e/4+t/2)),-e]}function Zr(e){return e[0]}function ei(e){return e[1]}function ti(e){for(var t=e.length,n=[0,1],r=2,i=2;i<t;i++){for(;r>1&&Se(e[n[r-2]],e[n[r-1]],e[i])<=0;)--r
n[r++]=i}return n.slice(0,r)}function ni(e,t){return e[0]-t[0]||e[1]-t[1]}(e.geo.stereographic=function(){return Tr(Xr)}).raw=Xr,Jr.invert=function(e,t){return[-t,2*Math.atan(Math.exp(e))-xe]},(e.geo.transverseMercator=function(){var e=Kr(Jr),t=e.center,n=e.rotate
return e.center=function(e){return e?t([-e[1],e[0]]):[(e=t())[1],-e[0]]},e.rotate=function(e){return e?n([e[0],e[1],e.length>2?e[2]+90:90]):[(e=n())[0],e[1],e[2]-90]},n([0,0,90])}).raw=Jr,e.geom={},e.geom.hull=function(e){var t=Zr,n=ei
if(arguments.length)return r(e)
function r(e){if(e.length<3)return[]
var r,i=ht(t),o=ht(n),s=e.length,a=[],u=[]
for(r=0;r<s;r++)a.push([+i.call(this,e[r],r),+o.call(this,e[r],r),r])
for(a.sort(ni),r=0;r<s;r++)u.push([a[r][0],-a[r][1]])
var l=ti(a),c=ti(u),p=c[0]===l[0],f=c[c.length-1]===l[l.length-1],h=[]
for(r=l.length-1;r>=0;--r)h.push(e[a[l[r]][2]])
for(r=+p;r<c.length-f;++r)h.push(e[a[c[r]][2]])
return h}return r.x=function(e){return arguments.length?(t=e,r):t},r.y=function(e){return arguments.length?(n=e,r):n},r},e.geom.polygon=function(e){return I(e,ri),e}
var ri=e.geom.polygon.prototype=[]
function ii(e,t,n){return(n[0]-t[0])*(e[1]-t[1])<(n[1]-t[1])*(e[0]-t[0])}function oi(e,t,n,r){var i=e[0],o=n[0],s=t[0]-i,a=r[0]-o,u=e[1],l=n[1],c=t[1]-u,p=r[1]-l,f=(a*(u-l)-p*(i-o))/(p*s-a*c)
return[i+f*s,u+f*c]}function si(e){var t=e[0],n=e[e.length-1]
return!(t[0]-n[0]||t[1]-n[1])}ri.area=function(){for(var e,t=-1,n=this.length,r=this[n-1],i=0;++t<n;)e=r,r=this[t],i+=e[1]*r[0]-e[0]*r[1]
return.5*i},ri.centroid=function(e){var t,n,r=-1,i=this.length,o=0,s=0,a=this[i-1]
for(arguments.length||(e=-1/(6*this.area()));++r<i;)t=a,a=this[r],n=t[0]*a[1]-a[0]*t[1],o+=(t[0]+a[0])*n,s+=(t[1]+a[1])*n
return[o*e,s*e]},ri.clip=function(e){for(var t,n,r,i,o,s,a=si(e),u=-1,l=this.length-si(this),c=this[l-1];++u<l;){for(t=e.slice(),e.length=0,i=this[u],o=t[(r=t.length-a)-1],n=-1;++n<r;)ii(s=t[n],c,i)?(ii(o,c,i)||e.push(oi(o,s,c,i)),e.push(s)):ii(o,c,i)&&e.push(oi(o,s,c,i)),o=s
a&&e.push(e[0]),c=i}return e}
var ai,ui,li,ci,pi,fi=[],hi=[]
function di(){Ai(this),this.edge=this.site=this.circle=null}function mi(e){var t=fi.pop()||new di
return t.site=e,t}function bi(e){ki(e),li.remove(e),fi.push(e),Ai(e)}function gi(e){var t=e.circle,n=t.x,r=t.cy,i={x:n,y:r},o=e.P,s=e.N,a=[e]
bi(e)
for(var u=o;u.circle&&b(n-u.circle.x)<we&&b(r-u.circle.cy)<we;)o=u.P,a.unshift(u),bi(u),u=o
a.unshift(u),ki(u)
for(var l=s;l.circle&&b(n-l.circle.x)<we&&b(r-l.circle.cy)<we;)s=l.N,a.push(l),bi(l),l=s
a.push(l),ki(l)
var c,p=a.length
for(c=1;c<p;++c)l=a[c],u=a[c-1],Ri(l.edge,u.site,l.site,i)
u=a[0],(l=a[p-1]).edge=Si(u.site,l.site,null,i),Ci(u),Ci(l)}function vi(e){for(var t,n,r,i,o=e.x,s=e.y,a=li._;a;)if((r=yi(a,s)-o)>we)a=a.L
else{if(!((i=o-_i(a,s))>we)){r>-we?(t=a.P,n=a):i>-we?(t=a,n=a.N):t=n=a
break}if(!a.R){t=a
break}a=a.R}var u=mi(e)
if(li.insert(t,u),t||n){if(t===n)return ki(t),n=mi(t.site),li.insert(u,n),u.edge=n.edge=Si(t.site,u.site),Ci(t),void Ci(n)
if(n){ki(t),ki(n)
var l=t.site,c=l.x,p=l.y,f=e.x-c,h=e.y-p,d=n.site,m=d.x-c,b=d.y-p,g=2*(f*b-h*m),v=f*f+h*h,y=m*m+b*b,_={x:(b*v-h*y)/g+c,y:(f*y-m*v)/g+p}
Ri(n.edge,l,d,_),u.edge=Si(l,e,null,_),n.edge=Si(e,d,null,_),Ci(t),Ci(n)}else u.edge=Si(t.site,u.site)}}function yi(e,t){var n=e.site,r=n.x,i=n.y,o=i-t
if(!o)return r
var s=e.P
if(!s)return-1/0
var a=(n=s.site).x,u=n.y,l=u-t
if(!l)return a
var c=a-r,p=1/o-1/l,f=c/l
return p?(-f+Math.sqrt(f*f-2*p*(c*c/(-2*l)-u+l/2+i-o/2)))/p+r:(r+a)/2}function _i(e,t){var n=e.N
if(n)return yi(n,t)
var r=e.site
return r.y===t?r.x:1/0}function Ei(e){this.site=e,this.edges=[]}function xi(e,t){return t.angle-e.angle}function wi(){Ai(this),this.x=this.y=this.arc=this.site=this.cy=null}function Ci(e){var t=e.P,n=e.N
if(t&&n){var r=t.site,i=e.site,o=n.site
if(r!==o){var s=i.x,a=i.y,u=r.x-s,l=r.y-a,c=o.x-s,p=2*(u*(b=o.y-a)-l*c)
if(!(p>=-Ce)){var f=u*u+l*l,h=c*c+b*b,d=(b*f-l*h)/p,m=(u*h-c*f)/p,b=m+a,g=hi.pop()||new wi
g.arc=e,g.site=i,g.x=d+s,g.y=b+Math.sqrt(d*d+m*m),g.cy=b,e.circle=g
for(var v=null,y=pi._;y;)if(g.y<y.y||g.y===y.y&&g.x<=y.x){if(!y.L){v=y.P
break}y=y.L}else{if(!y.R){v=y
break}y=y.R}pi.insert(v,g),v||(ci=g)}}}}function ki(e){var t=e.circle
t&&(t.P||(ci=t.N),pi.remove(t),hi.push(t),Ai(t),e.circle=null)}function Ti(e,t){var n=e.b
if(n)return!0
var r,i,o=e.a,s=t[0][0],a=t[1][0],u=t[0][1],l=t[1][1],c=e.l,p=e.r,f=c.x,h=c.y,d=p.x,m=p.y,b=(f+d)/2,g=(h+m)/2
if(m===h){if(b<s||b>=a)return
if(f>d){if(o){if(o.y>=l)return}else o={x:b,y:u}
n={x:b,y:l}}else{if(o){if(o.y<u)return}else o={x:b,y:l}
n={x:b,y:u}}}else if(i=g-(r=(f-d)/(m-h))*b,r<-1||r>1)if(f>d){if(o){if(o.y>=l)return}else o={x:(u-i)/r,y:u}
n={x:(l-i)/r,y:l}}else{if(o){if(o.y<u)return}else o={x:(l-i)/r,y:l}
n={x:(u-i)/r,y:u}}else if(h<m){if(o){if(o.x>=a)return}else o={x:s,y:r*s+i}
n={x:a,y:r*a+i}}else{if(o){if(o.x<s)return}else o={x:a,y:r*a+i}
n={x:s,y:r*s+i}}return e.a=o,e.b=n,!0}function Oi(e,t){this.l=e,this.r=t,this.a=this.b=null}function Si(e,t,n,r){var i=new Oi(e,t)
return ai.push(i),n&&Ri(i,e,t,n),r&&Ri(i,t,e,r),ui[e.i].edges.push(new Pi(i,e,t)),ui[t.i].edges.push(new Pi(i,t,e)),i}function Ri(e,t,n,r){e.a||e.b?e.l===n?e.b=r:e.a=r:(e.a=r,e.l=t,e.r=n)}function Pi(e,t,n){var r=e.a,i=e.b
this.edge=e,this.site=t,this.angle=n?Math.atan2(n.y-t.y,n.x-t.x):e.l===t?Math.atan2(i.x-r.x,r.y-i.y):Math.atan2(r.x-i.x,i.y-r.y)}function Mi(){this._=null}function Ai(e){e.U=e.C=e.L=e.R=e.P=e.N=null}function Ni(e,t){var n=t,r=t.R,i=n.U
i?i.L===n?i.L=r:i.R=r:e._=r,r.U=i,n.U=r,n.R=r.L,n.R&&(n.R.U=n),r.L=n}function ji(e,t){var n=t,r=t.L,i=n.U
i?i.L===n?i.L=r:i.R=r:e._=r,r.U=i,n.U=r,n.L=r.R,n.L&&(n.L.U=n),r.R=n}function Li(e){for(;e.L;)e=e.L
return e}function Ii(e,t){var n,r,i,o=e.sort(Di).pop()
for(ai=[],ui=new Array(e.length),li=new Mi,pi=new Mi;;)if(i=ci,o&&(!i||o.y<i.y||o.y===i.y&&o.x<i.x))o.x===n&&o.y===r||(ui[o.i]=new Ei(o),vi(o),n=o.x,r=o.y),o=e.pop()
else{if(!i)break
gi(i.arc)}t&&(function(e){for(var t,n=ai,r=Zn(e[0][0],e[0][1],e[1][0],e[1][1]),i=n.length;i--;)(!Ti(t=n[i],e)||!r(t)||b(t.a.x-t.b.x)<we&&b(t.a.y-t.b.y)<we)&&(t.a=t.b=null,n.splice(i,1))}(t),function(e){for(var t,n,r,i,o,s,a,u,l,c,p=e[0][0],f=e[1][0],h=e[0][1],d=e[1][1],m=ui,g=m.length;g--;)if((o=m[g])&&o.prepare())for(u=(a=o.edges).length,s=0;s<u;)r=(c=a[s].end()).x,i=c.y,t=(l=a[++s%u].start()).x,n=l.y,(b(r-t)>we||b(i-n)>we)&&(a.splice(s,0,new Pi((v=o.site,y=c,_=b(r-p)<we&&d-i>we?{x:p,y:b(t-p)<we?n:d}:b(i-d)<we&&f-r>we?{x:b(n-d)<we?t:f,y:d}:b(r-f)<we&&i-h>we?{x:f,y:b(t-f)<we?n:h}:b(i-h)<we&&r-p>we?{x:b(n-h)<we?t:p,y:h}:null,E=void 0,E=new Oi(v,null),E.a=y,E.b=_,ai.push(E),E),o.site,null)),++u)
var v,y,_,E}(t))
var s={cells:ui,edges:ai}
return li=pi=ai=ui=null,s}function Di(e,t){return t.y-e.y||t.x-e.x}Ei.prototype.prepare=function(){for(var e,t=this.edges,n=t.length;n--;)(e=t[n].edge).b&&e.a||t.splice(n,1)
return t.sort(xi),t.length},Pi.prototype={start:function(){return this.edge.l===this.site?this.edge.a:this.edge.b},end:function(){return this.edge.l===this.site?this.edge.b:this.edge.a}},Mi.prototype={insert:function(e,t){var n,r,i
if(e){if(t.P=e,t.N=e.N,e.N&&(e.N.P=t),e.N=t,e.R){for(e=e.R;e.L;)e=e.L
e.L=t}else e.R=t
n=e}else this._?(e=Li(this._),t.P=null,t.N=e,e.P=e.L=t,n=e):(t.P=t.N=null,this._=t,n=null)
for(t.L=t.R=null,t.U=n,t.C=!0,e=t;n&&n.C;)n===(r=n.U).L?(i=r.R)&&i.C?(n.C=i.C=!1,r.C=!0,e=r):(e===n.R&&(Ni(this,n),n=(e=n).U),n.C=!1,r.C=!0,ji(this,r)):(i=r.L)&&i.C?(n.C=i.C=!1,r.C=!0,e=r):(e===n.L&&(ji(this,n),n=(e=n).U),n.C=!1,r.C=!0,Ni(this,r)),n=e.U
this._.C=!1},remove:function(e){e.N&&(e.N.P=e.P),e.P&&(e.P.N=e.N),e.N=e.P=null
var t,n,r,i=e.U,o=e.L,s=e.R
if(n=o?s?Li(s):o:s,i?i.L===e?i.L=n:i.R=n:this._=n,o&&s?(r=n.C,n.C=e.C,n.L=o,o.U=n,n!==s?(i=n.U,n.U=e.U,e=n.R,i.L=e,n.R=s,s.U=n):(n.U=i,i=n,e=n.R)):(r=e.C,e=n),e&&(e.U=i),!r)if(e&&e.C)e.C=!1
else{do{if(e===this._)break
if(e===i.L){if((t=i.R).C&&(t.C=!1,i.C=!0,Ni(this,i),t=i.R),t.L&&t.L.C||t.R&&t.R.C){t.R&&t.R.C||(t.L.C=!1,t.C=!0,ji(this,t),t=i.R),t.C=i.C,i.C=t.R.C=!1,Ni(this,i),e=this._
break}}else if((t=i.L).C&&(t.C=!1,i.C=!0,ji(this,i),t=i.L),t.L&&t.L.C||t.R&&t.R.C){t.L&&t.L.C||(t.R.C=!1,t.C=!0,Ni(this,t),t=i.L),t.C=i.C,i.C=t.L.C=!1,ji(this,i),e=this._
break}t.C=!0,e=i,i=i.U}while(!e.C)
e&&(e.C=!1)}}},e.geom.voronoi=function(e){var t=Zr,n=ei,r=t,i=n,o=Bi
if(e)return s(e)
function s(e){var t=new Array(e.length),n=o[0][0],r=o[0][1],i=o[1][0],s=o[1][1]
return Ii(a(e),o).cells.forEach(function(o,a){var u=o.edges,l=o.site;(t[a]=u.length?u.map(function(e){var t=e.start()
return[t.x,t.y]}):l.x>=n&&l.x<=i&&l.y>=r&&l.y<=s?[[n,s],[i,s],[i,r],[n,r]]:[]).point=e[a]}),t}function a(e){return e.map(function(e,t){return{x:Math.round(r(e,t)/we)*we,y:Math.round(i(e,t)/we)*we,i:t}})}return s.links=function(e){return Ii(a(e)).edges.filter(function(e){return e.l&&e.r}).map(function(t){return{source:e[t.l.i],target:e[t.r.i]}})},s.triangles=function(e){var t=[]
return Ii(a(e)).cells.forEach(function(n,r){for(var i,o,s,a,u=n.site,l=n.edges.sort(xi),c=-1,p=l.length,f=l[p-1].edge,h=f.l===u?f.r:f.l;++c<p;)f,i=h,h=(f=l[c].edge).l===u?f.r:f.l,r<i.i&&r<h.i&&(s=i,a=h,((o=u).x-a.x)*(s.y-o.y)-(o.x-s.x)*(a.y-o.y)<0)&&t.push([e[r],e[i.i],e[h.i]])}),t},s.x=function(e){return arguments.length?(r=ht(t=e),s):t},s.y=function(e){return arguments.length?(i=ht(n=e),s):n},s.clipExtent=function(e){return arguments.length?(o=null==e?Bi:e,s):o===Bi?null:o},s.size=function(e){return arguments.length?s.clipExtent(e&&[[0,0],e]):o===Bi?null:o&&o[1]},s}
var Bi=[[-1e6,-1e6],[1e6,1e6]]
function Fi(e){return e.x}function zi(e){return e.y}function Hi(t,n){t=e.rgb(t),n=e.rgb(n)
var r=t.r,i=t.g,o=t.b,s=n.r-r,a=n.g-i,u=n.b-o
return function(e){return"#"+st(Math.round(r+s*e))+st(Math.round(i+a*e))+st(Math.round(o+u*e))}}function qi(e,t){var n,r={},i={}
for(n in e)n in t?r[n]=Gi(e[n],t[n]):i[n]=e[n]
for(n in t)n in e||(i[n]=t[n])
return function(e){for(n in r)i[n]=r[n](e)
return i}}function Ui(e,t){return t-=e=+e,function(n){return e+t*n}}function Vi(e,t){var n,r,i,o=Wi.lastIndex=Yi.lastIndex=0,s=-1,a=[],u=[]
for(e+="",t+="";(n=Wi.exec(e))&&(r=Yi.exec(t));)(i=r.index)>o&&(i=t.substring(o,i),a[s]?a[s]+=i:a[++s]=i),(n=n[0])===(r=r[0])?a[s]?a[s]+=r:a[++s]=r:(a[++s]=null,u.push({i:s,x:Ui(n,r)})),o=Yi.lastIndex
return o<t.length&&(i=t.substring(o),a[s]?a[s]+=i:a[++s]=i),a.length<2?u[0]?(t=u[0].x,function(e){return t(e)+""}):function(){return t}:(t=u.length,function(e){for(var n,r=0;r<t;++r)a[(n=u[r]).i]=n.x(e)
return a.join("")})}e.geom.delaunay=function(t){return e.geom.voronoi().triangles(t)},e.geom.quadtree=function(e,t,n,r,i){var o,s=Zr,a=ei
if(o=arguments.length)return s=Fi,a=zi,3===o&&(i=n,r=t,n=t=0),u(e)
function u(e){var u,l,c,p,f,h,d,m,g,v=ht(s),y=ht(a)
if(null!=t)h=t,d=n,m=r,g=i
else if(m=g=-(h=d=1/0),l=[],c=[],f=e.length,o)for(p=0;p<f;++p)(u=e[p]).x<h&&(h=u.x),u.y<d&&(d=u.y),u.x>m&&(m=u.x),u.y>g&&(g=u.y),l.push(u.x),c.push(u.y)
else for(p=0;p<f;++p){var _=+v(u=e[p],p),E=+y(u,p)
_<h&&(h=_),E<d&&(d=E),_>m&&(m=_),E>g&&(g=E),l.push(_),c.push(E)}var x=m-h,w=g-d
function C(e,t,n,r,i,o,s,a){if(!isNaN(n)&&!isNaN(r))if(e.leaf){var u=e.x,l=e.y
if(null!=u)if(b(u-n)+b(l-r)<.01)k(e,t,n,r,i,o,s,a)
else{var c=e.point
e.x=e.y=e.point=null,k(e,c,u,l,i,o,s,a),k(e,t,n,r,i,o,s,a)}else e.x=n,e.y=r,e.point=t}else k(e,t,n,r,i,o,s,a)}function k(e,t,n,r,i,o,s,a){var u=.5*(i+s),l=.5*(o+a),c=n>=u,p=r>=l,f=(p<<1)+c
e.leaf=!1,c?i=u:s=u,p?o=l:a=l,C(e=e.nodes[f]||(e.nodes[f]={leaf:!0,nodes:[],point:null,x:null,y:null}),t,n,r,i,o,s,a)}x>w?g=d+x:m=h+w
var T={leaf:!0,nodes:[],point:null,x:null,y:null,add:function(e){C(T,e,+v(e,++p),+y(e,p),h,d,m,g)}}
if(T.visit=function(e){(function e(t,n,r,i,o,s){if(!t(n,r,i,o,s)){var a=.5*(r+o),u=.5*(i+s),l=n.nodes
l[0]&&e(t,l[0],r,i,a,u),l[1]&&e(t,l[1],a,i,o,u),l[2]&&e(t,l[2],r,u,a,s),l[3]&&e(t,l[3],a,u,o,s)}})(e,T,h,d,m,g)},p=-1,null==t){for(;++p<f;)C(T,e[p],l[p],c[p],h,d,m,g);--p}else e.forEach(T.add)
return l=c=e=u=null,T}return u.x=function(e){return arguments.length?(s=e,u):s},u.y=function(e){return arguments.length?(a=e,u):a},u.extent=function(e){return arguments.length?(null==e?t=n=r=i=null:(t=+e[0][0],n=+e[0][1],r=+e[1][0],i=+e[1][1]),u):null==t?null:[[t,n],[r,i]]},u.size=function(e){return arguments.length?(null==e?t=n=r=i=null:(t=n=0,r=+e[0],i=+e[1]),u):null==t?null:[r-t,i-n]},u},e.interpolateRgb=Hi,e.interpolateObject=qi,e.interpolateNumber=Ui,e.interpolateString=Vi
var Wi=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,Yi=new RegExp(Wi.source,"g")
function Gi(t,n){for(var r,i=e.interpolators.length;--i>=0&&!(r=e.interpolators[i](t,n)););return r}function Qi(e,t){var n,r=[],i=[],o=e.length,s=t.length,a=Math.min(e.length,t.length)
for(n=0;n<a;++n)r.push(Gi(e[n],t[n]))
for(;n<o;++n)i[n]=e[n]
for(;n<s;++n)i[n]=t[n]
return function(e){for(n=0;n<a;++n)i[n]=r[n](e)
return i}}e.interpolate=Gi,e.interpolators=[function(e,t){var n=typeof t
return("string"===n?ft.has(t)||/^(#|rgb\(|hsl\()/.test(t)?Hi:Vi:t instanceof Be?Hi:Array.isArray(t)?Qi:"object"===n&&isNaN(t)?qi:Ui)(e,t)}],e.interpolateArray=Qi
var Ki=function(){return dt},$i=e.map({linear:Ki,poly:function(e){return function(t){return Math.pow(t,e)}},quad:function(){return eo},cubic:function(){return to},sin:function(){return ro},exp:function(){return io},circle:function(){return oo},elastic:function(e,t){var n
...
return function(t){return t*t*((e+1)*t-e)}},bounce:function(){return so}}),Xi=e.map({in:dt,out:Ji,"in-out":Zi,"out-in":function(e){return Zi(Ji(e))}})
function Ji(e){return function(t){return 1-e(1-t)}}function Zi(e){return function(t){return.5*(t<.5?e(2*t):2-e(2-2*t))}}function eo(e){return e*e}function to(e){return e*e*e}function no(e){if(e<=0)return 0
if(e>=1)return 1
var t=e*e,n=t*e
return 4*(e<.5?n:3*(e-t)+n-.75)}function ro(e){return 1-Math.cos(e*xe)}function io(e){return Math.pow(2,10*(e-1))}function oo(e){return 1-Math.sqrt(1-e*e)}function so(e){return e<1/2.75?7.5625*e*e:e<2/2.75?7.5625*(e-=1.5/2.75)*e+.75:e<2.5/2.75?7.5625*(e-=2.25/2.75)*e+.9375:7.5625*(e-=2.625/2.75)*e+.984375}function ao(e,t){return t-=e,function(n){return Math.round(e+t*n)}}function uo(e){var t,n,r,i=[e.a,e.b],o=[e.c,e.d],s=co(i),a=lo(i,o),u=co(((t=o)[0]+=(r=-a)*(n=i)[0],t[1]+=r*n[1],t))||0
i[0]*o[1]<o[0]*i[1]&&(i[0]*=-1,i[1]*=-1,s*=-1,a*=-1),this.rotate=(s?Math.atan2(i[1],i[0]):Math.atan2(-o[0],o[1]))*Te,this.translate=[e.e,e.f],this.scale=[s,u],this.skew=u?Math.atan2(a,u)*Te:0}function lo(e,t){return e[0]*t[0]+e[1]*t[1]}function co(e){var t=Math.sqrt(lo(e,e))
return t&&(e[0]/=t,e[1]/=t),t}e.ease=function(e){var n,r=e.indexOf("-"),i=r>=0?e.substring(0,r):e,o=r>=0?e.substring(r+1):"in"
return i=$i.get(i)||Ki,o=Xi.get(o)||dt,n=o(i.apply(null,t.call(arguments,1))),function(e){return e<=0?0:e>=1?1:n(e)}},e.interpolateHcl=function(t,n){t=e.hcl(t),n=e.hcl(n)
var r=t.h,i=t.c,o=t.l,s=n.h-r,a=n.c-i,u=n.l-o
isNaN(a)&&(a=0,i=isNaN(i)?n.c:i)
isNaN(s)?(s=0,r=isNaN(r)?n.h:r):s>180?s-=360:s<-180&&(s+=360)
return function(e){return Ve(r+s*e,i+a*e,o+u*e)+""}},e.interpolateHsl=function(t,n){t=e.hsl(t),n=e.hsl(n)
var r=t.h,i=t.s,o=t.l,s=n.h-r,a=n.s-i,u=n.l-o
isNaN(a)&&(a=0,i=isNaN(i)?n.s:i)
isNaN(s)?(s=0,r=isNaN(r)?n.h:r):s>180?s-=360:s<-180&&(s+=360)
return function(e){return He(r+s*e,i+a*e,o+u*e)+""}},e.interpolateLab=function(t,n){t=e.lab(t),n=e.lab(n)
var r=t.l,i=t.a,o=t.b,s=n.l-r,a=n.a-i,u=n.b-o
return function(e){return Xe(r+s*e,i+a*e,o+u*e)+""}},e.interpolateRound=ao,e.transform=function(t){var n=r.createElementNS(e.ns.prefix.svg,"g")
return(e.transform=function(e){if(null!=e){n.setAttribute("transform",e)
var t=n.transform.baseVal.consolidate()}return new uo(t?t.matrix:po)})(t)},uo.prototype.toString=function(){return"translate("+this.translate+")rotate("+this.rotate+")skewX("+this.skew+")scale("+this.scale+")"}
var po={a:1,b:0,c:0,d:1,e:0,f:0}
function fo(t,n){var r,i=[],o=[],s=e.transform(t),a=e.transform(n),u=s.translate,l=a.translate,c=s.rotate,p=a.rotate,f=s.skew,h=a.skew,d=s.scale,m=a.scale
return u[0]!=l[0]||u[1]!=l[1]?(i.push("translate(",null,",",null,")"),o.push({i:1,x:Ui(u[0],l[0])},{i:3,x:Ui(u[1],l[1])})):l[0]||l[1]?i.push("translate("+l+")"):i.push(""),c!=p?(c-p>180?p+=360:p-c>180&&(c+=360),o.push({i:i.push(i.pop()+"rotate(",null,")")-2,x:Ui(c,p)})):p&&i.push(i.pop()+"rotate("+p+")"),f!=h?o.push({i:i.push(i.pop()+"skewX(",null,")")-2,x:Ui(f,h)}):h&&i.push(i.pop()+"skewX("+h+")"),d[0]!=m[0]||d[1]!=m[1]?(r=i.push(i.pop()+"scale(",null,",",null,")"),o.push({i:r-4,x:Ui(d[0],m[0])},{i:r-2,x:Ui(d[1],m[1])})):1==m[0]&&1==m[1]||i.push(i.pop()+"scale("+m+")"),r=o.length,function(e){for(var t,n=-1;++n<r;)i[(t=o[n]).i]=t.x(e)
return i.join("")}}function ho(e,t){return t=t-(e=+e)?1/(t-e):0,function(n){return(n-e)*t}}function mo(e,t){return t=t-(e=+e)?1/(t-e):0,function(n){return Math.max(0,Math.min(1,(n-e)*t))}}function bo(e){for(var t=e.source,n=e.target,r=function(e,t){if(e===t)return e
var n=go(e),r=go(t),i=n.pop(),o=r.pop(),s=null
for(;i===o;)s=i,i=n.pop(),o=r.pop()
return s}(t,n),i=[t];t!==r;)t=t.parent,i.push(t)
for(var o=i.length;n!==r;)i.splice(o,0,n),n=n.parent
return i}function go(e){for(var t=[],n=e.parent;null!=n;)t.push(e),e=n,n=n.parent
return t.push(e),t}function vo(e){e.fixed|=2}function yo(e){e.fixed&=-7}function _o(e){e.fixed|=4,e.px=e.x,e.py=e.y}function Eo(e){e.fixed&=-5}e.interpolateTransform=fo,e.layout={},e.layout.bundle=function(){return function(e){for(var t=[],n=-1,r=e.length;++n<r;)t.push(bo(e[n]))
return t}},e.layout.chord=function(){var t,n,r,i,o,s,a,u={},l=0
function c(){var u,c,f,h,d,m={},b=[],g=e.range(i),v=[]
for(t=[],n=[],u=0,h=-1;++h<i;){for(c=0,d=-1;++d<i;)c+=r[h][d]
b.push(c),v.push(e.range(i)),u+=c}for(o&&g.sort(function(e,t){return o(b[e],b[t])}),s&&v.forEach(function(e,t){e.sort(function(e,n){return s(r[t][e],r[t][n])})}),u=(Ee-l*i)/u,c=0,h=-1;++h<i;){for(f=c,d=-1;++d<i;){var y=g[h],_=v[y][d],E=r[y][_],x=c,w=c+=E*u
m[y+"-"+_]={index:y,subindex:_,startAngle:x,endAngle:w,value:E}}n[y]={index:y,startAngle:f,endAngle:c,value:(c-f)/u},c+=l}for(h=-1;++h<i;)for(d=h-1;++d<i;){var C=m[h+"-"+d],k=m[d+"-"+h];(C.value||k.value)&&t.push(C.value<k.value?{source:k,target:C}:{source:C,target:k})}a&&p()}function p(){t.sort(function(e,t){return a((e.source.value+e.target.value)/2,(t.source.value+t.target.value)/2)})}return u.matrix=function(e){return arguments.length?(i=(r=e)&&r.length,t=n=null,u):r},u.padding=function(e){return arguments.length?(l=e,t=n=null,u):l},u.sortGroups=function(e){return arguments.length?(o=e,t=n=null,u):o},u.sortSubgroups=function(e){return arguments.length?(s=e,t=null,u):s},u.sortChords=function(e){return arguments.length?(a=e,t&&p(),u):a},u.chords=function(){return t||c(),t},u.groups=function(){return n||c(),n},u},e.layout.force=function(){var t,n,r,i,o,s={},a=e.dispatch("start","tick","end"),u=[1,1],l=.9,c=xo,p=wo,f=-30,h=Co,d=.1,m=.64,b=[],g=[]
function v(e){return function(t,n,r,i){if(t.point!==e){var o=t.cx-e.x,s=t.cy-e.y,a=i-n,u=o*o+s*s
if(a*a/m<u){if(u<h){var l=t.charge/u
e.px-=o*l,e.py-=s*l}return!0}if(t.point&&u&&u<h){l=t.pointCharge/u
e.px-=o*l,e.py-=s*l}}return!t.charge}}function y(t){t.px=e.event.x,t.py=e.event.y,s.resume()}return s.tick=function(){if((n*=.99)<.005)return a.end({type:"end",alpha:n=0}),!0
var t,s,c,p,h,m,y,_,E,x=b.length,w=g.length
for(s=0;s<w;++s)p=(c=g[s]).source,(m=(_=(h=c.target).x-p.x)*_+(E=h.y-p.y)*E)&&(_*=m=n*i[s]*((m=Math.sqrt(m))-r[s])/m,E*=m,h.x-=_*(y=p.weight/(h.weight+p.weight)),h.y-=E*y,p.x+=_*(y=1-y),p.y+=E*y)
if((y=n*d)&&(_=u[0]/2,E=u[1]/2,s=-1,y))for(;++s<x;)(c=b[s]).x+=(_-c.x)*y,c.y+=(E-c.y)*y
if(f)for(function e(t,n,r){var i=0,o=0
t.charge=0
if(!t.leaf)for(var s,a=t.nodes,u=a.length,l=-1;++l<u;)null!=(s=a[l])&&(e(s,n,r),t.charge+=s.charge,i+=s.charge*s.cx,o+=s.charge*s.cy)
if(t.point){t.leaf||(t.point.x+=Math.random()-.5,t.point.y+=Math.random()-.5)
var c=n*r[t.point.index]
t.charge+=t.pointCharge=c,i+=c*t.point.x,o+=c*t.point.y}t.cx=i/t.charge
t.cy=o/t.charge}(t=e.geom.quadtree(b),n,o),s=-1;++s<x;)(c=b[s]).fixed||t.visit(v(c))
for(s=-1;++s<x;)(c=b[s]).fixed?(c.x=c.px,c.y=c.py):(c.x-=(c.px-(c.px=c.x))*l,c.y-=(c.py-(c.py=c.y))*l)
a.tick({type:"tick",alpha:n})},s.nodes=function(e){return arguments.length?(b=e,s):b},s.links=function(e){return arguments.length?(g=e,s):g},s.size=function(e){return arguments.length?(u=e,s):u},s.linkDistance=function(e){return arguments.length?(c="function"==typeof e?e:+e,s):c},s.distance=s.linkDistance,s.linkStrength=function(e){return arguments.length?(p="function"==typeof e?e:+e,s):p},s.friction=function(e){return arguments.length?(l=+e,s):l},s.charge=function(e){return arguments.length?(f="function"==typeof e?e:+e,s):f},s.chargeDistance=function(e){return arguments.length?(h=e*e,s):Math.sqrt(h)},s.gravity=function(e){return arguments.length?(d=+e,s):d},s.theta=function(e){return arguments.length?(m=e*e,s):Math.sqrt(m)},s.alpha=function(t){return arguments.length?(t=+t,n?n=t>0?t:0:t>0&&(a.start({type:"start",alpha:n=t}),e.timer(s.tick)),s):n},s.start=function(){var e,t,n,a=b.length,l=g.length,h=u[0],d=u[1]
for(e=0;e<a;++e)(n=b[e]).index=e,n.weight=0
for(e=0;e<l;++e)"number"==typeof(n=g[e]).source&&(n.source=b[n.source]),"number"==typeof n.target&&(n.target=b[n.target]),++n.source.weight,++n.target.weight
for(e=0;e<a;++e)n=b[e],isNaN(n.x)&&(n.x=m("x",h)),isNaN(n.y)&&(n.y=m("y",d)),isNaN(n.px)&&(n.px=n.x),isNaN(n.py)&&(n.py=n.y)
if(r=[],"function"==typeof c)for(e=0;e<l;++e)r[e]=+c.call(this,g[e],e)
else for(e=0;e<l;++e)r[e]=c
if(i=[],"function"==typeof p)for(e=0;e<l;++e)i[e]=+p.call(this,g[e],e)
else for(e=0;e<l;++e)i[e]=p
if(o=[],"function"==typeof f)for(e=0;e<a;++e)o[e]=+f.call(this,b[e],e)
else for(e=0;e<a;++e)o[e]=f
function m(n,r){if(!t){for(t=new Array(a),u=0;u<a;++u)t[u]=[]
for(u=0;u<l;++u){var i=g[u]
t[i.source.index].push(i.target),t[i.target.index].push(i.source)}}for(var o,s=t[e],u=-1,l=s.length;++u<l;)if(!isNaN(o=s[u][n]))return o
return Math.random()*r}return s.resume()},s.resume=function(){return s.alpha(.1)},s.stop=function(){return s.alpha(0)},s.drag=function(){if(t||(t=e.behavior.drag().origin(dt).on("dragstart.force",vo).on("drag.force",y).on("dragend.force",yo)),!arguments.length)return t
this.on("mouseover.force",_o).on("mouseout.force",Eo).call(t)},e.rebind(s,a,"on")}
var xo=20,wo=1,Co=1/0
function ko(t,n){return e.rebind(t,n,"sort","children","value"),t.nodes=t,t.links=Mo,t}function To(e,t){for(var n=[e];null!=(e=n.pop());)if(t(e),(i=e.children)&&(r=i.length))for(var r,i;--r>=0;)n.push(i[r])}function Oo(e,t){for(var n=[e],r=[];null!=(e=n.pop());)if(r.push(e),(o=e.children)&&(i=o.length))for(var i,o,s=-1;++s<i;)n.push(o[s])
for(;null!=(e=r.pop());)t(e)}function So(e){return e.children}function Ro(e){return e.value}function Po(e,t){return t.value-e.value}function Mo(t){return e.merge(t.map(function(e){return(e.children||[]).map(function(t){return{source:e,target:t}})}))}e.layout.hierarchy=function(){var e=Po,t=So,n=Ro
function r(i){var o,s=[i],a=[]
for(i.depth=0;null!=(o=s.pop());)if(a.push(o),(l=t.call(r,o,o.depth))&&(u=l.length)){for(var u,l,c;--u>=0;)s.push(c=l[u]),c.parent=o,c.depth=o.depth+1
n&&(o.value=0),o.children=l}else n&&(o.value=+n.call(r,o,o.depth)||0),delete o.children
return Oo(i,function(t){var r,i
e&&(r=t.children)&&r.sort(e),n&&(i=t.parent)&&(i.value+=t.value)}),a}return r.sort=function(t){return arguments.length?(e=t,r):e},r.children=function(e){return arguments.length?(t=e,r):t},r.value=function(e){return arguments.length?(n=e,r):n},r.revalue=function(e){return n&&(To(e,function(e){e.children&&(e.value=0)}),Oo(e,function(e){var t
e.children||(e.value=+n.call(r,e,e.depth)||0),(t=e.parent)&&(t.value+=e.value)})),e},r},e.layout.partition=function(){var t=e.layout.hierarchy(),n=[1,1]
function r(e,r){var i=t.call(this,e,r)
return function e(t,n,r,i){var o=t.children
if(t.x=n,t.y=t.depth*i,t.dx=r,t.dy=i,o&&(s=o.length)){var s,a,u,l=-1
for(r=t.value?r/t.value:0;++l<s;)e(a=o[l],n,u=a.value*r,i),n+=u}}(i[0],0,n[0],n[1]/function e(t){var n=t.children,r=0
if(n&&(i=n.length))for(var i,o=-1;++o<i;)r=Math.max(r,e(n[o]))
return 1+r}(i[0])),i}return r.size=function(e){return arguments.length?(n=e,r):n},ko(r,t)},e.layout.pie=function(){var t=Number,n=Ao,r=0,i=Ee
function o(s){var a=s.map(function(e,n){return+t.call(o,e,n)}),u=+("function"==typeof r?r.apply(this,arguments):r),l=(("function"==typeof i?i.apply(this,arguments):i)-u)/e.sum(a),c=e.range(s.length)
null!=n&&c.sort(n===Ao?function(e,t){return a[t]-a[e]}:function(e,t){return n(s[e],s[t])})
var p=[]
return c.forEach(function(e){var t
p[e]={data:s[e],value:t=a[e],startAngle:u,endAngle:u+=t*l}}),p}return o.value=function(e){return arguments.length?(t=e,o):t},o.sort=function(e){return arguments.length?(n=e,o):n},o.startAngle=function(e){return arguments.length?(r=e,o):r},o.endAngle=function(e){return arguments.length?(i=e,o):i},o}
var Ao={}
function No(e){return e.x}function jo(e){return e.y}function Lo(e,t,n){e.y0=t,e.y=n}e.layout.stack=function(){var t=dt,n=Bo,r=Fo,i=Lo,o=No,s=jo
function a(u,l){var c=u.map(function(e,n){return t.call(a,e,n)}),p=c.map(function(e){return e.map(function(e,t){return[o.call(a,e,t),s.call(a,e,t)]})}),f=n.call(a,p,l)
c=e.permute(c,f),p=e.permute(p,f)
var h,d,m,b=r.call(a,p,l),g=c.length,v=c[0].length
for(d=0;d<v;++d)for(i.call(a,c[0][d],m=b[d],p[0][d][1]),h=1;h<g;++h)i.call(a,c[h][d],m+=p[h-1][d][1],p[h][d][1])
return u}return a.values=function(e){return arguments.length?(t=e,a):t},a.order=function(e){return arguments.length?(n="function"==typeof e?e:Io.get(e)||Bo,a):n},a.offset=function(e){return arguments.length?(r="function"==typeof e?e:Do.get(e)||Fo,a):r},a.x=function(e){return arguments.length?(o=e,a):o},a.y=function(e){return arguments.length?(s=e,a):s},a.out=function(e){return arguments.length?(i=e,a):i},a}
var Io=e.map({"inside-out":function(t){var n,r,i=t.length,o=t.map(zo),s=t.map(Ho),a=e.range(i).sort(function(e,t){return o[e]-o[t]}),u=0,l=0,c=[],p=[]
for(n=0;n<i;++n)r=a[n],u<l?(u+=s[r],c.push(r)):(l+=s[r],p.push(r))
return p.reverse().concat(c)},reverse:function(t){return e.range(t.length).reverse()},default:Bo}),Do=e.map({silhouette:function(e){var t,n,r,i=e.length,o=e[0].length,s=[],a=0,u=[]
for(n=0;n<o;++n){for(t=0,r=0;t<i;t++)r+=e[t][n][1]
r>a&&(a=r),s.push(r)}for(n=0;n<o;++n)u[n]=(a-s[n])/2
return u},wiggle:function(e){var t,n,r,i,o,s,a,u,l,c=e.length,p=e[0],f=p.length,h=[]
for(h[0]=u=l=0,n=1;n<f;++n){for(t=0,i=0;t<c;++t)i+=e[t][n][1]
for(t=0,o=0,a=p[n][0]-p[n-1][0];t<c;++t){for(r=0,s=(e[t][n][1]-e[t][n-1][1])/(2*a);r<t;++r)s+=(e[r][n][1]-e[r][n-1][1])/a
o+=s*e[t][n][1]}h[n]=u-=i?o/i*a:0,u<l&&(l=u)}for(n=0;n<f;++n)h[n]-=l
return h},expand:function(e){var t,n,r,i=e.length,o=e[0].length,s=1/i,a=[]
for(n=0;n<o;++n){for(t=0,r=0;t<i;t++)r+=e[t][n][1]
if(r)for(t=0;t<i;t++)e[t][n][1]/=r
else for(t=0;t<i;t++)e[t][n][1]=s}for(n=0;n<o;++n)a[n]=0
return a},zero:Fo})
function Bo(t){return e.range(t.length)}function Fo(e){for(var t=-1,n=e[0].length,r=[];++t<n;)r[t]=0
return r}function zo(e){for(var t,n=1,r=0,i=e[0][1],o=e.length;n<o;++n)(t=e[n][1])>i&&(r=n,i=t)
return r}function Ho(e){return e.reduce(qo,0)}function qo(e,t){return e+t[1]}function Uo(e,t){return Vo(e,Math.ceil(Math.log(t.length)/Math.LN2+1))}function Vo(e,t){for(var n=-1,r=+e[0],i=(e[1]-r)/t,o=[];++n<=t;)o[n]=i*n+r
return o}function Wo(t){return[e.min(t),e.max(t)]}function Yo(e,t){return e.value-t.value}function Go(e,t){var n=e._pack_next
e._pack_next=t,t._pack_prev=e,t._pack_next=n,n._pack_prev=t}function Qo(e,t){e._pack_next=t,t._pack_prev=e}function Ko(e,t){var n=t.x-e.x,r=t.y-e.y,i=e.r+t.r
return.999*i*i>n*n+r*r}function $o(e){if((t=e.children)&&(u=t.length)){var t,n,r,i,o,s,a,u,l=1/0,c=-1/0,p=1/0,f=-1/0
if(t.forEach(Xo),(n=t[0]).x=-n.r,n.y=0,y(n),u>1&&((r=t[1]).x=r.r,r.y=0,y(r),u>2))for(Zo(n,r,i=t[2]),y(i),Go(n,i),n._pack_prev=i,Go(i,r),r=n._pack_next,o=3;o<u;o++){Zo(n,r,i=t[o])
var h=0,d=1,m=1
for(s=r._pack_next;s!==r;s=s._pack_next,d++)if(Ko(s,i)){h=1
break}if(1==h)for(a=n._pack_prev;a!==s._pack_prev&&!Ko(a,i);a=a._pack_prev,m++);h?(d<m||d==m&&r.r<n.r?Qo(n,r=s):Qo(n=a,r),o--):(Go(n,i),r=i,y(i))}var b=(l+c)/2,g=(p+f)/2,v=0
for(o=0;o<u;o++)(i=t[o]).x-=b,i.y-=g,v=Math.max(v,i.r+Math.sqrt(i.x*i.x+i.y*i.y))
e.r=v,t.forEach(Jo)}function y(e){l=Math.min(e.x-e.r,l),c=Math.max(e.x+e.r,c),p=Math.min(e.y-e.r,p),f=Math.max(e.y+e.r,f)}}function Xo(e){e._pack_next=e._pack_prev=e}function Jo(e){delete e._pack_next,delete e._pack_prev}function Zo(e,t,n){var r=e.r+n.r,i=t.x-e.x,o=t.y-e.y
if(r&&(i||o)){var s=t.r+n.r,a=i*i+o*o,u=.5+((r*=r)-(s*=s))/(2*a),l=Math.sqrt(Math.max(0,2*s*(r+a)-(r-=a)*r-s*s))/(2*a)
n.x=e.x+u*i+l*o,n.y=e.y+u*o-l*i}else n.x=e.x+r,n.y=e.y}function es(e,t){return e.parent==t.parent?1:2}function ts(e){var t=e.children
return t.length?t[0]:e.t}function ns(e){var t,n=e.children
return(t=n.length)?n[t-1]:e.t}function rs(e,t,n){var r=n/(t.i-e.i)
t.c-=r,t.s+=n,e.c+=r,t.z+=n,t.m+=n}function is(e,t,n){return e.a.parent===t.parent?e.a:n}function os(e){return{x:e.x,y:e.y,dx:e.dx,dy:e.dy}}function ss(e,t){var n=e.x+t[3],r=e.y+t[0],i=e.dx-t[1]-t[3],o=e.dy-t[0]-t[2]
return i<0&&(n+=i/2,i=0),o<0&&(r+=o/2,o=0),{x:n,y:r,dx:i,dy:o}}function as(e){var t=e[0],n=e[e.length-1]
return t<n?[t,n]:[n,t]}function us(e){return e.rangeExtent?e.rangeExtent():as(e.range())}function ls(e,t,n,r){var i=n(e[0],e[1]),o=r(t[0],t[1])
return function(e){return o(i(e))}}function cs(e,t){var n,r=0,i=e.length-1,o=e[r],s=e[i]
return s<o&&(n=r,r=i,i=n,n=o,o=s,s=n),e[r]=t.floor(o),e[i]=t.ceil(s),e}e.layout.histogram=function(){var t=!0,n=Number,r=Wo,i=Uo
function o(o,s){for(var a,u,l=[],c=o.map(n,this),p=r.call(this,c,s),f=i.call(this,p,c,s),h=(s=-1,c.length),d=f.length-1,m=t?1:1/h;++s<d;)(a=l[s]=[]).dx=f[s+1]-(a.x=f[s]),a.y=0
if(d>0)for(s=-1;++s<h;)(u=c[s])>=p[0]&&u<=p[1]&&((a=l[e.bisect(f,u,1,d)-1]).y+=m,a.push(o[s]))
return l}return o.value=function(e){return arguments.length?(n=e,o):n},o.range=function(e){return arguments.length?(r=ht(e),o):r},o.bins=function(e){return arguments.length?(i="number"==typeof e?function(t){return Vo(t,e)}:ht(e),o):i},o.frequency=function(e){return arguments.length?(t=!!e,o):t},o},e.layout.pack=function(){var t,n=e.layout.hierarchy().sort(Yo),r=0,i=[1,1]
function o(e,o){var s=n.call(this,e,o),a=s[0],u=i[0],l=i[1],c=null==t?Math.sqrt:"function"==typeof t?t:function(){return t}
if(a.x=a.y=0,Oo(a,function(e){e.r=+c(e.value)}),Oo(a,$o),r){var p=r*(t?1:Math.max(2*a.r/u,2*a.r/l))/2
Oo(a,function(e){e.r+=p}),Oo(a,$o),Oo(a,function(e){e.r-=p})}return function e(t,n,r,i){var o=t.children
t.x=n+=i*t.x
t.y=r+=i*t.y
t.r*=i
if(o)for(var s=-1,a=o.length;++s<a;)e(o[s],n,r,i)}(a,u/2,l/2,t?1:1/Math.max(2*a.r/u,2*a.r/l)),s}return o.size=function(e){return arguments.length?(i=e,o):i},o.radius=function(e){return arguments.length?(t=null==e||"function"==typeof e?e:+e,o):t},o.padding=function(e){return arguments.length?(r=+e,o):r},ko(o,n)},e.layout.tree=function(){var t=e.layout.hierarchy().sort(null).value(null),n=es,r=[1,1],i=null
function o(e,o){var l=t.call(this,e,o),c=l[0],p=function(e){var t,n={A:null,children:[e]},r=[n]
for(;null!=(t=r.pop());)for(var i,o=t.children,s=0,a=o.length;s<a;++s)r.push((o[s]=i={_:o[s],parent:t,children:(i=o[s].children)&&i.slice()||[],A:null,a:null,z:0,m:0,c:0,s:0,t:null,i:s}).a=i)
return n.children[0]}(c)
if(Oo(p,s),p.parent.m=-p.z,To(p,a),i)To(c,u)
else{var f=c,h=c,d=c
To(c,function(e){e.x<f.x&&(f=e),e.x>h.x&&(h=e),e.depth>d.depth&&(d=e)})
var m=n(f,h)/2-f.x,b=r[0]/(h.x+n(h,f)/2+m),g=r[1]/(d.depth||1)
To(c,function(e){e.x=(e.x+m)*b,e.y=e.depth*g})}return l}function s(e){var t=e.children,r=e.parent.children,i=e.i?r[e.i-1]:null
if(t.length){(function(e){var t,n=0,r=0,i=e.children,o=i.length
for(;--o>=0;)(t=i[o]).z+=n,t.m+=n,n+=t.s+(r+=t.c)})(e)
var o=(t[0].z+t[t.length-1].z)/2
i?(e.z=i.z+n(e._,i._),e.m=e.z-o):e.z=o}else i&&(e.z=i.z+n(e._,i._))
e.parent.A=function(e,t,r){if(t){for(var i,o=e,s=e,a=t,u=o.parent.children[0],l=o.m,c=s.m,p=a.m,f=u.m;a=ns(a),o=ts(o),a&&o;)u=ts(u),(s=ns(s)).a=e,(i=a.z+p-o.z-l+n(a._,o._))>0&&(rs(is(a,e,r),e,i),l+=i,c+=i),p+=a.m,l+=o.m,f+=u.m,c+=s.m
a&&!ns(s)&&(s.t=a,s.m+=p-c),o&&!ts(u)&&(u.t=o,u.m+=l-f,r=e)}return r}(e,i,e.parent.A||r[0])}function a(e){e._.x=e.z+e.parent.m,e.m+=e.parent.m}function u(e){e.x*=r[0],e.y=e.depth*r[1]}return o.separation=function(e){return arguments.length?(n=e,o):n},o.size=function(e){return arguments.length?(i=null==(r=e)?u:null,o):i?null:r},o.nodeSize=function(e){return arguments.length?(i=null==(r=e)?null:u,o):i?r:null},ko(o,t)},e.layout.cluster=function(){var t=e.layout.hierarchy().sort(null).value(null),n=es,r=[1,1],i=!1
function o(o,s){var a,u=t.call(this,o,s),l=u[0],c=0
Oo(l,function(t){var r=t.children
r&&r.length?(t.x=function(e){return e.reduce(function(e,t){return e+t.x},0)/e.length}(r),t.y=function(t){return 1+e.max(t,function(e){return e.y})}(r)):(t.x=a?c+=n(t,a):0,t.y=0,a=t)})
var p=function e(t){var n=t.children
return n&&n.length?e(n[0]):t}(l),f=function e(t){var n,r=t.children
return r&&(n=r.length)?e(r[n-1]):t}(l),h=p.x-n(p,f)/2,d=f.x+n(f,p)/2
return Oo(l,i?function(e){e.x=(e.x-l.x)*r[0],e.y=(l.y-e.y)*r[1]}:function(e){e.x=(e.x-h)/(d-h)*r[0],e.y=(1-(l.y?e.y/l.y:1))*r[1]}),u}return o.separation=function(e){return arguments.length?(n=e,o):n},o.size=function(e){return arguments.length?(i=null==(r=e),o):i?null:r},o.nodeSize=function(e){return arguments.length?(i=null!=(r=e),o):i?r:null},ko(o,t)},e.layout.treemap=function(){var t,n=e.layout.hierarchy(),r=Math.round,i=[1,1],o=null,s=os,a=!1,u="squarify",l=.5*(1+Math.sqrt(5))
function c(e,t){for(var n,r,i=-1,o=e.length;++i<o;)r=(n=e[i]).value*(t<0?0:t),n.area=isNaN(r)||r<=0?0:r}function p(e){var t=e.children
if(t&&t.length){var n,r,i,o=s(e),a=[],l=t.slice(),f=1/0,m="slice"===u?o.dx:"dice"===u?o.dy:"slice-dice"===u?1&e.depth?o.dy:o.dx:Math.min(o.dx,o.dy)
for(c(l,o.dx*o.dy/e.value),a.area=0;(i=l.length)>0;)a.push(n=l[i-1]),a.area+=n.area,"squarify"!==u||(r=h(a,m))<=f?(l.pop(),f=r):(a.area-=a.pop().area,d(a,m,o,!1),m=Math.min(o.dx,o.dy),a.length=a.area=0,f=1/0)
a.length&&(d(a,m,o,!0),a.length=a.area=0),t.forEach(p)}}function f(e){var t=e.children
if(t&&t.length){var n,r=s(e),i=t.slice(),o=[]
for(c(i,r.dx*r.dy/e.value),o.area=0;n=i.pop();)o.push(n),o.area+=n.area,null!=n.z&&(d(o,n.z?r.dx:r.dy,r,!i.length),o.length=o.area=0)
t.forEach(f)}}function h(e,t){for(var n,r=e.area,i=0,o=1/0,s=-1,a=e.length;++s<a;)(n=e[s].area)&&(n<o&&(o=n),n>i&&(i=n))
return t*=t,(r*=r)?Math.max(t*i*l/r,r/(t*o*l)):1/0}function d(e,t,n,i){var o,s=-1,a=e.length,u=n.x,l=n.y,c=t?r(e.area/t):0
if(t==n.dx){for((i||c>n.dy)&&(c=n.dy);++s<a;)(o=e[s]).x=u,o.y=l,o.dy=c,u+=o.dx=Math.min(n.x+n.dx-u,c?r(o.area/c):0)
o.z=!0,o.dx+=n.x+n.dx-u,n.y+=c,n.dy-=c}else{for((i||c>n.dx)&&(c=n.dx);++s<a;)(o=e[s]).x=u,o.y=l,o.dx=c,l+=o.dy=Math.min(n.y+n.dy-l,c?r(o.area/c):0)
o.z=!1,o.dy+=n.y+n.dy-l,n.x+=c,n.dx-=c}}function m(e){var r=t||n(e),o=r[0]
return o.x=0,o.y=0,o.dx=i[0],o.dy=i[1],t&&n.revalue(o),c([o],o.dx*o.dy/o.value),(t?f:p)(o),a&&(t=r),r}return m.size=function(e){return arguments.length?(i=e,m):i},m.padding=function(e){if(!arguments.length)return o
function t(t){return ss(t,e)}var n
return s=null==(o=e)?os:"function"==(n=typeof e)?function(t){var n=e.call(m,t,t.depth)
return null==n?os(t):ss(t,"number"==typeof n?[n,n,n,n]:n)}:"number"===n?(e=[e,e,e,e],t):t,m},m.round=function(e){return arguments.length?(r=e?Math.round:Number,m):r!=Number},m.sticky=function(e){return arguments.length?(a=e,t=null,m):a},m.ratio=function(e){return arguments.length?(l=e,m):l},m.mode=function(e){return arguments.length?(u=e+"",m):u},ko(m,n)},e.random={normal:function(e,t){var n=arguments.length
...
return t}}},e.scale={}
var ps={floor:dt,ceil:dt}
function fs(t,n,r,i){var o=[],s=[],a=0,u=Math.min(t.length,n.length)-1
for(t[u]<t[0]&&(t=t.slice().reverse(),n=n.slice().reverse());++a<=u;)o.push(r(t[a-1],t[a])),s.push(i(n[a-1],n[a]))
return function(n){var r=e.bisect(t,n,1,u)-1
return s[r](o[r](n))}}function hs(t,n){return e.rebind(t,n,"range","rangeRound","interpolate","clamp")}function ds(e,t){return cs(e,(n=ms(e,t)[2])?{floor:function(e){return Math.floor(e/n)*n},ceil:function(e){return Math.ceil(e/n)*n}}:ps)
var n}function ms(e,t){null==t&&(t=10)
var n=as(e),r=n[1]-n[0],i=Math.pow(10,Math.floor(Math.log(r/t)/Math.LN10)),o=t/r*i
return o<=.15?i*=10:o<=.35?i*=5:o<=.75&&(i*=2),n[0]=Math.ceil(n[0]/i)*i,n[1]=Math.floor(n[1]/i)*i+.5*i,n[2]=i,n}function bs(t,n){return e.range.apply(e,ms(t,n))}function gs(t,n,r){var i=ms(t,n)
if(r){var o=St.exec(r)
if(o.shift(),"s"===o[8]){var s=e.formatPrefix(Math.max(b(i[0]),b(i[1])))
return o[7]||(o[7]="."+ys(s.scale(i[2]))),o[8]="f",r=e.format(o.join("")),function(e){return r(s.scale(e))+s.symbol}}o[7]||(o[7]="."+function(e,t){var n=ys(t[2])
return e in vs?Math.abs(n-ys(Math.max(b(t[0]),b(t[1]))))+ +("e"!==e):n-2*("%"===e)}(o[8],i)),r=o.join("")}else r=",."+ys(i[2])+"f"
return e.format(r)}e.scale.linear=function(){return function e(t,n,r,i){var o,s
function a(){var e=Math.min(t.length,n.length)>2?fs:ls,a=i?mo:ho
return o=e(t,n,a,r),s=e(n,t,a,Gi),u}function u(e){return o(e)}u.invert=function(e){return s(e)}
u.domain=function(e){return arguments.length?(t=e.map(Number),a()):t}
u.range=function(e){return arguments.length?(n=e,a()):n}
u.rangeRound=function(e){return u.range(e).interpolate(ao)}
u.clamp=function(e){return arguments.length?(i=e,a()):i}
u.interpolate=function(e){return arguments.length?(r=e,a()):r}
u.ticks=function(e){return bs(t,e)}
u.tickFormat=function(e,n){return gs(t,e,n)}
u.nice=function(e){return ds(t,e),a()}
u.copy=function(){return e(t,n,r,i)}
return a()}([0,1],[0,1],Gi,!1)}
var vs={s:1,g:1,p:1,r:1,e:1}
function ys(e){return-Math.floor(Math.log(e)/Math.LN10+.01)}e.scale.log=function(){return function t(n,r,i,o){function s(e){return(i?Math.log(e<0?0:e):-Math.log(e>0?0:-e))/Math.log(r)}function a(e){return i?Math.pow(r,e):-Math.pow(r,-e)}function u(e){return n(s(e))}u.invert=function(e){return a(n.invert(e))}
u.domain=function(e){return arguments.length?(i=e[0]>=0,n.domain((o=e.map(Number)).map(s)),u):o}
u.base=function(e){return arguments.length?(r=+e,n.domain(o.map(s)),u):r}
u.nice=function(){var e=cs(o.map(s),i?Math:Es)
return n.domain(e),o=e.map(a),u}
u.ticks=function(){var e=as(o),t=[],n=e[0],u=e[1],l=Math.floor(s(n)),c=Math.ceil(s(u)),p=r%1?2:r
if(isFinite(c-l)){if(i){for(;l<c;l++)for(var f=1;f<p;f++)t.push(a(l)*f)
t.push(a(l))}else for(t.push(a(l));l++<c;)for(var f=p-1;f>0;f--)t.push(a(l)*f)
for(l=0;t[l]<n;l++);for(c=t.length;t[c-1]>u;c--);t=t.slice(l,c)}return t}
u.tickFormat=function(t,n){if(!arguments.length)return _s
arguments.length<2?n=_s:"function"!=typeof n&&(n=e.format(n))
var r,o=Math.max(.1,t/u.ticks().length),l=i?(r=1e-12,Math.ceil):(r=-1e-12,Math.floor)
return function(e){return e/a(l(s(e)+r))<=o?n(e):""}}
u.copy=function(){return t(n.copy(),r,i,o)}
return hs(u,n)}(e.scale.linear().domain([0,1]),10,!0,[1,10])}
var _s=e.format(".0e"),Es={floor:function(e){return-Math.ceil(-e)},ceil:function(e){return-Math.floor(-e)}}
function xs(e){return function(t){return t<0?-Math.pow(-t,e):Math.pow(t,e)}}e.scale.pow=function(){return function e(t,n,r){var i=xs(n),o=xs(1/n)
function s(e){return t(i(e))}s.invert=function(e){return o(t.invert(e))}
s.domain=function(e){return arguments.length?(t.domain((r=e.map(Number)).map(i)),s):r}
s.ticks=function(e){return bs(r,e)}
s.tickFormat=function(e,t){return gs(r,e,t)}
s.nice=function(e){return s.domain(ds(r,e))}
s.exponent=function(e){return arguments.length?(i=xs(n=e),o=xs(1/n),t.domain(r.map(i)),s):n}
s.copy=function(){return e(t.copy(),n,r)}
return hs(s,t)}(e.scale.linear(),1,[0,1])},e.scale.sqrt=function(){return e.scale.pow().exponent(.5)},e.scale.ordinal=function(){return function t(n,r){var i,o,s
function a(e){return o[((i.get(e)||("range"===r.t?i.set(e,n.push(e)):NaN))-1)%o.length]}function u(t,r){return e.range(n.length).map(function(e){return t+r*e})}a.domain=function(e){if(!arguments.length)return n
n=[],i=new v
for(var t,o=-1,s=e.length;++o<s;)i.has(t=e[o])||i.set(t,n.push(t))
return a[r.t].apply(a,r.a)}
a.range=function(e){return arguments.length?(o=e,s=0,r={t:"range",a:arguments},a):o}
a.rangePoints=function(e,t){arguments.length<2&&(t=0)
var i=e[0],l=e[1],c=(l-i)/(Math.max(1,n.length-1)+t)
return o=u(n.length<2?(i+l)/2:i+c*t/2,c),s=0,r={t:"rangePoints",a:arguments},a}
a.rangeBands=function(e,t,i){arguments.length<2&&(t=0),arguments.length<3&&(i=t)
var l=e[1]<e[0],c=e[l-0],p=e[1-l],f=(p-c)/(n.length-t+2*i)
return o=u(c+f*i,f),l&&o.reverse(),s=f*(1-t),r={t:"rangeBands",a:arguments},a}
a.rangeRoundBands=function(e,t,i){arguments.length<2&&(t=0),arguments.length<3&&(i=t)
var l=e[1]<e[0],c=e[l-0],p=e[1-l],f=Math.floor((p-c)/(n.length-t+2*i)),h=p-c-(n.length-t)*f
return o=u(c+Math.round(h/2),f),l&&o.reverse(),s=Math.round(f*(1-t)),r={t:"rangeRoundBands",a:arguments},a}
a.rangeBand=function(){return s}
a.rangeExtent=function(){return as(r.a[0])}
a.copy=function(){return t(n,r)}
return a.domain(n)}([],{t:"range",a:[[]]})},e.scale.category10=function(){return e.scale.ordinal().range(ws)},e.scale.category20=function(){return e.scale.ordinal().range(Cs)},e.scale.category20b=function(){return e.scale.ordinal().range(ks)},e.scale.category20c=function(){return e.scale.ordinal().range(Ts)}
var ws=[2062260,16744206,2924588,14034728,9725885,9197131,14907330,8355711,12369186,1556175].map(it),Cs=[2062260,11454440,16744206,16759672,2924588,10018698,14034728,16750742,9725885,12955861,9197131,12885140,14907330,16234194,8355711,13092807,12369186,14408589,1556175,10410725].map(it),ks=[3750777,5395619,7040719,10264286,6519097,9216594,11915115,13556636,9202993,12426809,15186514,15190932,8666169,11356490,14049643,15177372,8077683,10834324,13528509,14589654].map(it),Ts=[3244733,7057110,10406625,13032431,15095053,16616764,16625259,16634018,3253076,7652470,10607003,13101504,7695281,10394312,12369372,14342891,6513507,9868950,12434877,14277081].map(it)
e.scale.quantile=function(){return function t(n,r){var i
function o(){var t=0,o=r.length
for(i=[];++t<o;)i[t-1]=e.quantile(n,t/o)
return s}function s(t){if(!isNaN(t=+t))return r[e.bisect(i,t)]}s.domain=function(e){return arguments.length?(n=e.filter(f).sort(p),o()):n}
s.range=function(e){return arguments.length?(r=e,o()):r}
s.quantiles=function(){return i}
s.invertExtent=function(e){return(e=r.indexOf(e))<0?[NaN,NaN]:[e>0?i[e-1]:n[0],e<i.length?i[e]:n[n.length-1]]}
s.copy=function(){return t(n,r)}
return o()}([],[])},e.scale.quantize=function(){return function e(t,n,r){var i,o
function s(e){return r[Math.max(0,Math.min(o,Math.floor(i*(e-t))))]}function a(){return i=r.length/(n-t),o=r.length-1,s}s.domain=function(e){return arguments.length?(t=+e[0],n=+e[e.length-1],a()):[t,n]}
s.range=function(e){return arguments.length?(r=e,a()):r}
s.invertExtent=function(e){return[e=(e=r.indexOf(e))<0?NaN:e/i+t,e+1/i]}
s.copy=function(){return e(t,n,r)}
return a()}(0,1,[0,1])},e.scale.threshold=function(){return function t(n,r){function i(t){if(t<=t)return r[e.bisect(n,t)]}i.domain=function(e){return arguments.length?(n=e,i):n}
i.range=function(e){return arguments.length?(r=e,i):r}
i.invertExtent=function(e){return e=r.indexOf(e),[n[e-1],n[e]]}
i.copy=function(){return t(n,r)}
return i}([.5],[0,1])},e.scale.identity=function(){return function e(t){function n(e){return+e}n.invert=n
n.domain=n.range=function(e){return arguments.length?(t=e.map(n),n):t}
n.ticks=function(e){return bs(t,e)}
n.tickFormat=function(e,n){return gs(t,e,n)}
n.copy=function(){return e(t)}
return n}([0,1])},e.svg={},e.svg.arc=function(){var e=Rs,t=Ps,n=Ms,r=As
function i(){var i=e.apply(this,arguments),o=t.apply(this,arguments),s=n.apply(this,arguments)+Os,a=r.apply(this,arguments)+Os,u=(a<s&&(u=s,s=a,a=u),a-s),l=u<_e?"0":"1",c=Math.cos(s),p=Math.sin(s),f=Math.cos(a),h=Math.sin(a)
return u>=Ss?i?"M0,"+o+"A"+o+","+o+" 0 1,1 0,"+-o+"A"+o+","+o+" 0 1,1 0,"+o+"M0,"+i+"A"+i+","+i+" 0 1,0 0,"+-i+"A"+i+","+i+" 0 1,0 0,"+i+"Z":"M0,"+o+"A"+o+","+o+" 0 1,1 0,"+-o+"A"+o+","+o+" 0 1,1 0,"+o+"Z":i?"M"+o*c+","+o*p+"A"+o+","+o+" 0 "+l+",1 "+o*f+","+o*h+"L"+i*f+","+i*h+"A"+i+","+i+" 0 "+l+",0 "+i*c+","+i*p+"Z":"M"+o*c+","+o*p+"A"+o+","+o+" 0 "+l+",1 "+o*f+","+o*h+"L0,0Z"}return i.innerRadius=function(t){return arguments.length?(e=ht(t),i):e},i.outerRadius=function(e){return arguments.length?(t=ht(e),i):t},i.startAngle=function(e){return arguments.length?(n=ht(e),i):n},i.endAngle=function(e){return arguments.length?(r=ht(e),i):r},i.centroid=function(){var i=(e.apply(this,arguments)+t.apply(this,arguments))/2,o=(n.apply(this,arguments)+r.apply(this,arguments))/2+Os
return[Math.cos(o)*i,Math.sin(o)*i]},i}
var Os=-xe,Ss=Ee-we
function Rs(e){return e.innerRadius}function Ps(e){return e.outerRadius}function Ms(e){return e.startAngle}function As(e){return e.endAngle}function Ns(e){var t=Zr,n=ei,r=Vn,i=Ls,o=i.key,s=.7
function a(o){var a,u=[],l=[],c=-1,p=o.length,f=ht(t),h=ht(n)
function d(){u.push("M",i(e(l),s))}for(;++c<p;)r.call(this,a=o[c],c)?l.push([+f.call(this,a,c),+h.call(this,a,c)]):l.length&&(d(),l=[])
return l.length&&d(),u.length?u.join(""):null}return a.x=function(e){return arguments.length?(t=e,a):t},a.y=function(e){return arguments.length?(n=e,a):n},a.defined=function(e){return arguments.length?(r=e,a):r},a.interpolate=function(e){return arguments.length?(o="function"==typeof e?i=e:(i=js.get(e)||Ls).key,a):o},a.tension=function(e){return arguments.length?(s=e,a):s},a}e.svg.line=function(){return Ns(dt)}
var js=e.map({linear:Ls,"linear-closed":function(e){return Ls(e)+"Z"},step:function(e){var t=0,n=e.length,r=e[0],i=[r[0],",",r[1]]
for(;++t<n;)i.push("H",(r[0]+(r=e[t])[0])/2,"V",r[1])
n>1&&i.push("H",r[0])
return i.join("")},"step-before":Is,"step-after":Ds,basis:zs,"basis-open":function(e){if(e.length<4)return Ls(e)
var t,n=[],r=-1,i=e.length,o=[0],s=[0]
for(;++r<3;)t=e[r],o.push(t[0]),s.push(t[1])
n.push(Hs(Vs,o)+","+Hs(Vs,s)),--r
for(;++r<i;)t=e[r],o.shift(),o.push(t[0]),s.shift(),s.push(t[1]),Ws(n,o,s)
return n.join("")},"basis-closed":function(e){var t,n,r=-1,i=e.length,o=i+4,s=[],a=[]
for(;++r<4;)n=e[r%i],s.push(n[0]),a.push(n[1])
t=[Hs(Vs,s),",",Hs(Vs,a)],--r
for(;++r<o;)n=e[r%i],s.shift(),s.push(n[0]),a.shift(),a.push(n[1]),Ws(t,s,a)
return t.join("")},bundle:function(e,t){var n=e.length-1
if(n)for(var r,i,o=e[0][0],s=e[0][1],a=e[n][0]-o,u=e[n][1]-s,l=-1;++l<=n;)r=e[l],i=l/n,r[0]=t*r[0]+(1-t)*(o+i*a),r[1]=t*r[1]+(1-t)*(s+i*u)
return zs(e)},cardinal:function(e,t){return e.length<3?Ls(e):e[0]+Bs(e,Fs(e,t))},"cardinal-open":function(e,t){return e.length<4?Ls(e):e[1]+Bs(e.slice(1,e.length-1),Fs(e,t))},"cardinal-closed":function(e,t){return e.length<3?Ls(e):e[0]+Bs((e.push(e[0]),e),Fs([e[e.length-2]].concat(e,[e[1]]),t))},monotone:function(e){return e.length<3?Ls(e):e[0]+Bs(e,function(e){var t,n,r,i,o=[],s=function(e){var t=0,n=e.length-1,r=[],i=e[0],o=e[1],s=r[0]=Ys(i,o)
for(;++t<n;)r[t]=(s+(s=Ys(i=o,o=e[t+1])))/2
return r[t]=s,r}(e),a=-1,u=e.length-1
for(;++a<u;)t=Ys(e[a],e[a+1]),b(t)<we?s[a]=s[a+1]=0:(n=s[a]/t,r=s[a+1]/t,(i=n*n+r*r)>9&&(i=3*t/Math.sqrt(i),s[a]=i*n,s[a+1]=i*r))
a=-1
for(;++a<=u;)i=(e[Math.min(u,a+1)][0]-e[Math.max(0,a-1)][0])/(6*(1+s[a]*s[a])),o.push([i||0,s[a]*i||0])
return o}(e))}})
function Ls(e){return e.join("L")}function Is(e){for(var t=0,n=e.length,r=e[0],i=[r[0],",",r[1]];++t<n;)i.push("V",(r=e[t])[1],"H",r[0])
return i.join("")}function Ds(e){for(var t=0,n=e.length,r=e[0],i=[r[0],",",r[1]];++t<n;)i.push("H",(r=e[t])[0],"V",r[1])
return i.join("")}function Bs(e,t){if(t.length<1||e.length!=t.length&&e.length!=t.length+2)return Ls(e)
var n=e.length!=t.length,r="",i=e[0],o=e[1],s=t[0],a=s,u=1
if(n&&(r+="Q"+(o[0]-2*s[0]/3)+","+(o[1]-2*s[1]/3)+","+o[0]+","+o[1],i=e[1],u=2),t.length>1){a=t[1],o=e[u],u++,r+="C"+(i[0]+s[0])+","+(i[1]+s[1])+","+(o[0]-a[0])+","+(o[1]-a[1])+","+o[0]+","+o[1]
for(var l=2;l<t.length;l++,u++)o=e[u],a=t[l],r+="S"+(o[0]-a[0])+","+(o[1]-a[1])+","+o[0]+","+o[1]}if(n){var c=e[u]
r+="Q"+(o[0]+2*a[0]/3)+","+(o[1]+2*a[1]/3)+","+c[0]+","+c[1]}return r}function Fs(e,t){for(var n,r=[],i=(1-t)/2,o=e[0],s=e[1],a=1,u=e.length;++a<u;)n=o,o=s,s=e[a],r.push([i*(s[0]-n[0]),i*(s[1]-n[1])])
return r}function zs(e){if(e.length<3)return Ls(e)
var t=1,n=e.length,r=e[0],i=r[0],o=r[1],s=[i,i,i,(r=e[1])[0]],a=[o,o,o,r[1]],u=[i,",",o,"L",Hs(Vs,s),",",Hs(Vs,a)]
for(e.push(e[n-1]);++t<=n;)r=e[t],s.shift(),s.push(r[0]),a.shift(),a.push(r[1]),Ws(u,s,a)
return e.pop(),u.push("L",r),u.join("")}function Hs(e,t){return e[0]*t[0]+e[1]*t[1]+e[2]*t[2]+e[3]*t[3]}js.forEach(function(e,t){t.key=e,t.closed=/-closed$/.test(e)})
var qs=[0,2/3,1/3,0],Us=[0,1/3,2/3,0],Vs=[0,1/6,2/3,1/6]
function Ws(e,t,n){e.push("C",Hs(qs,t),",",Hs(qs,n),",",Hs(Us,t),",",Hs(Us,n),",",Hs(Vs,t),",",Hs(Vs,n))}function Ys(e,t){return(t[1]-e[1])/(t[0]-e[0])}function Gs(e){for(var t,n,r,i=-1,o=e.length;++i<o;)n=(t=e[i])[0],r=t[1]+Os,t[0]=n*Math.cos(r),t[1]=n*Math.sin(r)
return e}function Qs(e){var t=Zr,n=Zr,r=0,i=ei,o=Vn,s=Ls,a=s.key,u=s,l="L",c=.7
function p(a){var p,f,h,d=[],m=[],b=[],g=-1,v=a.length,y=ht(t),_=ht(r),E=t===n?function(){return f}:ht(n),x=r===i?function(){return h}:ht(i)
function w(){d.push("M",s(e(b),c),l,u(e(m.reverse()),c),"Z")}for(;++g<v;)o.call(this,p=a[g],g)?(m.push([f=+y.call(this,p,g),h=+_.call(this,p,g)]),b.push([+E.call(this,p,g),+x.call(this,p,g)])):m.length&&(w(),m=[],b=[])
return m.length&&w(),d.length?d.join(""):null}return p.x=function(e){return arguments.length?(t=n=e,p):n},p.x0=function(e){return arguments.length?(t=e,p):t},p.x1=function(e){return arguments.length?(n=e,p):n},p.y=function(e){return arguments.length?(r=i=e,p):i},p.y0=function(e){return arguments.length?(r=e,p):r},p.y1=function(e){return arguments.length?(i=e,p):i},p.defined=function(e){return arguments.length?(o=e,p):o},p.interpolate=function(e){return arguments.length?(a="function"==typeof e?s=e:(s=js.get(e)||Ls).key,u=s.reverse||s,l=s.closed?"M":"L",p):a},p.tension=function(e){return arguments.length?(c=e,p):c},p}function Ks(e){return e.radius}function $s(e){return[e.x,e.y]}function Xs(){return 64}function Js(){return"circle"}function Zs(e){var t=Math.sqrt(e/_e)
return"M0,"+t+"A"+t+","+t+" 0 1,1 0,"+-t+"A"+t+","+t+" 0 1,1 0,"+t+"Z"}e.svg.line.radial=function(){var e=Ns(Gs)
return e.radius=e.x,delete e.x,e.angle=e.y,delete e.y,e},Is.reverse=Ds,Ds.reverse=Is,e.svg.area=function(){return Qs(dt)},e.svg.area.radial=function(){var e=Qs(Gs)
return e.radius=e.x,delete e.x,e.innerRadius=e.x0,delete e.x0,e.outerRadius=e.x1,delete e.x1,e.angle=e.y,delete e.y,e.startAngle=e.y0,delete e.y0,e.endAngle=e.y1,delete e.y1,e},e.svg.chord=function(){var e=Fr,t=zr,n=Ks,r=Ms,i=As
function o(n,r){var i,o,l=s(this,e,n,r),c=s(this,t,n,r)
return"M"+l.p0+a(l.r,l.p1,l.a1-l.a0)+(o=c,(i=l).a0==o.a0&&i.a1==o.a1?u(l.r,l.p1,l.r,l.p0):u(l.r,l.p1,c.r,c.p0)+a(c.r,c.p1,c.a1-c.a0)+u(c.r,c.p1,l.r,l.p0))+"Z"}function s(e,t,o,s){var a=t.call(e,o,s),u=n.call(e,a,s),l=r.call(e,a,s)+Os,c=i.call(e,a,s)+Os
return{r:u,a0:l,a1:c,p0:[u*Math.cos(l),u*Math.sin(l)],p1:[u*Math.cos(c),u*Math.sin(c)]}}function a(e,t,n){return"A"+e+","+e+" 0 "+ +(n>_e)+",1 "+t}function u(e,t,n,r){return"Q 0,0 "+r}return o.radius=function(e){return arguments.length?(n=ht(e),o):n},o.source=function(t){return arguments.length?(e=ht(t),o):e},o.target=function(e){return arguments.length?(t=ht(e),o):t},o.startAngle=function(e){return arguments.length?(r=ht(e),o):r},o.endAngle=function(e){return arguments.length?(i=ht(e),o):i},o},e.svg.diagonal=function(){var e=Fr,t=zr,n=$s
function r(r,i){var o=e.call(this,r,i),s=t.call(this,r,i),a=(o.y+s.y)/2,u=[o,{x:o.x,y:a},{x:s.x,y:a},s]
return"M"+(u=u.map(n))[0]+"C"+u[1]+" "+u[2]+" "+u[3]}return r.source=function(t){return arguments.length?(e=ht(t),r):e},r.target=function(e){return arguments.length?(t=ht(e),r):t},r.projection=function(e){return arguments.length?(n=e,r):n},r},e.svg.diagonal.radial=function(){var t=e.svg.diagonal(),n=$s,r=t.projection
return t.projection=function(e){return arguments.length?r(function(e){return function(){var t=e.apply(this,arguments),n=t[0],r=t[1]+Os
return[n*Math.cos(r),n*Math.sin(r)]}}(n=e)):n},t},e.svg.symbol=function(){var e=Js,t=Xs
function n(n,r){return(ea.get(e.call(this,n,r))||Zs)(t.call(this,n,r))}return n.type=function(t){return arguments.length?(e=ht(t),n):e},n.size=function(e){return arguments.length?(t=ht(e),n):t},n}
var ea=e.map({circle:Zs,cross:function(e){var t=Math.sqrt(e/5)/2
return"M"+-3*t+","+-t+"H"+-t+"V"+-3*t+"H"+t+"V"+-t+"H"+3*t+"V"+t+"H"+t+"V"+3*t+"H"+-t+"V"+t+"H"+-3*t+"Z"},diamond:function(e){var t=Math.sqrt(e/(2*na)),n=t*na
return"M0,"+-t+"L"+n+",0 0,"+t+" "+-n+",0Z"},square:function(e){var t=Math.sqrt(e)/2
return"M"+-t+","+-t+"L"+t+","+-t+" "+t+","+t+" "+-t+","+t+"Z"},"triangle-down":function(e){var t=Math.sqrt(e/ta),n=t*ta/2
return"M0,"+n+"L"+t+","+-n+" "+-t+","+-n+"Z"},"triangle-up":function(e){var t=Math.sqrt(e/ta),n=t*ta/2
return"M0,"+-n+"L"+t+","+n+" "+-t+","+n+"Z"}})
e.svg.symbolTypes=ea.keys()
var ta=Math.sqrt(3),na=Math.tan(30*ke)
function ra(e,t){return I(e,sa),e.id=t,e}var ia,oa,sa=[],aa=0
function ua(e,t,n,r){var i=e.id
return re(e,"function"==typeof n?function(e,o,s){e.__transition__[i].tween.set(t,r(n.call(e,e.__data__,o,s)))}:(n=r(n),function(e){e.__transition__[i].tween.set(t,n)}))}function la(e){return null==e&&(e=""),function(){this.textContent=e}}function ca(t,n,r,i){var o=t.__transition__||(t.__transition__={active:0,count:0}),s=o[r]
if(!s){var a=i.time
s=o[r]={tween:new v,time:a,ease:i.ease,delay:i.delay,duration:i.duration},++o.count,e.timer(function(i){var u=t.__data__,l=s.ease,c=s.delay,p=s.duration,f=Et,h=[]
if(f.t=c+a,c<=i)return d(i-c)
function d(i){if(o.active>r)return b()
o.active=r,s.event&&s.event.start.call(t,u,n),s.tween.forEach(function(e,r){(r=r.call(t,u,n))&&h.push(r)}),e.timer(function(){return f.c=m(i||1)?Vn:m,1},0,a)}function m(e){if(o.active!==r)return b()
for(var i=e/p,a=l(i),c=h.length;c>0;)h[--c].call(t,a)
return i>=1?(s.event&&s.event.end.call(t,u,n),b()):void 0}function b(){return--o.count?delete o[r]:delete t.__transition__,1}f.c=d},0,a)}}sa.call=q.call,sa.empty=q.empty,sa.node=q.node,sa.size=q.size,e.transition=function(e){return arguments.length?ia?e.transition():e:ae.transition()},e.transition.prototype=sa,sa.select=function(e){var t,n,r,i=this.id,o=[]
e=U(e)
for(var s=-1,a=this.length;++s<a;){o.push(t=[])
for(var u=this[s],l=-1,c=u.length;++l<c;)(r=u[l])&&(n=e.call(r,r.__data__,l,s))?("__data__"in r&&(n.__data__=r.__data__),ca(n,l,i,r.__transition__[i]),t.push(n)):t.push(null)}return ra(o,i)},sa.selectAll=function(e){var t,n,r,i,o,s=this.id,a=[]
e=V(e)
for(var u=-1,l=this.length;++u<l;)for(var c=this[u],p=-1,f=c.length;++p<f;)if(r=c[p]){o=r.__transition__[s],n=e.call(r,r.__data__,p,u),a.push(t=[])
for(var h=-1,d=n.length;++h<d;)(i=n[h])&&ca(i,h,s,o),t.push(i)}return ra(a,s)},sa.filter=function(e){var t,n,r=[]
"function"!=typeof e&&(e=ne(e))
for(var i=0,o=this.length;i<o;i++){r.push(t=[])
for(var s,a=0,u=(s=this[i]).length;a<u;a++)(n=s[a])&&e.call(n,n.__data__,a,i)&&t.push(n)}return ra(r,this.id)},sa.tween=function(e,t){var n=this.id
return arguments.length<2?this.node().__transition__[n].tween.get(e):re(this,null==t?function(t){t.__transition__[n].tween.remove(e)}:function(r){r.__transition__[n].tween.set(e,t)})},sa.attr=function(t,n){if(arguments.length<2){for(n in t)this.attr(n,t[n])
return this}var r="transform"==t?fo:Gi,i=e.ns.qualify(t)
function o(){this.removeAttribute(i)}function s(){this.removeAttributeNS(i.space,i.local)}return ua(this,"attr."+t,n,i.local?function(e){return null==e?s:(e+="",function(){var t,n=this.getAttributeNS(i.space,i.local)
return n!==e&&(t=r(n,e),function(e){this.setAttributeNS(i.space,i.local,t(e))})})}:function(e){return null==e?o:(e+="",function(){var t,n=this.getAttribute(i)
return n!==e&&(t=r(n,e),function(e){this.setAttribute(i,t(e))})})})},sa.attrTween=function(t,n){var r=e.ns.qualify(t)
...
return i&&function(e){this.setAttribute(r,i(e))}})},sa.style=function(e,t,n){var r=arguments.length
if(r<3){if("string"!=typeof e){for(n in r<2&&(t=""),e)this.style(n,e[n],t)
return this}n=""}function i(){this.style.removeProperty(e)}return ua(this,"style."+e,t,function(t){return null==t?i:(t+="",function(){var r,i=o.getComputedStyle(this,null).getPropertyValue(e)
return i!==t&&(r=Gi(i,t),function(t){this.style.setProperty(e,r(t),n)})})})},sa.styleTween=function(e,t,n){return arguments.length<3&&(n=""),this.tween("style."+e,function(r,i){var s=t.call(this,r,i,o.getComputedStyle(this,null).getPropertyValue(e))
return s&&function(t){this.style.setProperty(e,s(t),n)}})},sa.text=function(e){return ua(this,"text",e,la)},sa.remove=function(){return this.each("end.transition",function(){var e
this.__transition__.count<2&&(e=this.parentNode)&&e.removeChild(this)})},sa.ease=function(t){var n=this.id
return arguments.length<1?this.node().__transition__[n].ease:("function"!=typeof t&&(t=e.ease.apply(e,arguments)),re(this,function(e){e.__transition__[n].ease=t}))},sa.delay=function(e){var t=this.id
return arguments.length<1?this.node().__transition__[t].delay:re(this,"function"==typeof e?function(n,r,i){n.__transition__[t].delay=+e.call(n,n.__data__,r,i)}:(e=+e,function(n){n.__transition__[t].delay=e}))},sa.duration=function(e){var t=this.id
return arguments.length<1?this.node().__transition__[t].duration:re(this,"function"==typeof e?function(n,r,i){n.__transition__[t].duration=Math.max(1,e.call(n,n.__data__,r,i))}:(e=Math.max(1,e),function(n){n.__transition__[t].duration=e}))},sa.each=function(t,n){var r=this.id
if(arguments.length<2){var i=oa,o=ia
ia=r,re(this,function(e,n,i){oa=e.__transition__[r],t.call(e,e.__data__,n,i)}),oa=i,ia=o}else re(this,function(i){var o=i.__transition__[r];(o.event||(o.event=e.dispatch("start","end"))).on(t,n)})
return this},sa.transition=function(){for(var e,t,n,r=this.id,i=++aa,o=[],s=0,a=this.length;s<a;s++){o.push(e=[])
for(var u,l=0,c=(u=this[s]).length;l<c;l++)(t=u[l])&&((n=Object.create(t.__transition__[r])).delay+=n.duration,ca(t,l,i,n)),e.push(t)}return ra(o,i)},e.svg.axis=function(){var t,n=e.scale.linear(),r=pa,i=6,o=6,s=3,a=[10],u=null
function l(l){l.each(function(){var l,c=e.select(this),p=this.__chart__||n,f=this.__chart__=n.copy(),h=null==u?f.ticks?f.ticks.apply(f,a):f.domain():u,d=null==t?f.tickFormat?f.tickFormat.apply(f,a):dt:t,m=c.selectAll(".tick").data(h,f),b=m.enter().insert("g",".domain").attr("class","tick").style("opacity",we),g=e.transition(m.exit()).style("opacity",we).remove(),v=e.transition(m.order()).style("opacity",1),y=us(f),_=c.selectAll(".domain").data([0]),E=(_.enter().append("path").attr("class","domain"),e.transition(_))
b.append("line"),b.append("text")
var x=b.select("line"),w=v.select("line"),C=m.select("text").text(d),k=b.select("text"),T=v.select("text")
switch(r){case"bottom":l=ha,x.attr("y2",i),k.attr("y",Math.max(i,0)+s),w.attr("x2",0).attr("y2",i),T.attr("x",0).attr("y",Math.max(i,0)+s),C.attr("dy",".71em").style("text-anchor","middle"),E.attr("d","M"+y[0]+","+o+"V0H"+y[1]+"V"+o)
break
case"top":l=ha,x.attr("y2",-i),k.attr("y",-(Math.max(i,0)+s)),w.attr("x2",0).attr("y2",-i),T.attr("x",0).attr("y",-(Math.max(i,0)+s)),C.attr("dy","0em").style("text-anchor","middle"),E.attr("d","M"+y[0]+","+-o+"V0H"+y[1]+"V"+-o)
break
case"left":l=da,x.attr("x2",-i),k.attr("x",-(Math.max(i,0)+s)),w.attr("x2",-i).attr("y2",0),T.attr("x",-(Math.max(i,0)+s)).attr("y",0),C.attr("dy",".32em").style("text-anchor","end"),E.attr("d","M"+-o+","+y[0]+"H0V"+y[1]+"H"+-o)
break
case"right":l=da,x.attr("x2",i),k.attr("x",Math.max(i,0)+s),w.attr("x2",i).attr("y2",0),T.attr("x",Math.max(i,0)+s).attr("y",0),C.attr("dy",".32em").style("text-anchor","start"),E.attr("d","M"+o+","+y[0]+"H0V"+y[1]+"H"+o)}if(f.rangeBand){var O=f,S=O.rangeBand()/2
p=f=function(e){return O(e)+S}}else p.rangeBand?p=f:g.call(l,f)
b.call(l,p),v.call(l,f)})}return l.scale=function(e){return arguments.length?(n=e,l):n},l.orient=function(e){return arguments.length?(r=e in fa?e+"":pa,l):r},l.ticks=function(){return arguments.length?(a=arguments,l):a},l.tickValues=function(e){return arguments.length?(u=e,l):u},l.tickFormat=function(e){return arguments.length?(t=e,l):t},l.tickSize=function(e){var t=arguments.length
return t?(i=+e,o=+arguments[t-1],l):i},l.innerTickSize=function(e){return arguments.length?(i=+e,l):i},l.outerTickSize=function(e){return arguments.length?(o=+e,l):o},l.tickPadding=function(e){return arguments.length?(s=+e,l):s},l.tickSubdivide=function(){return arguments.length&&l},l}
var pa="bottom",fa={top:1,right:1,bottom:1,left:1}
function ha(e,t){e.attr("transform",function(e){return"translate("+t(e)+",0)"})}function da(e,t){e.attr("transform",function(e){return"translate(0,"+t(e)+")"})}e.svg.brush=function(){var t,n,r=j(f,"brushstart","brush","brushend"),i=null,s=null,a=[0,0],u=[0,0],l=!0,c=!0,p=ba[0]
function f(t){t.each(function(){var t=e.select(this).style("pointer-events","all").style("-webkit-tap-highlight-color","rgba(0,0,0,0)").on("mousedown.brush",b).on("touchstart.brush",b),n=t.selectAll(".background").data([0])
...
var r=t.selectAll(".resize").data(p,dt)
r.exit().remove(),r.enter().append("g").attr("class",function(e){return"resize "+e}).style("cursor",function(e){return ma[e]}).append("rect").attr("x",function(e){return/[ew]$/.test(e)?-3:null}).attr("y",function(e){return/^[ns]/.test(e)?-3:null}).attr("width",6).attr("height",6).style("visibility","hidden"),r.style("display",f.empty()?"none":null)
var o,a=e.transition(t),u=e.transition(n)
i&&(o=us(i),u.attr("x",o[0]).attr("width",o[1]-o[0]),d(a)),s&&(o=us(s),u.attr("y",o[0]).attr("height",o[1]-o[0]),m(a)),h(a)})}function h(e){e.selectAll(".resize").attr("transform",function(e){return"translate("+a[+/e$/.test(e)]+","+u[+/^s/.test(e)]+")"})}function d(e){e.select(".extent").attr("x",a[0]),e.selectAll(".extent,.n>rect,.s>rect").attr("width",a[1]-a[0])}function m(e){e.select(".extent").attr("y",u[0]),e.selectAll(".extent,.e>rect,.w>rect").attr("height",u[1]-u[0])}function b(){var p,b,g=this,v=e.select(e.event.target),y=r.of(g,arguments),_=e.select(g),E=v.datum(),x=!/^(n|s)$/.test(E)&&i,w=!/^(e|w)$/.test(E)&&s,C=v.classed("extent"),k=de(),T=e.mouse(g),O=e.select(o).on("keydown.brush",function(){32==e.event.keyCode&&(C||(p=null,T[0]-=a[1],T[1]-=u[1],C=2),A())}).on("keyup.brush",function(){32==e.event.keyCode&&2==C&&(T[0]+=a[1],T[1]+=u[1],C=0,A())})
if(e.event.changedTouches?O.on("touchmove.brush",P).on("touchend.brush",N):O.on("mousemove.brush",P).on("mouseup.brush",N),_.interrupt().selectAll("*").interrupt(),C)T[0]=a[0]-T[0],T[1]=u[0]-T[1]
else if(E){var S=+/w$/.test(E),R=+/^n/.test(E)
b=[a[1-S]-T[0],u[1-R]-T[1]],T[0]=a[S],T[1]=u[R]}else e.event.altKey&&(p=T.slice())
function P(){var t=e.mouse(g),n=!1
b&&(t[0]+=b[0],t[1]+=b[1]),C||(e.event.altKey?(p||(p=[(a[0]+a[1])/2,(u[0]+u[1])/2]),T[0]=a[+(t[0]<p[0])],T[1]=u[+(t[1]<p[1])]):p=null),x&&M(t,i,0)&&(d(_),n=!0),w&&M(t,s,1)&&(m(_),n=!0),n&&(h(_),y({type:"brush",mode:C?"move":"resize"}))}function M(e,r,i){var o,s,f=us(r),h=f[0],d=f[1],m=T[i],b=i?u:a,g=b[1]-b[0]
if(C&&(h-=m,d-=g+m),o=(i?c:l)?Math.max(h,Math.min(d,e[i])):e[i],C?s=(o+=m)+g:(p&&(m=Math.max(h,Math.min(d,2*p[i]-o))),m<o?(s=o,o=m):s=m),b[0]!=o||b[1]!=s)return i?n=null:t=null,b[0]=o,b[1]=s,!0}function N(){P(),_.style("pointer-events","all").selectAll(".resize").style("display",f.empty()?"none":null),e.select("body").style("cursor",null),O.on("mousemove.brush",null).on("mouseup.brush",null).on("touchmove.brush",null).on("touchend.brush",null).on("keydown.brush",null).on("keyup.brush",null),k(),y({type:"brushend"})}_.style("pointer-events","none").selectAll(".resize").style("display",null),e.select("body").style("cursor",v.style("cursor")),y({type:"brushstart"}),P()}return f.event=function(i){i.each(function(){var i=r.of(this,arguments),o={x:a,y:u,i:t,j:n},s=this.__chart__||o
this.__chart__=o,ia?e.select(this).transition().each("start.brush",function(){t=s.i,n=s.j,a=s.x,u=s.y,i({type:"brushstart"})}).tween("brush:brush",function(){var e=Qi(a,o.x),r=Qi(u,o.y)
return t=n=null,function(t){a=o.x=e(t),u=o.y=r(t),i({type:"brush",mode:"resize"})}}).each("end.brush",function(){t=o.i,n=o.j,i({type:"brush",mode:"resize"}),i({type:"brushend"})}):(i({type:"brushstart"}),i({type:"brush",mode:"resize"}),i({type:"brushend"}))})},f.x=function(e){return arguments.length?(p=ba[!(i=e)<<1|!s],f):i},f.y=function(e){return arguments.length?(p=ba[!i<<1|!(s=e)],f):s},f.clamp=function(e){return arguments.length?(i&&s?(l=!!e[0],c=!!e[1]):i?l=!!e:s&&(c=!!e),f):i&&s?[l,c]:i?l:s?c:null},f.extent=function(e){var r,o,l,c,p
return arguments.length?(i&&(r=e[0],o=e[1],s&&(r=r[0],o=o[0]),t=[r,o],i.invert&&(r=i(r),o=i(o)),o<r&&(p=r,r=o,o=p),r==a[0]&&o==a[1]||(a=[r,o])),s&&(l=e[0],c=e[1],i&&(l=l[1],c=c[1]),n=[l,c],s.invert&&(l=s(l),c=s(c)),c<l&&(p=l,l=c,c=p),l==u[0]&&c==u[1]||(u=[l,c])),f):(i&&(t?(r=t[0],o=t[1]):(r=a[0],o=a[1],i.invert&&(r=i.invert(r),o=i.invert(o)),o<r&&(p=r,r=o,o=p))),s&&(n?(l=n[0],c=n[1]):(l=u[0],c=u[1],s.invert&&(l=s.invert(l),c=s.invert(c)),c<l&&(p=l,l=c,c=p))),i&&s?[[r,l],[o,c]]:i?[r,o]:s&&[l,c])},f.clear=function(){return f.empty()||(a=[0,0],u=[0,0],t=n=null),f},f.empty=function(){return!!i&&a[0]==a[1]||!!s&&u[0]==u[1]},e.rebind(f,r,"on")}
var ma={n:"ns-resize",e:"ew-resize",s:"ns-resize",w:"ew-resize",nw:"nwse-resize",ne:"nesw-resize",se:"nwse-resize",sw:"nesw-resize"},ba=[["n","e","s","w","nw","ne","se","sw"],["e","w"],["n","s"],[]],ga=Mt.format=sn.timeFormat,va=ga.utc,ya=va("%Y-%m-%dT%H:%M:%S.%LZ")
function _a(e){return e.toISOString()}function Ea(t,n,r){function i(e){return t(e)}function o(t,r){var i=(t[1]-t[0])/r,o=e.bisect(wa,i)
return o==wa.length?[n.year,ms(t.map(function(e){return e/31536e6}),r)[2]]:o?n[i/wa[o-1]<wa[o]/i?o-1:o]:[Ta,ms(t,r)[2]]}return i.invert=function(e){return xa(t.invert(e))},i.domain=function(e){return arguments.length?(t.domain(e),i):t.domain().map(xa)},i.nice=function(e,t){var n=i.domain(),r=as(n),s=null==e?o(r,10):"number"==typeof e&&o(r,e)
function a(n){return!isNaN(n)&&!e.range(n,xa(+n+1),t).length}return s&&(e=s[0],t=s[1]),i.domain(cs(n,t>1?{floor:function(t){for(;a(t=e.floor(t));)t=xa(t-1)
return t},ceil:function(t){for(;a(t=e.ceil(t));)t=xa(+t+1)
return t}}:e))},i.ticks=function(e,t){var n=as(i.domain()),r=null==e?o(n,10):"number"==typeof e?o(n,e):!e.range&&[{range:e},t]
return r&&(e=r[0],t=r[1]),e.range(n[0],xa(+n[1]+1),t<1?1:t)},i.tickFormat=function(){return r},i.copy=function(){return Ea(t.copy(),n,r)},hs(i,t)}function xa(e){return new Date(e)}ga.iso=Date.prototype.toISOString&&+new Date("2000-01-01T00:00:00.000Z")?_a:ya,_a.parse=function(e){var t=new Date(e)
return isNaN(t)?null:t},_a.toString=ya.toString,Mt.second=Lt(function(e){return new At(1e3*Math.floor(e/1e3))},function(e,t){e.setTime(e.getTime()+1e3*Math.floor(t))},function(e){return e.getSeconds()}),Mt.seconds=Mt.second.range,Mt.seconds.utc=Mt.second.utc.range,Mt.minute=Lt(function(e){return new At(6e4*Math.floor(e/6e4))},function(e,t){e.setTime(e.getTime()+6e4*Math.floor(t))},function(e){return e.getMinutes()}),Mt.minutes=Mt.minute.range,Mt.minutes.utc=Mt.minute.utc.range,Mt.hour=Lt(function(e){var t=e.getTimezoneOffset()/60
return new At(36e5*(Math.floor(e/36e5-t)+t))},function(e,t){e.setTime(e.getTime()+36e5*Math.floor(t))},function(e){return e.getHours()}),Mt.hours=Mt.hour.range,Mt.hours.utc=Mt.hour.utc.range,Mt.month=Lt(function(e){return(e=Mt.day(e)).setDate(1),e},function(e,t){e.setMonth(e.getMonth()+t)},function(e){return e.getMonth()}),Mt.months=Mt.month.range,Mt.months.utc=Mt.month.utc.range
var wa=[1e3,5e3,15e3,3e4,6e4,3e5,9e5,18e5,36e5,108e5,216e5,432e5,864e5,1728e5,6048e5,2592e6,7776e6,31536e6],Ca=[[Mt.second,1],[Mt.second,5],[Mt.second,15],[Mt.second,30],[Mt.minute,1],[Mt.minute,5],[Mt.minute,15],[Mt.minute,30],[Mt.hour,1],[Mt.hour,3],[Mt.hour,6],[Mt.hour,12],[Mt.day,1],[Mt.day,2],[Mt.week,1],[Mt.month,1],[Mt.month,3],[Mt.year,1]],ka=ga.multi([[".%L",function(e){return e.getMilliseconds()}],[":%S",function(e){return e.getSeconds()}],["%I:%M",function(e){return e.getMinutes()}],["%I %p",function(e){return e.getHours()}],["%a %d",function(e){return e.getDay()&&1!=e.getDate()}],["%b %d",function(e){return 1!=e.getDate()}],["%B",function(e){return e.getMonth()}],["%Y",Vn]]),Ta={range:function(t,n,r){return e.range(Math.ceil(t/r)*r,+n,r).map(xa)},floor:dt,ceil:dt}
Ca.year=Mt.year,Mt.scale=function(){return Ea(e.scale.linear(),Ca,ka)}
var Oa=Ca.map(function(e){return[e[0].utc,e[1]]}),Sa=va.multi([[".%L",function(e){return e.getUTCMilliseconds()}],[":%S",function(e){return e.getUTCSeconds()}],["%I:%M",function(e){return e.getUTCMinutes()}],["%I %p",function(e){return e.getUTCHours()}],["%a %d",function(e){return e.getUTCDay()&&1!=e.getUTCDate()}],["%b %d",function(e){return 1!=e.getUTCDate()}],["%B",function(e){return e.getUTCMonth()}],["%Y",Vn]])
function Ra(e){return JSON.parse(e.responseText)}function Pa(e){var t=r.createRange()
return t.selectNode(r.body),t.createContextualFragment(e.responseText)}Oa.year=Mt.year.utc,Mt.scale.utc=function(){return Ea(e.scale.linear(),Oa,Sa)},e.text=mt(function(e){return e.responseText}),e.json=function(e,t){return bt(e,"application/json",Ra,t)},e.html=function(e,t){return bt(e,"text/html",Pa,t)},e.xml=mt(function(e){return e.responseXML}),"function"==typeof define&&define.amd?define(e):"object"==typeof module&&module.exports&&(module.exports=e),this.d3=e}(),define("ember-ajax/-private/promise",["exports"],function(e){"use strict"
...
function h(e){return!!(0,s.default)(e)&&!!e.match(f)}function d(e){return"/"===e.charAt(0)}function m(e){return e.substring(1)}function b(e){var t
...
return i&&(i=b(i),n.push(i)),new RegExp("^(/)?"+i).test(e)?e:(d(e)&&(e=m(e)),n.push(e),n.join("/"))},handleResponse:function(e,t,n,r){return this.isSuccess(e,t,n)?n:(n=this.normalizeErrorResponse(e,t,n),this._createCorrectError(e,t,n,r))},_createCorrectError:function(e,n,r,i){var o=void 0
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=Ember.Component.extend({layout:t.default,tagName:"",collapsed:null,collapseComponent:"bs-collapse"})})
...
Object.defineProperty(e,"__esModule",{value:!0}),e.default=t.default.extend({classNames:["accordion"]})})
...
function a(e){this.value=e}}),define("ember-load-initializers/index",["exports"],function(e){"use strict"
...
return n.d(t,"a",t),t},n.o=function(e,t){return Object.prototype.hasOwnProperty.call(e,t)},n.p="",n(n.s=2)}([function(e,t){window._eai_r=require,window._eai_d=define},function(e,t){function n(e){return e<10?"0"+e:e}var r=/(-)?[0-9]?[0-9]:[0-9][0-9](:[0-9][0-9])?/
e.exports.parseTime=function(e){if(!e)return null
if("string"!=typeof e)return null
if(!r.test(e))return null
var t=e.split(":"),n=null
if(2===t.length){var i="-"===t[0][0],o=parseInt(t[0],10)
n=(i?-1:1)*(60*Math.abs(o)+parseInt(t[1],10))}else 3===t.length&&(n=3600*parseInt(t[0],10)+60*parseInt(t[1],10)+parseInt(t[2],10))
return isNaN(n)?null:n},e.exports.formatTime=function(e){const t=e<0?"-":"",r=Math.abs(e)
return r>=3600?t+Math.floor(r/3600)+":"+n(Math.floor(r/60)%60)+":"+n(r%60):Math.floor(r/60)+":"+n(r%60)}},function(e,t,n){n(0),e.exports=n(3)},function(e,t,n){var r,i,o
"undefined"!=typeof document&&(n.p=(r=document.querySelectorAll("script"))[r.length-1].src.replace(/\/[^\/]*$/,"/")),e.exports=(i=_eai_d,o=_eai_r,window.emberAutoImportDynamic=function(e){return o("_eai_dyn_"+e)},void i("@rasifix/orienteering-utils",[],function(){return n(4)}))},function(e,t,n){const r=n(5),i=n(6),o=n(7),s=n(1)
e.exports={oware:r,kraemer:i,solv:o,time:s}},function(e,t){e.exports.parse=function(e){var t=e.trim().split(/[\r\n]+/),n=(t=t.splice(1))[0].split(";"),r={name:n[0].substring(2,n[0].length),map:n[1],date:n[2],startTime:n[3],categories:[]}
t=t.splice(1)
var i=null
return t.filter(e=>e.trim().length>0).forEach(function(e){var t,n=e.split(";")
4===n.length?(i={name:(t=n)[0],distance:parseInt(t[1],10),ascent:parseInt(t[2],10),controls:parseInt(t[3],10),runners:[]},r.categories.push(i)):i.runners.push(function(e){var t,n=[]
for(t=15;t<e.length;t+=2)n.push({code:e[t],time:e[t+1]})
for(t=n.length-1;t>0;t--)n[t].time===n[t-1].time&&"-"!==n[t].time&&(n[t].time="s")
return{rank:e[0]?parseInt(e[0]):null,name:e[1],firstName:e[2],fullName:[e[2],e[1]].join(" "),yearOfBirth:e[3],sex:e[4],club:e[8],city:e[7],nation:e[9],time:e[12],startTime:e[13],ecard:e[11],splits:n}}(n))}),r},e.exports.serialize=function(e){var t="//Format: Rank;Name;Firstname;YearOfBirth;SexMF;FedNr;Zip;Town;Club;NationIOF;StartNr;eCardNr;RunTime;StartTime;FinishTime;CtrlCode;SplitTime; ...\n"
return t+="//"+[e.name,e.map,e.date,e.startTime,""].join(";")+"\n",e.categories.forEach(function(e){t+=[e.name,e.distance,e.ascent,e.controls].join(";")+"\n",e.runners.forEach(function(e){t+=[e.rank,e.name,e.firstName,e.yearOfBirth,e.sex,"",e.zip,e.city,e.club,e.nation,"",e.ecard,e.time,e.startTime,""].join(";"),t+=";"+e.splits.map(function(e){return e.code+";"+e.time}).join(";")+"\n"})}),t},e.exports.formatCheck=function(e){return"//Format"===e.substring(0,8)}},function(e,t,n){var{parseTime:r,formatTime:i}=n(1)
function o(e){return e?e.length>0&&'"'===e[0]?e.substring(1,e.length-1):e:""}e.exports.parse=function(e,t={}){var n,s=e.split("[\r\n]+"),a=s[0].split(";"),u={}
u.Nachname=a.indexOf("Nachname"),u.Vorname=a.indexOf("Vorname"),u.Jg=a.indexOf("Jg"),u.G=a.indexOf("G"),u["Datenbank Id"]=a.indexOf("Datenbank Id"),u.Abk=a.indexOf("Abk"),u.Club=a.indexOf("Ort"),u.Ort=a.indexOf("Adr. Ort"),u.Nat=a.indexOf("Nat"),u.Start=a.indexOf("Start"),u.Ziel=a.indexOf("Ziel"),u.Zeit=a.indexOf("Zeit"),u.Katnr=a.indexOf("Kurz"),u.Wertung=a.indexOf("Wertung"),u.Posten=a.indexOf("Bahn Posten"),u.km=a.indexOf("km"),u.hm=a.indexOf("Hm"),n=a.indexOf("Posten1"),"OE0014"===a[0]?u.Chip=a.indexOf("Chipnr"):u.Chip=a.indexOf("Chip"),s=s.slice(1)
var l={}
return s.forEach(function(e){var t=e.split(";"),s=function(e){var t={}
return Object.keys(u).forEach(function(n){t[n]=e[u[n]]}),t}(t)
if("0"!==s.Wertung)return
let a=o(s.Nachname),c=o(s.Vorname)
var p={name:a,firstName:c,fullName:[c,a].join(" "),yearOfBirth:s.Jg,sex:o(s.G),club:(o(s.Abk)+" "+o(s.Club)).trim(),city:o(s.Ort),nation:o(s.Nat),time:i(r(s.Zeit)),startTime:i(r(s.Start)),ecard:o(s.Chip),splits:[]},f=l[o(s.Katnr)]
void 0===f&&(f={name:o(s.Katnr),distance:1e3*parseInt(o(s.km),10),ascent:o(s.hm),controls:o(s.Posten),runners:[]},l[f.name]=f)
for(var h=t.slice(n),d=0;d<2*parseInt(s.Posten,10);d+=2)d!==h.length-1&&p.splits.push([h[d],i(r(h[d+1]))])
p.course=p.splits.map(function(e){return e[0]}).join(","),f.runners.push(p)}),{name:t.event||"Anonymous Event",map:t.map||"Unknown Map",date:date||"",startTime:startTime||"",categories:Object.keys(l).map(function(e){return l[e]})}},e.exports.formatCheck=function(e){return"OE0014"===e.substring(0,6)||"Stnr;Chip;Datenbank Id;"===e.substring(0,23)}},function(e,t,n){const{formatTime:r,parseTime:i}=n(1)
function o(e){return"-"===e||"-----"===e?"-":"0.00"===e?"s":r(i(e))}e.exports.parse=function(e,t={}){const n={},s=e.split("\n")
return s.splice(0,1)[0].split(";"),s.forEach(function(e,t){const s=e.split(";")
if(s.length<11)return
const a=s[0]
let u=n[a]
u||(u={name:a,distance:Math.round(1e3*parseFloat(s[1])),ascent:s[2],controls:parseInt(s[3]),runners:[]},n[a]=u)
const l={id:t,rank:s[4]?parseInt(s[4]):null,fullName:s[5],yearOfBirth:s[6],city:s[7],club:s[8],time:(c=s[9],-1===c.indexOf(":")?c:r(i(c))),startTime:s[10],splits:[]}
var c
if(s.length-12<2*u.controls){console.log("fix crappy data from SOLV - not enough tokens on line for runner "+l.fullName)
for(var p=s.length;p<2*u.controls+12;p++)s[p]=p%2==0?0===u.runners.length?"???":u.runners[0].splits[(p-12)/2].code:"-"}for(let n=12;n<s.length-1;n+=2){let e=o(s[n+1])
l.splits.length>0&&i(e)&&(e===i(l.splits[l.splits.length-1])||"0.00"===s[n+1]||i(s[n+1])>10800)&&(e="s"),l.splits.push({code:s[n],time:e})}u.runners.push(l)}),{name:t.event||"Anonymous Event",map:t.map||"Unknown Map",date:t.date||"",startTime:t.startTime||"",categories:Object.keys(n).map(function(e){return n[e]})}},e.exports.serialize=function(e){var t="Kategorie;Laenge;Steigung;PoAnz;Rang;Name;Jahrgang;Ort;Club;Zeit;Startzeit;Zielzeit;Zwischenzeiten\n"
return e.categories.forEach(function(e){e.runners.forEach(function(n){const o=e.distance?parseFloat(e.distance/1e3).toFixed(1):null
t+=[e.name,o,e.ascent,e.controls,n.rank,n.fullName,n.yearOfBirth,n.city,n.club,n.time,n.startTime,r(i(n.time)+i(n.startTime))].join(";"),t+=";"+n.splits.map(function(e){return e.code+";"+e.time}).join(";")+"\n"})}),t},e.exports.formatCheck=function(e){return e.startsWith("Kategorie;Laenge;Steigung;PoAnz;Rang;")}}])
